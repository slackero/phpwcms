...
Welcome! This is the developer instructions file for **Antigravity CLI**. It provides project context, guidelines, and commands.

## Tech Stack
- **Backend**: PHP >= 8.2 (configured for PHP 8.2)
- **Database**: MySQL / MariaDB (minimum 5.6+)
- **Dependency Management**: Composer (vendor directory at `include/vendor`)
- **Coding Standards & Tools**: PHPStan (level 5 static analysis)

## Core Commands
- **Install dependencies**: `composer install`
- **Run static analysis (Linter)**: `composer phpstan` (executes `phpstan analyse`)
- **Update autoload maps**: `composer dump-autoload`

## Coding Style & Best Practices
- **Strict Guidelines**: Maintain compatibility with PHP 8.2+.
- **Database Safety**: Focus on parameterized queries and input sanitization to prevent SQL injection. Avoid MySQL Strict mode issues where possible.
- **XSS Prevention**: Sanitize all dynamic HTML output.
- **Dependency Isolation**: Do not write source code or vendor modifications directly; manage them through Composer.
