...
require_once CMSGO_ROOT.'/setup/inc/upgrade.func.inc.php';
...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" summary="">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td valign="top" style="background: url(../img/backend/backend_r3_c4.jpg) repeat-x;"><table width="740" border="0" cellpadding="0" cellspacing="0" summary="">
        ...
        <tr>
          <td valign="top" class="navtext">CMSGO UPGRADE VERSION&nbsp;<?php echo $cmsgo['release'].', RELEASE '.$cmsgo['release_date'] ?></td>
          <td align="right" valign="top" class="navtext"><a href="../index.php" target="_top">HOME</a> |
            <a href="setup.php">SETUP</a> | <a href="index.php" target="_top">LICENCE</a> | <a href="<?php echo CMSGO_URL.get_login_file() ?>" target="_top">LOGIN</a></td>
        </tr>
    </table></td>
...
if($do) {
	...
	$sql_data = preg_replace("/ `cmsgo/", " `".DB_PREPEND."cmsgo", $sql_data );
...
?>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td style="font-weight:bold; "><?php echo $cmsgo["db_host"] ?></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">Database:</td>
    <td style="font-weight:bold; "><?php echo $cmsgo["db_table"] ?></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td align="right">DB user:</td>
    <td style="font-weight:bold; "><?php echo $cmsgo["db_user"] ?></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><select class="custom-select" name="sqlfile" id="sqlfile" onchange="window.open(this.options[this.selectedIndex].value,'sqlqueries')">
