...
// get all articles
if($all = _dbQuery("SELECT article_id, article_alias, article_title FROM ".DB_PREPEND."cmsgo_article WHERE article_end='2010-12-31 23:59:59' AND article_deleted=0")) {
