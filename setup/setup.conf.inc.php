...
$cmsgo['admin_email'] = 'noreply@'.str_replace('www.', '', get_url_origin(true, false, false));
...
$cmsgo['video-js'] = ''; // can be stored locally too 'template/lib/video-js/ (https://vjs.zencdn.net/8.23.4/)
