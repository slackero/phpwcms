...
$phpwcms['img_list_width'] = 160; //max with of the list thumbnail image
...
$phpwcms['preserve_getVar'] = array(); // phpwcms removes some internal GET vars by default, add the ones that should be preserved
