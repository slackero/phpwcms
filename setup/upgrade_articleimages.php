...
$sql = "SELECT * FROM ".DB_PREPEND."cmsgo_articlecontent WHERE acontent_type=1 and acontent_image != ''";
$result = _dbQuery($sql);
...
if($total)
    ...
    foreach($result as $row) {
        ...
        $fsql = "SELECT * FROM ".DB_PREPEND."cmsgo_file WHERE f_id='".intval($image[0])."' LIMIT 1";
