...
//setup functions
$phpwcms_version = "1.3.5";
$phpwcms_release_date = '2007/12/05';
...
function write_conf_file($val) {
	...
	$conf_file .= "\$phpwcms['no_session_start']  = array('googlebot', 'msnbot', 'ia_archiver', 'altavista', 'slurp', 'yahoo', 'jeeves', 'teoma', 'lycos', 'crawler'); //don't start session \n";
