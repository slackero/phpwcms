...
<form action="setup.php?step=4" method="post"><table border="0" cellpadding="0" cellspacing="0" summary="">
          ...
          <tr>
            ...
            <td><input name="file_maxsize" type="text" class="f11b" id="file_maxsize" style="width:125px" value="<?php echo $cmsgo["file_maxsize"] ?>" size="30" maxlength="100"></td>
          ...
          <tr>
            ...
            <td><input name="content_width" type="text" class="f11b" id="content_width" style="width:125px" value="<?php echo $cmsgo["content_width"] ?>" size="30" maxlength="100"></td>
          ...
          <tr>
            ...
            <td><table border="0" cellpadding="0" cellspacing="0" summary="">
              <tr>
                <td><input name="img_list_width" type="text" class="f11b" id="img_list_width" style="width:55px" value="<?php echo $cmsgo["img_list_width"] ?>" size="30" maxlength="100"></td>
                <td class="v10">&nbsp;x&nbsp;</td>
                <td><input name="img_list_height" type="text" class="f11b" id="img_list_height" style="width:55px" value="<?php echo $cmsgo["img_list_height"] ?>" size="30" maxlength="100"></td>
              </tr>
            </table></td>
          ...
          <tr>
            ...
            <td><table border="0" cellpadding="0" cellspacing="0" summary="">
              <tr>
                <td><input name="img_prev_width" type="text" class="f11b" id="img_prev_width" style="width:55px" value="<?php echo $cmsgo["img_prev_width"] ?>" size="30" maxlength="100">                </td>
                <td class="v10">&nbsp;x&nbsp;</td>
                <td><input name="img_prev_height" type="text" class="f11b" id="img_prev_height" style="width:55px" value="<?php echo $cmsgo["img_prev_height"] ?>" size="30" maxlength="100">                </td>
              </tr>
            </table></td>
          ...
          <tr>
            ...
            <td><input name="max_time" type="text" class="f11b" id="max_time" style="width:125px" value="<?php echo $cmsgo["max_time"] ?>" size="30" maxlength="100"></td>
