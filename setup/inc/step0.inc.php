...
<p><strong>cmsGO!</strong> has
    ...
    support for <a href="http://en.wikipedia.org/wiki/GD_Graphics_Library" target="_blank">GD</a> &#8212;
    <strong>GD2</strong> with
...
if (!is_writable($DOCROOT . '/setup/setup.conf.inc.php')) {
    ...
    <form action="setup.php?step=1" method="post">
        <input name="Submit" type="submit" value="Start setup of cmsgo"/>
        &nbsp;&nbsp;
