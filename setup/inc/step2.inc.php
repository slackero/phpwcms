...
?>
<form action="setup.php?step=2" method="post" autocomplete="off">
    ...
    <div class="card mb-4 border">
        ...
        <div class="card-body">
            ...
            if ($_wl_payload !== false):
                $_brand_prefix_val = (!empty($phpwcms['brand_table_prefix']) && $phpwcms['brand_table_prefix'] !== 'phpwcms')
                    ? $phpwcms['brand_table_prefix']
                    : (!empty($_SESSION['brand_table_prefix']) && $_SESSION['brand_table_prefix'] !== 'phpwcms'
                        ? $_SESSION['brand_table_prefix']
                        : (!empty($_wl_payload['brand_table_prefix']) && $_wl_payload['brand_table_prefix'] !== 'phpwcms' ? $_wl_payload['brand_table_prefix'] : ''));
            ?>
            <div class="form-group row">
                <label for="brand_table_prefix" class="col-sm-3 col-form-label fw-bold">Brand Table Prefix</label>
                <div class="col-sm-6">
                    <input name="brand_table_prefix" type="text" class="form-control" id="brand_table_prefix" value="<?php echo html_specialchars($_brand_prefix_val) ?>" placeholder="phpwcms" maxlength="64" pattern="[a-zA-Z0-9_]*" />
                </div>
