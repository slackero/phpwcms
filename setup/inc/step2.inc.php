...
<form action="setup.php?step=2" method="post">
  <table border="0" cellpadding="0" cellspacing="0" summary="">
          <tr>
            ...
            <td><input name="site" type="text" class="f11b" id="site" value="<?php echo html_specialchars($phpwcms["site"]) ?>" size="30" style="width:275px" placeholder="<?php echo get_url_origin(true); ?>"></td>
