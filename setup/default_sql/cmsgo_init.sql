...
CREATE TABLE `cmsgo_ads_campaign` (
...
CREATE TABLE `cmsgo_ads_formats` (
...
CREATE TABLE `cmsgo_ads_tracking` (
...
CREATE TABLE `cmsgo_articlecontent` (
...
CREATE TABLE `cmsgo_shop_orders` (
...
CREATE TABLE `cmsgo_shop_products` (
...
CREATE TABLE `cmsgo_subscription` (
