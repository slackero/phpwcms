...
CREATE TABLE `phpwcms_log_seo` (
  ...
  `domain` varchar(255) collate latin1_german2_ci NOT NULL,
  `query` varchar(255) collate latin1_german2_ci NOT NULL,
  `pos` int(11) NOT NULL,
  `referrer` text collate latin1_german2_ci NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM;
