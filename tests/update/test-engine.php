...
assert(phpwcms_update::isSkipped('setup/index.php') === true, 'setup must be skipped');
...
// 2. version compare
assert(phpwcms_update::MIN_SUPPORTED_VERSION === '2.0.0');
assert(phpwcms_update::isNewer('2.0.1') === true);
assert(phpwcms_update::isNewer('2.0.0') === false);
assert(phpwcms_update::isNewer('1.9.34') === false);
