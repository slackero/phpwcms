...
*
* Enhancements...: 17/03/2007 Oliver Georgi, http://www.cmsgo.org
	...
	function dynCalendar_show()
	{
        ...
        */
		if (this.useMonthCombo) {
			...
			monthCombo = '<select class="custom-select" name="months" onchange="' + this.objName + '.show(this.options[this.selectedIndex].value, ' + this.objName + '.currentYear)">' + monthComboOptions + '</select>';
		} else {
        ...
        */
		if (this.useYearCombo) {
			...
			yearCombo = '<select class="custom-select" name="years" onchange="' + this.objName + '.show(' + this.objName + '.currentMonth, this.options[this.selectedIndex].value)">' + yearComboOptions + '</select>';
		} else {
...
*/
	function dynCalendar_writeHTML()
	{
		...
		//if (is_ie5up || is_nav6up || is_gecko) {
			...
			document.write('<div class="Collapse' + this.objName + ' dynCalendar collapse" id="' + this.layerID + '" onmouseover="' + this.objName + '._mouseover(true)" onmouseout="' + this.objName + '._mouseover(false)"></div>');
		//}
	}
