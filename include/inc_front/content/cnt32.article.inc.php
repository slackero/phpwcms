...
// read template
if(empty($crow["acontent_template"]) && is_file(CMSGO_TEMPLATE.'inc_default/tabs.tmpl')) {

    $tabs['template']   = render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_default/tabs.tmpl') );

} elseif(is_file(CMSGO_TEMPLATE.'inc_cntpart/tabs/'.$crow["acontent_template"])) {

    $tabs['template']   = render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_cntpart/tabs/'.$crow["acontent_template"]) );
