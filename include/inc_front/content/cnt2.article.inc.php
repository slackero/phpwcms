...
if(is_array($image) && ($image_count = count($image))) {
    ...
    if(empty($crow["acontent_template"]) && is_file(CMSGO_TEMPLATE.'inc_default/imagetable.tmpl')) {
        ...
        $crow["acontent_template"]  = render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_default/imagetable.tmpl') );

    } elseif(is_file(CMSGO_TEMPLATE.'inc_cntpart/imagetable/'.$crow["acontent_template"])) {

        $crow["acontent_template"]  = render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_cntpart/imagetable/'.$crow["acontent_template"]) );
