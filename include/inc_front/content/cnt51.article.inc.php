...
$map['sql']  = "SELECT * FROM ".DB_PREPEND."cmsgo_map WHERE map_deleted=0 ";
...
$map['template']        = render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_cntpart/map/'.$map['template']) );
...
$map['map_img'] = '';
if(file_exists(CMSGO_TEMPLATE.'inc_cntpart/map/map_img/'.$map['image'])) {
