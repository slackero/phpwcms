...
//bullet list
// read template
if(empty($crow["acontent_template"]) && is_file(CMSGO_TEMPLATE.'inc_default/bulletlist.tmpl')) {

	$crow["acontent_template"]	= render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_default/bulletlist.tmpl') );

} elseif(is_file(CMSGO_TEMPLATE.'inc_cntpart/bulletlist/'.$crow["acontent_template"])) {

	$crow["acontent_template"]	= render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_cntpart/bulletlist/'.$crow["acontent_template"]) );
