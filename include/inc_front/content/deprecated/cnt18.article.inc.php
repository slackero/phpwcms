    ...
    if($guestbook['listing'] && $guestbook['listcount']) {
        ...
        if($guestbook['pagecount'] > 1 || $guestbook['archivedate']) {
            ...
            if( ! ( strpos($guestbook['nav'],'{ARCHIVE')===false ) ) {
                ...
                $guestbook['archive'] .= '<select class="custom-select"  name="showarchive" id="showarchive" onchange="document.guestbookarchive.submit();">';
            ...
            if( ! ( strpos($guestbook['nav'],'{JUMP')===false ) ) {
                ...
                $guestbook['jump'] .= '<select class="custom-select" name="showguestbookpage" id="showpage" onchange="document.guestbookjump.submit();">';
                    ...
                    if($thumb_image != false) {
                        ...
                        if($guestbook['imgdata'][2]) {
                            ...
                            if($zoominfo != false) {
                                ...
                                $popup_img = CMSGO_URL . 'image_zoom.php?'.getClickZoomImageParameter($zoominfo['src'].'?'.$zoominfo[3]);
