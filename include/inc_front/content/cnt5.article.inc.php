...
//link list
// read template
if(empty($crow["acontent_template"]) && is_file(CMSGO_TEMPLATE.'inc_default/linklist.tmpl')) {

	$crow["acontent_template"]	= render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_default/linklist.tmpl') );

} elseif(is_file(CMSGO_TEMPLATE.'inc_cntpart/linklist/'.$crow["acontent_template"])) {

	$crow["acontent_template"]	= render_device( @file_get_contents(CMSGO_TEMPLATE.'inc_cntpart/linklist/'.$crow["acontent_template"]) );
