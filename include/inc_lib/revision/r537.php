...
function phpwcms_revision_r537() {
	...
	if(!_dbColumnExists('phpwcms_content', 'cnt_opengraph')) {
	...
	if(!_dbColumnExists('phpwcms_categories', 'cat_opengraph')) {
	...
	if(!_dbColumnExists('phpwcms_shop_products', 'shopprod_opengraph')) {
