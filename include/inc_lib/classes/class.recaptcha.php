...
class cmsgoRecaptcha {
    ...
    public function __construct($sitekey=null, $secretkey=null) {
        ...
        } elseif(!empty($GLOBALS['cmsgo']['recaptcha_site_key'])) {
            $this->sitekey = $GLOBALS['cmsgo']['recaptcha_site_key'];
        }

        if($secretkey !== null && is_string($secretkey)) {
            $this->secretkey = $secretkey;
        } elseif(!empty($GLOBALS['cmsgo']['recaptcha_secret_key'])) {
            $this->secretkey = $GLOBALS['cmsgo']['recaptcha_secret_key'];
        }
