...
function cmsgoversionCheck() {
    ...
    if(function_exists('fsockopen') && $fsock = @fsockopen('www.pixels-points.ch', 80, $errno, $errstr, 10)) {
        ...
        $version_info = @file_get_contents('https://www.pixels-points.ch/versioncheck/'.$identify);
        $get_info = true;
...
//  unset($GLOBALS['BE']['HEADER']['mootools.js']);
    ...
    $GLOBALS['BE']['HEADER'] = array('jquery.js' => getJavaScriptSourceLink('include/inc_js/jquery/jquery-3.6.3.min.js')) + $GLOBALS['BE']['HEADER'];
}
