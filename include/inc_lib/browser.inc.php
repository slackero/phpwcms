...
// 
// $Id: browser.inc.php,v 1.1 2006/09/11 20:13:55 slackero Exp $ 
...
//debug code 
echo "\n\nAgent: ".$HTTP_SERVER_VARS['HTTP_USER_AGENT']."<br />"; 
echo "\nIE: ".browser_is_ie()."<br />"; 
echo "\nMac: ".browser_is_mac()."<br />"; 
echo "\nWindows: ".browser_is_windows()."<br />"; 
echo "\nPlatform: ".browser_get_platform()."<br />"; 
echo "\nVersion: ".browser_get_version()."<br />"; 
