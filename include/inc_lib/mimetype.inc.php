...
function get_mimetype_by_extension($ext='') {
	...
	if(empty($ext) || !isset($GLOBALS['cmsgo']['mime_types'][$ext])) {
		$ext = '*';
	}

	return $GLOBALS['cmsgo']['mime_types'][$ext];
}

function is_mimetype_by_extension($ext) {
	return empty($ext) || !isset($GLOBALS['cmsgo']['mime_types'][$ext]) ? false : true;
}
