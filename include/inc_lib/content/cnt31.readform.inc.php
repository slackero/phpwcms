...
$content['image_special']   = array(
    ...
    'width_zoom'    => empty($_POST['cimage_width_zoom']) ? $cmsgo['img_prev_width'] : intval($_POST['cimage_width_zoom']),
    'height_zoom'   => empty($_POST['cimage_height_zoom']) ? $cmsgo['img_prev_height'] : intval($_POST['cimage_height_zoom']),
