  ...
  <div class="card-header"><h2><i class="fa fa-list"></i> <?php echo $BL['be_admin_tmpl_title'] ?></h2></div>
    <div class="card-body">
      ...
      <form action="cmsgo.php?do=admin&amp;p=11&amp;s=0" method="post">
        <input type="submit" value="<?php echo $BL['be_admin_tmpl_add'] ?>" class="btn btn-blue btn-sm" title="<?php echo $BL['be_admin_tmpl_add'] ?>" />
      </form>
    </div>
</div>
<?php
...
<hr />
  ...
  <div class="form-group form-row">
    <label for="be_admin_tmpl_css" class="col-sm-2 col-form-label text-right"><?php echo $BL['be_admin_tmpl_css'] ?></label>
    <div class="col">
    ...
    <div class="col-sm-auto">
      <button type="button" class="btn btn-sm btn-blue" onclick="moveOptionUp(document.blocks.template_css);"><i class="fa fa-angle-up fa-fw" aria-hidden="true"></i></button><br />
      <button type="button" class="btn btn-sm btn-blue mt-1" onclick="moveOptionDown(document.blocks.template_css);"><i class="fa fa-angle-down fa-fw" aria-hidden="true"></i></button>
    </div>
  </div>

  <div class="form-group form-row">
    <label for="be_admin_tmpl_head" class="col-sm-2 col-form-label text-right"><?php echo $BL['be_admin_tmpl_head'] ?></label>
    <div class="col">
      <textarea name="template_htmlhead" rows="5" class="form-control form-control-sm" id="template_htmlhead"><?php echo html_entities($template["htmlhead"]); ?></textarea>
     </div>
  </div>
...
<div class="form-group form-row">
  ...
  <div class="col-sm-10">
    ...
    <div class="form-check">
      ...
      <div id="ga-tracking" class="form-group form-row align-items-center mt-3"<?php if(!$template['tracking_ga']['enable']): ?> style="display:none;"<?php endif; ?>>
        <label class="col-sm-2 col-form-label text-right" for="be_tracking_id"><?php echo $BL['be_tracking_id']; ?></label>
    ...
    <div class="form-check">
      <label class="form-check-label" for="template_piwik">
        ...
        <div id="piwik-tracking" class="form-group form-row align-items-center mt-3"<?php if(!$template['tracking_piwik']['enable']): ?> style="display:none;"<?php endif; ?>>
        	<label class="col-sm-2 col-form-label text-right" for="be_site_id"><?php echo $BL['be_site_id']; ?></label>
          <input type="text" name="template_piwik_id" class="form-control col-sm-2" placeholder="1" value="<?php echo empty($template['tracking_piwik']['id']) ? '' : $template['tracking_piwik']['id']; ?>" />
          <label class="col-sm-2 col-form-label text-right" for="be_piwik_url"><?php echo $BL['be_piwik_url']; ?></label>
          <input type="text" name="template_piwik_url" class="form-control col-sm-4" placeholder="piwik.example.com" value="<?php echo html($template['tracking_piwik']['url']) ?>" />
        </div>
    </div>
    ...
    <div class="form-check">
      ...
      <div id="cookie-consent"<?php if(!$template['cookie_consent']['enable']): ?> style="display:none;"<?php endif; ?>>
        <div class="form-group form-row mt-3">
          ...
          <div class="col"><textarea name="template_cc_message" rows="3" class="form-control form-control-sm" placeholder="<?php echo $BL['cookie_consent_message']; ?>"><?php echo html($template['cookie_consent']['message']) ?></textarea></div>
        </div>
        <div class="form-group form-row">
          <label class="col-sm-3 col-form-label text-right" for="be_cookie_consent_dismiss"><?php echo $BL['be_cookie_consent_dismiss']; ?></label>
          <div class="col"><input type="text" name="cookie_consent_dismiss" class="form-control form-control-sm" placeholder="<?php echo $BL['cookie_consent_dismiss']; ?>" value="<?php echo html($template['cookie_consent']['dismiss']) ?>" /></div>
        </div>
        <div class="form-group form-row">
          <label class="col-sm-3 col-form-label text-right" for="be_cookie_consent_link"><?php echo $BL['be_cookie_consent_more']; ?></label>
          <div class="col"><input type="text" name="be_cookie_consent_more" class="form-control form-control-sm" placeholder="<?php echo $BL['cookie_consent_more']; ?>" value="<?php echo html($template['cookie_consent']['more']) ?>" /></div>
        </div>
        <div class="form-group form-row">
          <label class="col-sm-3 col-form-label text-right" for="be_cookie_consent_more"><?php echo $BL['be_cookie_consent_link']; ?></label>
                <div class="col"><input type="text" name="be_cookie_consent_link" class="form-control form-control-sm" placeholder="http://example.com/cookie-policy | cookie-policy" value="<?php echo html($template['cookie_consent']['link']) ?>" /></div>
        </div>
        <div class="form-group form-row">
          <label class="col-sm-3 col-form-label text-right" for="be_cookie_consent_theme"><?php echo $BL['be_cookie_consent_theme']; ?></label>
          <div class="col">
            <input type="text" name="be_cookie_consent_theme" class="form-control form-control-sm"
...
<hr />
    ...
    <div class="form-group form-row">
      ...
      <div class="col">
        <textarea name="template_block_header" rows="5" class="form-control form-control-sm" id="template_block_header"><?php echo html_entities($template["headertext"]); ?></textarea>
      </div>
    </div>
    <div class="form-group form-row">
      <label for="be_admin_page_main" class="col-sm-2 col-form-label text-right"><?php echo $BL['be_admin_page_main'] ?></label>
      <div class="col">
        <textarea name="template_block_main" rows="15" class="form-control form-control-sm" id="template_block_main"><?php echo html_entities($template["maintext"]); ?></textarea>
      </div>
    </div>
    <div class="form-group form-row">
      <label for="be_admin_page_footer" class="col-sm-2 col-form-label text-right"><?php echo $BL['be_admin_page_footer'] ?></label>
      <div class="col">
        <textarea name="template_block_footer" rows="5" class="form-control form-control-sm" id="template_block_footer"><?php echo html_entities($template["footertext"]); ?></textarea>
      </div>
    </div>
    <div class="form-group form-row">
      <label for="be_admin_page_left" class="col-sm-2 col-form-label text-right"><?php echo $BL['be_admin_page_left'] ?></label>
      <div class="col">
        <textarea name="template_block_left" rows="5" class="form-control form-control-sm" id="template_block_left"><?php echo html_entities($template["lefttext"]); ?></textarea>
      </div>
    </div>
    <div class="form-group form-row">
      <label for="be_admin_page_right" class="col-sm-2 col-form-label text-right"><?php echo $BL['be_admin_page_right'] ?></label>
      <div class="col">
        <textarea name="template_block_right" rows="5" class="form-control form-control-sm" id="template_block_right"><?php echo html_entities($template["righttext"]); ?></textarea>
      </div>
    </div>
...
?>
    ...
    <div class="form-group form-row">
      ...
      <div class="col">
        <textarea name="template_block_error" rows="5" class="form-control form-control-sm" id="template_block_error"><?php echo html_entities($template["errortext"]); ?></textarea>
      </div>
    </div>
</div>
</div>
