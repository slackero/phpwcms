...
?><form action="include/inc_act/act_ftptakeover.php" method="post" name="ftptakeover" id="ftptakeover"><table width="538" border="0" cellpadding="0" cellspacing="0" summary="">
		<tr><td colspan="6" class="title"><?php echo $BL['be_ftptakeover_title'] ?></td></tr>
		<tr><td colspan="6" class="title"><img src="img/leer.gif" alt="" width="1" height="4"></td></tr>
		  ...
		  ?>
          <tr<?php echo $fxb?>>
            <td align="center"><input name="ftp_mark[<?php echo $fx ?>]" type="checkbox" id="ftp_mark" value="1"></td>
          ...
          <tr>
			...
			?>
          <tr bgcolor="#92A1AF"><td colspan="6" bgcolor="#D9DEE3"><img src="img/leer.gif" alt="" width="1" height="1"></td></tr>
		  <input name="toggle" type="hidden" id="toggle" value="0">
          <tr bgcolor="#F9FAFB">
            <td align="center" class="subnavactive"><a href="javascript:;" onclick="toggleAllFTP(document.ftptakeover.ftp_mark, switchToggleFTP(document.ftptakeover.toggle));" title="toggle file selection on/off"><?php echo $BL['be_ftptakeover_all'] ?></a></td>
            <td bgcolor="#D9DEE3"><img src="img/leer.gif" alt="" width="1" height="17"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td bgcolor="#D9DEE3"><img src="img/leer.gif" alt="" width="1" height="1"></td>
        ...
        ?><table width="538" border="0" cellpadding="0" cellspacing="0" summary="">
          <tr bgcolor="#D9DEE3"><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="5"></td></tr>
            <tr bgcolor="#D9DEE3">
              <td width="67" align="right" class="v09"><?php echo $BL['be_ftptakeover_directory'] ?>:&nbsp;</td>
              <td width="471" class="v10"><select name="file_dir" id="file_dir" class="v10" style="font-weight: bold; width: 450px;">
            ...
            <tr bgcolor="#D9DEE3"><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="5"></td>
 			...
 			<tr bgcolor="#D9DEE3"><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="538" height="1"></td></tr>
            <tr bgcolor="#F9FAFB"><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="6"></td></tr>
            <?php 
	...
	if($result = mysql_query($sql, $db) or die("error while browsing file categories for selecting keywords")) {
		...
		while($row = mysql_fetch_array($result)) {
			if(get_filecat_childcount ($row["fcat_id"], $db)) {
				...
				$k .= "<td><select name=\"file_keywords[".$row["fcat_id"]."]\" class=\"f10b\">\n";
	...
	<tr bgcolor="#F9FAFB">
              ...
              <td><table border="0" cellpadding="0" cellspacing="0" summary="">
                  ...
                  <tr>
                    ...
                    <td><input name="file_shortinfo" type="text" class="v10" style="font-weight: bold; width: 350px;" id="file_shortinfo" size="40" maxlength="250"></td>
                  </tr>
                </table>
              </td>
            </tr>
            <tr bgcolor="#F9FAFB"><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="6"></td></tr>
             <tr bgcolor="#D9DEE3"><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="538" height="1"></td></tr>
            <tr><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="8"></td></tr>
            <tr>
              <td align="right" valign="top" class="v09"><img src="img/leer.gif" alt="" width="1" height="13"><?php echo $BL['be_ftptakeover_longinfo'] ?>:&nbsp;</td>
              <td valign="top"><textarea name="file_longinfo" cols="40" rows="10" class="v10" id="file_longinfo" style="width: 450px;"></textarea></td>
            </tr>
            <tr><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="9"></td></tr>
            <tr>
              ...
              <td><table border="0" cellpadding="1" cellspacing="0" bgcolor="#E6EAED" summary="">
                  <tr>
					...
					<!--
					<td><input name="file_thumb" type="checkbox" id="file_thumb" value="1"></td>
                    <td class="v10"><strong><?php echo $BL['be_ftptakeover_createthumb'] ?></strong></td>
					//-->
