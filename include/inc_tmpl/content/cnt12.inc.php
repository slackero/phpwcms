...
<div class="form-group row g-2">
  <label for="cnewsletter_subscription" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_subscription'] ?></label>
  <div class="col">
      <?php
...
<div class="form-group align-items-center row g-2">
  <label for="cnewsletter_label_email" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_labelemail'] ?></label>
  <div class="col-sm-4">
    ...
    <label class="col-sm-2 col-form-label text-sm-end mt-3 mt-sm-0">
        <strong><?php
  ...
  <div class="col">
    <select name="cnewsletter_pos" id="cnewsletter_pos" class="form-select form-select-sm">
...
<div class="form-group align-items-center row g-2">
  <label for="cnewsletter_label_name" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_labelname'] ?></label>
  <div class="col-sm-4">
...
<div class="form-group align-items-center row g-2">
  <label for="cnewsletter_label_subscriptions" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_labelsubsc'] ?></label>
  <div class="col-sm-4">
...
<div class="form-group row g-2">
  <label for="cnewsletter_text" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_infotext'] ?></label>
  <div class="col">
...
<div class="form-group row g-2">
  <label for="cnewsletter_success_text" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_successtext'] ?></label>
  <div class="col">
...
<div class="form-group align-items-center row g-2">
  <label for="cnewsletter_url1" class="col-sm-2 col-form-label text-end">URL 1</label>
  <div class="col-sm-4">
...
<div class="form-group align-items-center row g-2">
  <label for="cnewsletter_url2" class="col-sm-2 col-form-label text-end">URL 2</label>
  <div class="col-sm-4">
...
<div class="form-group align-items-center row g-2">
  <label for="cnewsletter_recaptcha" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_field']['recaptcha']; ?></label>
  <div class="col-sm-4">
    <select name="cnewsletter_recaptcha" class="form-select form-select-sm">
...
<div class="form-group row g-2">
  <label for="cnewsletter_recaptcha_config" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_settings']; ?></label>
  <div class="col">
...
<div class="form-group row g-2">
  <label for="cnewsletter_reg_text" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_regmail'] ?></label>
  <div class="col">
...
<div class="form-group row g-2">
  <label for="cnewsletter_logoff_text" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_logoffmail'] ?></label>
  <div class="col">
...
<div class="form-group row g-2">
  <label for="cnewsletter_change_text" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_changemail'] ?></label>
  <div class="col">
