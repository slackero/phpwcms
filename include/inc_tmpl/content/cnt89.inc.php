...
<div class="form-group form-row">
	...
	<div class="col">
		<select name="cimage_list[]" size="<?php echo is_array($content['poll_select']) && count($content['poll_select']) ? count($content['poll_select'])+6 : 6 ?>" multiple="multiple" class="custom-select form-control form-control-sm" id="cimage_list">
			<?php
