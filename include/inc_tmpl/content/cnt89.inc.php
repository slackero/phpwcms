...
<div class="form-group row g-2">
	<label for="cpoll_buttonstyle" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_attribute_class']; ?></label>
	<div class="col-sm-4">
...
<div class="form-group row g-2">
	<label for="cpoll_buttontext" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_buttontext']; ?></label>
	<div class="col-sm-4">
...
<div class="form-group row g-2">
	<label for="cpoll_caption" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_poll_choices']; ?></label>
	<div class="col-sm-10">
...
<div class="form-group row g-2">
	...
	<div class="col-sm-auto">
		<button type="button" class="modalButton btn btn-sm btn-blue mb-1 d-block" title="<?php echo $BL['be_cnt_openimagebrowser'] ?>" data-bs-toggle="modal" data-bs-target="#browserModal" data-src="filebrowser.php?opt=1&amp;target=nolist"><i class="fa fa-folder-open fa-fw" aria-hidden="true"></i></button>
...
<div class="form-group row g-2 align-items-center">
	<label for="cpoll_width" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_ftptakeover_size'] ?></label>
	<div class="col-sm-auto">
	...
	<div class="col-sm-auto d-flex align-items-center">
		<div class="form-check form-check-inline">
			<input name="cpoll_zoom" type="checkbox" id="cpoll_zoom" value="1" class="form-check-input" <?php is_checked(1, $content['poll_list']['zoom']); ?> />
			<label class="form-check-label" for="cpoll_zoom"><?php echo $BL['be_cnt_enlarge'] ?></label>
		</div>
	</div>
</div>
