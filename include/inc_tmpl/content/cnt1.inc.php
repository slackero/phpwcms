...
<div class="form-group align-items-center row g-2">
  ...
  <div class="col-sm-4">
    <div class="input-group">
      ...
      <button class="modalButton btn btn-sm btn-blue folder-open" type="button" data-bs-toggle="modal" data-bs-target="#browserModal" data-src="filebrowser.php?opt=0&amp;target=nolist" title="<?php echo $BL['be_cnt_openimagebrowser']; ?>"><i class="fa-solid fa-folder-open fa-fw" aria-hidden="true"></i></button>
