...
<div class="form-group align-items-center row g-2">
  ...
  <div class="col-sm-auto">
    <div class="input-group input-group-sm">
      ...
      <button class="modalButton btn btn-sm btn-blue sitemap-open" type="button" data-bs-toggle="modal" data-bs-target="#browserModal" data-src="articlebrowser.php?opt=4&amp;field=news_archive_link" title="<?php echo $BL['be_cnt_openarticlebrowser'] ?>"><i class="fa fa-sitemap fa-fw" aria-hidden="true"></i></button>
    </div>
  </div>
  <div class="col">
...
<div class="form-group align-items-center row g-2">
  ...
  <div class="col-sm-auto">
    <div class="input-group input-group-sm">
      ...
      <button class="modalButton btn btn-sm btn-blue sitemap-open" type="button" data-bs-toggle="modal" data-bs-target="#browserModal" data-src="articlebrowser.php?opt=4&amp;field=news_detail_link" title="<?php echo $BL['be_cnt_openarticlebrowser'] ?>"><i class="fa fa-sitemap fa-fw" aria-hidden="true"></i></button>
    </div>
  </div>
  <div class="col">
      <?php echo $BL['be_article_urlalias'].'/'.$BL['be_func_struct_articleID'] ?>
