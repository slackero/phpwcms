...
<div class="form-group align-items-center form-row mb-2">
  ...
  <div class="col-sm-auto px-sm-4">
		...
		if($for_select != '') {
			...
			echo '<select name="successInfo" id="successInfo" class="custom-select form-control form-control-sm custom-select" ';
			...
			echo '<a class="btn btn-sm btn-blue insert px-3" value="GO" onclick="insertAtCursorPos(document.articlecontent.cform_onsuccess, document.articlecontent.successInfo.options[document.articlecontent.successInfo.selectedIndex].value);"></a>';
			echo '</span>';
			echo '</div>';
		}
		?>
...
<div class="form-group form-row">
  <label class="col-sm-2 col-form-label"></label>
    <div class="col">
    	<textarea name="cform_onsuccess" id="cform_onsuccess" rows="3" class="form-control form-control-sm"><?php echo html($content['form']["onsuccess"]) ?></textarea>
		</div>
</div>
...
<table class="table w-100" style=" position: relative;">
<tr bgcolor="#e9ecef">
    <th class="px-1" style="width: 30px">&nbsp;</th>
    <th class="px-1" style="width: 30px">&nbsp;</th>
    ...
    <th class="px-0 text-center" style="width: 30px;"><i class="fas fa-trash" data-toggle="tooltip" data-placement="top" title="<?php echo $BL['be_cnt_delete'] ?>" alt="<?php echo $BL['be_cnt_delete'] ?>"></i></th>
</tr>
</table>
...
if(isset($content['form']["fields"]) && is_array($content['form']["fields"]) && count($content['form']["fields"])) {
    ...
    foreach($content['form']["fields"] as $key => $value) {
        ...
        $field_bg   = ($field_counter % 2) ? '' : ' bgcolor="transparent"';
        $field_row4 = '';
        ...
        switch($field_type) {
            ...
            case 'newsletter':      // default hide/show
                ...
                $field_row4 .= '<td colspan="3" align="right" valign="top">&nbsp;';
            ...
            case 'radio':
                ...
                if($content['form']["saveprofile"]) {
                    ...
                    $field_row4  = '<tr'.$field_bg.' id="formRow_'.$field_counter.'_5">';
                    $field_row4 .= '<td colspan="3" align="right">'.$BL['be_cnt_store_in'].':&nbsp;</td>';
            ...
            case 'list':
                ...
                if($content['form']["saveprofile"]) {
                    ...
                    $field_row4  = '<tr'.$field_bg.' id="formRow_'.$field_counter.'_5">';
                    $field_row4 .= '<td colspan="2" align="right">'.$BL['be_cnt_store_in'].':&nbsp;</td>';
        ...
        echo '</td><td align="right" valign="top"><a name="field_value_'.$field_counter.'"></a>';
        echo "</td></tr>";


        echo "</table></td>";
				echo '<td colspan="1" valign="top" class="py-2 text-right">&nbsp;'.$BL['be_cnt_value'].'&nbsp;</td>';
        echo '<td colspan="4" class="py-2"><textarea name="cform_field_value['.$field_counter.']" ';
        echo 'id="cform_field_value_'.$field_counter.'" rows="5" class="form-control form-control-sm">';
        ...
        if($field_type === 'recaptcha' || $field_type === 'recaptchainv') {
            echo '<a href="https://www.google.com/recaptcha/admin"
                target="_blank"
                class="d-inline-block underline my-2">'.$BL['be_cnt_field']['recaptcha_signapikey'].'</a>';
        }
        ...
        echo '<td colspan="3" class="text-right pb-2">&nbsp;'.$BL['be_newsletter_placeholder'].'&nbsp;</td>';
        ...
        echo '<td colspan="3" class="text-right pb-2">&nbsp;'.$BL['be_cnt_error_text'].'&nbsp;</td>';
        ...
        echo '<td colspan="3" class="text-right pb-2">&nbsp;'.$BL['be_cnt_css_class'].'&nbsp;</td>';
        ...
        echo '<td colspan="3">
             <table class="table-borderless w-100" cellpadding="0" cellspacing="0" border="0"><tr>
...
<table class="table-borderless w-100 bg-grey mb-3">
  <tr>
    <td width="30">&nbsp;</td>
    <td width="30">&nbsp;</td>
    <td width="25%" class="py-3">
    	<select name="cform_field_type[0]" id="cform_field_type" class="custom-select form-control form-control-sm">
  ...
  <tr>
    <td colspan="3" valign="top" class="text-right"><a name="field_value_0" id="field_value_0"></a>&nbsp;<?php echo $BL['be_cnt_value'] ?>&nbsp;</td>
    <td colspan="4"><textarea name="cform_field_value[0]" id="cform_field_value_0" rows="5" class="form-control form-control-sm"></textarea></td>
    <td colspan="3" valign="bottom"></td>
  </tr>
  <tr>
    <td colspan="3" class="text-right pt-2">&nbsp;<?php echo $BL['be_newsletter_placeholder'] ?>&nbsp;</td>
    <td colspan="4" class="pt-2"><input type="text" name="cform_field_placeholder[0]" class="form-control form-control-sm" /></td>
  </tr>
  <tr>
    <td colspan="3" class="text-right">&nbsp;<?php echo $BL['be_cnt_error_text'] ?>&nbsp;</td>
    <td colspan="4" class="py-2"><input type="text" name="cform_field_error[0]" class="form-control form-control-sm" /></td>
  </tr>
  <tr>
