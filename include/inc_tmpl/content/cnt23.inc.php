...
?>
<tr>
    <td colspan="2" class="rowspacer0x7"><img src="img/leer.gif" alt="" width="1" height="5"/><input type="hidden"
                                                                                                     name="target_ctype"
                                                                                                     value="23"/></td>
</tr>
<tr>
    ...
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td>&nbsp;</td>
                <td><input name="cform_subject" type="text" id="cform_subject" class="f11b" style="width:230px"
                           value="<?php echo html($content['form']["subject"]) ?>" size="40"/></td>
            </tr>
        </table>
    </td>
</tr>
    ...
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td>&nbsp;</td>
                <td><input name="cform_target" type="text" id="cform_target" class="f11b" style="width:230px"
                           value="<?php echo html($content['form']["target"]) ?>" size="40"/></td>
            </tr>
        </table>
    </td>
</tr>
    ...
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td>&nbsp;</td>
                <td><input name="cform_sender" type="text" id="cform_sender" class="f11b" style="width:230px"
                           value="<?php echo html($content['form']['sender']) ?>" size="40"/></td>
            </tr>
        </table>
    </td>
</tr>
    ...
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td>&nbsp;</td>
                <td><input name="cform_sendername" type="text" id="cform_sendername" class="f11b" style="width:230px"
                           value="<?php echo html($content['form']['sendername']) ?>" size="40"/></td>
            </tr>
        </table>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td><input type="checkbox" name="cform_sendcopy"
                           value="1"<?php echo is_checked('1', $content['form']["sendcopy"], 0, 0) ?>
                           title="send copy to selected field"/>&nbsp;
                </td>
                <td><select name="cform_copyto" class="v11" style="width:180px;">
                        <?php echo $cc_listing; ?>
                    </select></td>
                <td>&nbsp;</td>
                <td><input name="cform_cc" type="text" id="cform_cc" class="f11b" style="width:230px"
                           value="<?php echo html($content['form']['cc']) ?>" size="40"/></td>
            </tr>
        </table>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0" bgcolor="#E7E8EB">
            <tr>
                <td><input type="checkbox" name="cform_checktofrom" id="cform_checktofrom"
                           value="1" <?php is_checked(1, $content['form']['checktofrom']) ?> /></td>
                <td class="v10"><label
                            for="cform_checktofrom">&nbsp;<?php echo $BL['be_cnt_field']['checktofrom'] ?></label>&nbsp;
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    ...
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0" bgcolor="#E7E8EB">
            <tr>
                <td><input type="checkbox" name="cform_ssl" id="cform_ssl"
                           value="1" <?php is_checked(1, $content['form']['ssl']) ?> /></td>
...
<tr>
    ...
    <td><?php
        ...
        <table summary="" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td bgcolor="#E7E8EB"><input type="checkbox" name="cform_savedb" id="cform_savedb"
                                             value="1" <?php echo is_checked(1, $content['form']["savedb"], 0, 0) ?> />
                </td>
                <td class="v10" bgcolor="#E7E8EB"><label
                            for="cform_savedb">&nbsp;<?php echo $BL['be_cnt_formsave_in_db'] ?></label>&nbsp;
                </td>
            </tr>
            <tr>
                <td colspan="2"><img src="img/leer.gif" alt="" width="1" height="2"/></td>
            ...
            <tr>
                <td bgcolor="#E7E8EB"><input type="checkbox" name="cform_saveprofile" id="cform_saveprofile"
                                             value="1" <?php echo is_checked(1, $content['form']["saveprofile"], 0, 0) ?>
                                             onchange="this.form.submit();"/></td>
                <td class="v10" bgcolor="#E7E8EB"><label
                            for="cform_saveprofile">&nbsp;<?php echo $BL['be_cnt_formsave_profile'] ?></label>&nbsp;
                </td>
            </tr>
            <tr>
                <td colspan="2"><img src="img/leer.gif" alt="" width="1" height="2"/></td>
            ...
            <tr>
                <td bgcolor="#E7E8EB"><input type="checkbox" name="cform_tracking_off" id="cform_tracking_off"
                                             value="1" <?php echo is_checked(1, $content['form']["formtracking_off"], 0, 0) ?> />
                </td>
                <td class="v10" bgcolor="#E7E8EB"><label
                            for="cform_tracking_off">&nbsp;<?php echo $BL['be_cnt_field']['formtracking_off'] ?></label>&nbsp;
                </td>
            </tr>
        </table>
    </td>
...
<tr>
    <td align="right" class="chatlist" valign="top"><img src="img/leer.gif" alt="" width="1"
                                                         height="15"/><?php echo $BL['be_admin_tmpl_default'] ?>:&nbsp;
    </td>
    <td>
        <table summary="" cellpadding="1" cellspacing="0" border="0">
            <tr bgcolor="#E7E8EB">
                <td><input type="radio" name="cform_startup_html" id="cform_startup_html0"
                           value="0"<?php echo is_checked('0', $content['form']["startup_html"], 0, 0) ?> title="Text"/>
                </td>
                <td class="v10"><label for="cform_startup_html0">Text&nbsp;</label>&nbsp;</td>
                <td><input type="radio" name="cform_startup_html" id="cform_startup_html1"
                           value="1"<?php echo is_checked('1', $content['form']["startup_html"], 0, 0) ?> title="HTML"/>
                </td>
                <td class="v10"><label for="cform_startup_html1">HTML&nbsp;</label>&nbsp;</td>
            </tr>
        </table>
        <textarea name="cform_startup" id="cform_startup" rows="5"
                  class="width440 autosize"><?php echo html($content['form']["startup"]) ?></textarea></td>
</tr>
...
<tr>
    <td align="right" class="chatlist" valign="top"><img src="img/leer.gif" alt="" width="1"
                                                         height="15"/><?php echo $BL['be_cnt_onsuccess'] ?>:&nbsp;
    </td>
    <td>
        <table summary="" cellpadding="0" cellspacing="0" border="0">
            <tr bgcolor="#E7E8EB">
                <td><input type="radio" name="cform_onsuccess_redirect" id="cform_onsuccess_redirect0"
                           value="0"<?php echo is_checked('0', $content['form']["onsuccess_redirect"], 0, 0) ?>
                           title="redirect on success"/></td>
                <td class="v10"><label for="cform_onsuccess_redirect0">Text&nbsp;</label>&nbsp;</td>
                <td><input type="radio" name="cform_onsuccess_redirect" id="cform_onsuccess_redirect2"
                           value="2"<?php echo is_checked('2', $content['form']["onsuccess_redirect"], 0, 0) ?>
                           title="redirect on success"/></td>
                ...
                <td><input type="radio" name="cform_onsuccess_redirect" id="cform_onsuccess_redirect1"
                           value="1"<?php echo is_checked('1', $content['form']["onsuccess_redirect"], 0, 0) ?>
                           title="redirect on success"/></td>
        ...
        <textarea name="cform_onsuccess" id="cform_onsuccess" rows="3"
                  class="width440 autosize"><?php echo html($content['form']["onsuccess"]) ?></textarea>
    </td>
</tr>
<tr>
    <td colspan="2"><img src="img/leer.gif" alt="" width="1" height="2"/></td>
...
<tr>
    <td align="right" class="chatlist" valign="top"><img src="img/leer.gif" alt="" width="1"
                                                         height="15"/><?php echo $BL['be_cnt_onerror'] ?>:&nbsp;
    </td>
    <td>
        <table summary="" cellpadding="1" cellspacing="0" border="0">
            <tr bgcolor="#E7E8EB">
                <td><input type="radio" name="cform_onerror_redirect" id="cform_onerror_redirect0"
                           value="0"<?php echo is_checked('0', $content['form']["onerror_redirect"], 0, 0) ?>
                           title="redirect on success"/></td>
                <td class="v10"><label for="cform_onerror_redirect0">Text&nbsp;</label>&nbsp;</td>
                <td><input type="radio" name="cform_onerror_redirect" id="cform_onerror_redirect2"
                           value="2"<?php echo is_checked('2', $content['form']["onerror_redirect"], 0, 0) ?>
                           title="redirect on success"/></td>
                <td class="v10"><label for="cform_onerror_redirect2">HTML&nbsp;</label>&nbsp;</td>
                <td bgcolor="#FFFFFF" style="padding-bottom: 5px;">&nbsp;</td>
                <td><input type="radio" name="cform_onerror_redirect" id="cform_onerror_redirect1"
                           value="1"<?php echo is_checked('1', $content['form']["onerror_redirect"], 0, 0) ?>
                           title="redirect on success"/></td>
        ...
        <textarea name="cform_onerror" rows="3"
                  class="width440 autosize"><?php echo html($content['form']["onerror"]) ?></textarea>
    </td>
</tr>
    ...
    <td colspan="2">
        ...
        <table summary="" cellpadding="0" cellspacing="1" border="0">
                ...
                <td colspan="6" style="padding:3px 0 3px 0">
                    <table summary="" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            ?>
                            <td><input type="radio" name="cform_labelpos" id="cform_labelpos3"
                                       value="3"<?php echo is_checked(3, $content['form']["labelpos"], 0, 1) ?> /></td>
                            <td><label for="cform_labelpos3"><img src="img/symbole/label_3.gif" width="72" height="22"
                                                                  alt=""/></label></td>

                            <td>&nbsp;&nbsp;</td>

                            <td><input type="radio" name="cform_labelpos" id="cform_labelpos0"
                                       value="0"<?php echo is_checked(0, $content['form']["labelpos"], 0, 1) ?> /></td>
                            <td><label for="cform_labelpos0"><img src="img/symbole/label_0.gif" width="70" height="22"
                                                                  alt=""/></label></td>

                            <td>&nbsp;&nbsp;</td>
                            <td><input type="radio" name="cform_labelpos" id="cform_labelpos1"
                                       value="1"<?php echo is_checked(1, $content['form']["labelpos"], 0, 1) ?> /></td>
                            <td><label for="cform_labelpos1"><img src="img/symbole/label_1.gif" width="60" height="22"
                                                                  alt=""/></label></td>

                            <td>&nbsp;&nbsp;</td>
                            <td><input type="radio" name="cform_labelpos" id="cform_labelpos2"
                                       value="2"<?php echo is_checked(2, $content['form']["labelpos"], 0, 1) ?> /></td>
                            <td><label for="cform_labelpos2"><img src="img/symbole/label_2.gif" width="60" height="22"
                                                                  alt=""/></label></td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="cform_class" class="width120"
                           value="<?php echo html($content['form']["class"]) ?>"/></td>
                <td class="chatlist" align="right">&nbsp;<?php echo $BL['be_cnt_label_wrap'] ?>:&nbsp;</td>
                <td colspan="4"><input type="text" name="cform_label_wrap" class="v10 width85"
                                       value="<?php echo html($content['form']["label_wrap"]) ?>"/></td>
            </tr>

            <tr>
                <td colspan="2" class="chatlist" align="right"><?php echo $BL['be_cnt_req_mark'] ?>:&nbsp;</td>
                <td><input type="text" name="cform_reqmark" class="width120"
                           value="<?php echo html($content['form']["cform_reqmark"]) ?>"/></td>
                <td class="chatlist" align="right">&nbsp;<?php echo $BL['be_cnt_error_class'] ?>:&nbsp;</td>
                <td colspan="4"><input type="text" name="cform_error_class" class="v10 width85"
                                       value="<?php echo html($content['form']["error_class"]) ?>"/></td>
            </tr>

            <tr>
                <td colspan="2" class="chatlist" align="right"><?php echo $BL['be_cnt_function_validate'] ?>:&nbsp;</td>
                <td><input type="text" name="cform_function_validate" class="width120"
                           value="<?php echo html($content['form']["cform_function_validate"]) ?>"/></td>
                <td class="chatlist" align="right" class="nowrap">
                    <?php echo $BL['be_article_cnt_anchor'] . ' &ndash; ' . $BL['be_cnt_target']; ?>:<input
                            type="checkbox" name="cform_anchor_off" id="cform_anchor_off"
                            value="0"<?php is_checked(0, $content['form']["anchor_off"]) ?> />
                </td>
                <td colspan="4"><input type="text" name="cform_anchor_name" class="v10 width85"
                                       value="<?php echo html($content['form']["anchor_name"]) ?>"
                                       placeholder="jumpForm<?php echo empty($content["id"]) ? '' : $content["id"]; ?>"/>
                </td>
            </tr>
            ...
            <tr bgcolor="#E6ECF2">
                ...
                <td align="center" style="padding: 1px"><img src="img/article/fill_in_here.gif"
                                                             alt="<?php echo $BL['be_cnt_needed'] ?>"
                                                             title="<?php echo $BL['be_cnt_needed'] ?>" border="0"/>
                </td>
                <td align="center" style="padding: 1px"><img src="img/button/trash_13x13_1.gif"
                                                             alt="<?php echo $BL['be_cnt_delete'] ?>"
                                                             title="<?php echo $BL['be_cnt_delete'] ?>" border="0"/>
                </td>
            </tr>
            <?php
            if (isset($content['form']["fields"]) && is_array($content['form']["fields"]) && count($content['form']["fields"])) {
            ...
            <tr bgcolor="#E7E8EB">
                ...
                <td><input type="text" name="cform_field_size[0]" class="width40"
                           title="SIZE for Text/COLUMNS for Textarea"/></td>
                <td><input type="text" name="cform_field_max[0]" class="width40"
                           title="MAXLENGTH for Text/ROWS for Textarea and List"/></td>
                <td><input type="checkbox" name="cform_field_required[0]" value="1" title="mark as required field"/>
                </td>
                <td>&nbsp;<input type="hidden" name="cform_order[0]" value="<?php echo $field_counter ?>"/></td>
            </tr>
            <tr bgcolor="#E7E8EB">
                <td colspan="2" class="chatlist" valign="top" align="right"><a name="field_value_0"
                                                                               id="field_value_0"></a>&nbsp;<img
                            src="img/leer.gif" alt="" width="1" height="15"/><?php echo $BL['be_cnt_value'] ?>:&nbsp;
                </td>
                <td colspan="4"><textarea name="cform_field_value[0]" id="cform_field_value_0" rows="5"
                                          class="code width340 autosize"></textarea></td>
            ...
            <tr bgcolor="#E7E8EB">
                ...
                <td colspan="5">
                    <table summary="" cellpadding="0" cellspacing="0" border="0" style="width:202px;">
                        <tr>
                            <td class="chatlist" style="width:82px;" align="right">
                                &nbsp;<?php echo $BL['be_cnt_css_style'] ?>:&nbsp;
                            </td>
            ...
            <tr>
                <td colspan="2">&nbsp;</td>
                <td colspan="6"><input type="submit" value="<?php echo $BL['be_article_cnt_button1'] ?>" class="v09"/>
                </td>
            </tr>
...
<tr>
    <td colspan="2">
        <table summary="" cellpadding="0" cellspacing="0" border="0" bgcolor="#E7E8EB" style="margin-top:3px;">
            <tr>
                <td><input type="radio" name="cform_template_format" id="cform_template_text"
                           value="0"<?php is_checked('0', $content['form']["template_format"]) ?>
                           onchange="this.form.submit();"/></td>
                <td class="f10"><label for="cform_template_text">TEXT&nbsp;&nbsp;</label></td>
                <td><input type="radio" name="cform_template_format" id="cform_template_html"
                           value="1"<?php is_checked('1', $content['form']["template_format"]) ?>
                           onchange="this.form.submit();"/></td>
...
<tr>
    ...
    <td><input name="cform_function_to" type="text" id="cform_function_to" class="v11 width200"
               value="<?php echo html($content['form']['function_to']) ?>" size="40"/></td>
</tr>
...
<tr>
    <td colspan="2" class="tdtop3">
        <table summary="" cellpadding="0" cellspacing="0" border="0" bgcolor="#E7E8EB">
            ...
            <tr>
                <td><input type="checkbox" name="cform_template_equal" id="cform_template_equal"
                           value="1"<?php is_checked(1, $content['form']["template_equal"]) ?>
                           onchange="showhidecopy();"/></td>
                <td class="v10"><label
                            for="cform_template_equal">&nbsp;= <?php echo $BL['be_cnt_recipient'] . ' - ' . $BL['be_admin_struct_template'] ?>
                        &nbsp;&nbsp;</label></td>
            </tr>
...
<tr id="copytemplate1">
    <td colspan="2" class="tdtop3">
        <table summary="" cellpadding="0" cellspacing="0" border="0" bgcolor="#E7E8EB">
            <tr>
                <td><input type="radio" name="cform_template_format_copy" id="cform_template_text_copy"
                           value="0"<?php is_checked(0, $content['form']["template_format_copy"]) ?>
                           onchange="this.form.submit();"/></td>
                <td class="f10"><label for="cform_template_text_copy">TEXT&nbsp;&nbsp;</label></td>
                <td><input type="radio" name="cform_template_format_copy" id="cform_template_html_copy"
                           value="1"<?php is_checked(1, $content['form']["template_format_copy"]) ?>
                           onchange="this.form.submit();"/></td>
...
<tr>
    <td align="right" class="chatlist"><?php echo $BL['php_function'] ?>:&nbsp;</td>
    <td><input name="cform_function_cc" type="text" id="cform_function_cc" class="v11 width200"
               value="<?php echo html($content['form']['function_cc']) ?>" size="40"/></td>
</tr>
...
<tr>
    <td class="chatlist" colspan="2" style="padding-bottom:3px;"><a name="anchor_customform"
                                                                    id="anchor_customform"></a><?php echo $BL['be_admin_struct_template'] ?>
        :&nbsp;
    </td>
</tr>
<?php
...
<tr>
    <td colspan="2">
        <textarea name="cform_customform" id="cform_customform" rows="5"
                  class="code width540 autosize"><?php echo html($content['form']["customform"]) ?></textarea>
    </td>
</tr>
