...
<tr>
    ...
    <td><table class="table-no-border" class="width440">
        <tr>
            <td><select name="fmp_template" id="fmp_template" class="custom-select width150">
<?php
...
?>
            ...
            <td><select class="custom-select" name="fmp_width_height" id="fmp_width_height" onchange="setPlayerSize(this);">
...
<tr>
    <td align="right" valign="top"><strong><?php echo $BL['be_html5_media'] ?></strong>:&nbsp;</td>
    ...
    <td><table class="table-no-border">
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext0_h264"><?php echo $BL['be_cnt_internal'] ?>&nbsp;</label></td>
            <td>&nbsp;<input name="fmp_internal_id_h264" type="hidden" id="fmp_internal_id_h264" value="<?php echo $fmp_data['fmp_internal_id_h264'] ?>" /></td>
            <td><input name="fmp_internal_name_h264" type="text" id="fmp_internal_name_h264" class="width300 greyed modalButton" value="<?php echo html($fmp_data['fmp_internal_name_h264']) ?>" size="40" onfocus="this.blur()" /></td>
            <td><img src="img/button/open_image_button.gif" title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" alt="<?php echo $BL['be_cnt_openmediabrowser'] ?>" border="0" hspace="3" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=12" class="modalButton" /></td>
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext1_h264"><?php echo $BL['be_cnt_external'] ?>&nbsp;</label></td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext0_webm"><?php echo $BL['be_cnt_internal'] ?>&nbsp;</label></td>
            <td>&nbsp;<input name="fmp_internal_id_webm" type="hidden" id="fmp_internal_id_webm" value="<?php echo $fmp_data['fmp_internal_id_webm'] ?>" /></td>
            <td><input name="fmp_internal_name_webm" type="text" id="fmp_internal_name_webm" class="width300 greyed modalButton" value="<?php echo html($fmp_data['fmp_internal_name_webm']) ?>" size="40" onfocus="this.blur()" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=13" class="modalButton" data-title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" /></td>
            <td><img src="img/button/open_image_button.gif" title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" alt="<?php echo $BL['be_cnt_openmediabrowser'] ?>" border="0" hspace="3" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=13" class="modalButton" /></td>
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext1_webm"><?php echo $BL['be_cnt_external'] ?>&nbsp;</label></td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext0_ogg"><?php echo $BL['be_cnt_internal'] ?>&nbsp;</label></td>
            <td>&nbsp;<input name="fmp_internal_id_ogg" type="hidden" id="fmp_internal_id_ogg" value="<?php echo $fmp_data['fmp_internal_id_ogg'] ?>" /></td>
            <td><input name="fmp_internal_name_ogg" type="text" id="fmp_internal_name_ogg" class="width300 greyed modalButton" value="<?php echo html($fmp_data['fmp_internal_name_ogg']) ?>" size="40" onfocus="this.blur()" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=14" class="modalButton" data-title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" /></td>
            <td><img src="img/button/open_image_button.gif" title="<?php echo $BL['be_cnt_openmediabrowser'] ?> alt="<?php echo $BL['be_cnt_openmediabrowser'] ?>" border="0" hspace="3" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=14" class="modalButton" /></td>
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext1_ogg"><?php echo $BL['be_cnt_external'] ?>&nbsp;</label></td>
            <td>&nbsp;</td>
...
<tr>
    <td align="right" valign="top"><strong><?php echo $BL['be_flash_media'] ?></strong>:&nbsp;</td>
    <td><table class="table-no-border">
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext0"><?php echo $BL['be_cnt_internal'] ?>&nbsp;</label></td>
            <td>&nbsp;<input name="fmp_internal_id" type="hidden" id="fmp_internal_id" value="<?php echo $fmp_data['fmp_internal_id'] ?>" /></td>
            <td><input name="fmp_internal_name" type="text" id="fmp_internal_name" class="width300 greyed modalButton" value="<?php echo html($fmp_data['fmp_internal_name']) ?>" size="40" onfocus="this.blur()" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=6" class="modalButton" data-title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" /></td>
            <td><img src="img/button/open_image_button.gif" title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" alt="<?php echo $BL['be_cnt_openmediabrowser'] ?>" border="0" hspace="3" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=6" class="modalButton" /></td>
        ...
        <tr>
            ...
            <td bgcolor="#E7E8EB"><label for="fmp_int_ext1"><?php echo $BL['be_cnt_external'] ?>&nbsp;</label></td>
            <td>&nbsp;</td>
...
<tr>
    <td align="right"><?php echo $BL['be_flashplayer_thumbnail'] ?>:&nbsp;</td>

    <td><table class="table-no-border">

        <tr>
            <td><input name="fmp_img_name" type="text" id="fmp_img_name" class="width300 greyed modalButton" value="<?php echo html($fmp_data['fmp_img_name']) ?>" size="40" onfocus="this.blur()" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=7" class="modalButton" data-title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" /></td>
            <td><img src="img/button/open_image_button.gif" title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" alt="<?php echo $BL['be_cnt_openmediabrowser'] ?>" border="0" hspace="3" data-toggle="modal" data-target="#browserModal" data-src="filebrowser.php?opt=7" class="modalButton" /></td>
...
<tr>
    ...
    <td><table class="table-no-border" class="settings">

        <tr>
            <td align="right"><label for="fmp_set_html5only"><?php echo $BL['be_display_html5_only'] ?>:&nbsp;</label></td>
        ...
        <tr>
            <td align="right"><label for="fmp_set_audio"><?php echo $BL['be_audio_only'] ?>:&nbsp;</label></td>
            <td><input type="checkbox" name="fmp_set_audio" id="fmp_set_audio" value="1"<?php is_checked(1, $fmp_data['fmp_set_audio']) ?> /></td>
        </tr>

        <tr>
            <td align="right"><label for="fmp_set_autostart">Autostart:&nbsp;</label></td>
        ...
        <tr>
            <td align="right"><label for="fmp_set_loop">Loop:&nbsp;</label></td>
            <td><input type="checkbox" name="fmp_set_loop" id="fmp_set_loop" value="1"<?php is_checked(1, $fmp_data['fmp_set_loop']) ?> /></td>
        </tr>

        <tr>
            <td align="right"><label for="fmp_set_preload">Preload:&nbsp;</label></td>
            <td><select class="custom-select" name="fmp_set_preload" id="fmp_set_preload">
        ...
        <tr>
            <td align="right"><label for="fmp_set_skin"><?php echo $BL['be_skin'].' '.$BL['be_html5_media'] ?>:&nbsp;</label></td>
            <td><select class="custom-select" name="fmp_set_skin_html5">
...
?>
        ...
        <tr>
            <td align="right"><label for="fmp_set_showcontrols">Controlbar:&nbsp;</label></td>
            <td><select class="custom-select" name="fmp_set_showcontrols" id="fmp_set_showcontrols">
        ...
        <tr>
            <td align="right"><label for="fmp_set_volume"><?php echo $BL['be_player_volume'] ?>:&nbsp;</label></td>
            <td><select class="custom-select" name="fmp_set_volume" id="fmp_set_volume">
...
<?php       endfor; ?>
        ...
        <tr>
            <td align="right"><label for="fmp_set_bgcolor"><?php echo $BL['be_background_color'].' '.$BL['be_flash_media'] ?> (HEX):&nbsp;</label></td>
        ...
        <tr>
            <td align="right"><label for="fmp_set_color"><?php echo $BL['be_foreground_color'].' '.$BL['be_flash_media'] ?> (HEX):&nbsp;</label></td>
        ...
        <tr>
            <td align="right"><label for="fmp_set_logo"><?php echo $BL['be_media_watermark'].' '.$BL['be_flash_media'].' ('.$BL['be_cnt_pages_cust'].')' ?>:&nbsp;</label></td>
