...
<tr>
    ...
    <td><select name="cguestbook_template" id="cguestbook_template" class="custom-select form-control">
<?php
// templates for article listing
$tmpllist = get_tmpl_files(CMSGO_TEMPLATE.'inc_cntpart/guestbook');
...
<?php
    ...
    $_aliasID_Query  = 'SELECT acontent_id,  acontent_visible, article_title, acontent_form FROM '.DB_PREPEND.'cmsgo_articlecontent';
    $_aliasID_Query .= ' LEFT JOIN '.DB_PREPEND.'cmsgo_article ON ';
    $_aliasID_Query .= ' ('.DB_PREPEND.'cmsgo_articlecontent.acontent_aid = '.DB_PREPEND.'cmsgo_article.article_id)';
    $_aliasID_Query .= ' WHERE '.DB_PREPEND.'cmsgo_articlecontent.acontent_id != '.$content["id"];
    $_aliasID_Query .= ' AND '.DB_PREPEND.'cmsgo_articlecontent.acontent_type=18';
    $_aliasID_Query .= ' AND '.DB_PREPEND.'cmsgo_articlecontent.acontent_trash=0';

    $_available_aliasID = _dbQuery($_aliasID_Query);

    if(count($_available_aliasID)) {
        echo '<td><select name="cguestbook_aliasID_select" id="cguestbook_aliasID_select" class="custom-select form-control">'.LF;
...
<tr>
  ...
  <td><table class="table-no-border">
      ...
      ?>
        ...
        <td bgcolor="#E7E8EB"><label for="cguestbook_listing0"><?php echo $BL['be_cnt_guestbook_listing_all'] ?></label>&nbsp;&nbsp;</td>
...
<tr>
  ...
  <td><table class="table-no-border">
      ...
      ?>
       ...
       <td><label for="cguestbook_login_show">&nbsp;<?php echo $BL['be_gb_show_login'] ?>&nbsp;&nbsp;</label></td>
     </tr>
     <tr bgcolor="#E7E8EB">
       ...
       <td><label for="cguestbook_login_post">&nbsp;<?php echo $BL['be_gb_post_login'] ?>&nbsp;&nbsp;</label></td>
      </tr>
      </table></td>
</tr>
...
<tr>
  ...
  <td><table class="table-no-border">
      ...
      if(empty($content["guestbook"]["max_image_filesize"])) {
        $content["guestbook"]["max_image_filesize"] = $cmsgo['file_maxsize'];
      }

      $content["guestbook"]["max_image_filesize"] = return_bytes_shorten($content["guestbook"]["max_image_filesize"]);

      if(return_bytes($content["guestbook"]["max_image_filesize"]) > $cmsgo['file_maxsize']) {
        $content["guestbook"]["max_image_filesize"] = return_bytes_shorten($cmsgo['file_maxsize']);
      }
      ...
      ?>
       ...
       <td bgcolor="#E7E8EB"><label for="cguestbook_imgupload">&nbsp;<?php echo $BL['be_on'] ?></label>&nbsp;&nbsp;</td>
       <td>&nbsp;&nbsp;</td>
...
<tr>
  ...
  <td><table border="0" cellpadding="0" cellspacing="0" bgcolor="#E7E8EB" summary="">
      ...
      ?>
        ...
        <td><label for="cguestbook_sorting0"><?php echo $BL['be_msg_date'].' '.$BL['be_admin_struct_orderdesc'] ?></label>&nbsp;</td>
        <td><input name="cguestbook_sorting" id="cguestbook_sorting1" type="radio" value="1" <?php is_checked(1, $content["guestbook"]["sorting"]); ?> /></td>
        <td><label for="cguestbook_sorting1"><?php echo $BL['be_msg_date'].' '.$BL['be_admin_struct_orderasc'] ?></label>&nbsp;</td>
      </tr>
    </table></td>
</tr>
<tr>
  ...
  <td><table class="table-no-border">
      ...
      ?>
       ...
       <td bgcolor="#E7E8EB"><label for="cguestbook_captcha">&nbsp;<?php echo $BL['be_admin_usr_verify'] ?></label>&nbsp;&nbsp;</td>
       <td>&nbsp;&nbsp;</td>
...
<tr>
  ...
  <td><table class="table-no-border">
      ...
      ?>
       ...
       <td bgcolor="#E7E8EB"><label for="cguestbook_urlcheck">&nbsp;<?php echo $BL['be_gb_urlcheck'] ?>&nbsp;&nbsp;</label></td>
      </tr>
      </table></td>
</tr>

<tr>
  <td align="right" valign="top"><?php echo $BL['be_cnt_guestbook_banned'] ?>:&nbsp;</td>
  <td valign="top"><textarea name="cguestbook_banned" cols="40" rows="3" class="form-control"><?php echo  isset($content["guestbook"]["banned"]) ? html($content["guestbook"]["banned"]) : '' ?></textarea></td>
</tr>
...
<tr>
  ...
  <td><table border="0" cellpadding="0" cellspacing="0" bgcolor="#E7E8EB" summary="">
      <tr>
        ...
        ?> /></td>
        <td><?php echo $BL['be_cnt_guestbook_setcookie'] ?>&nbsp;&nbsp;&nbsp;</td>
        <td><?php echo$BL['be_cnt_guestbook_allowed'] ?>&nbsp;</td>
        ...
        ?>" /></td>
        <td>&nbsp;<?php echo $BL['be_cnt_guestbook_seconds'] ?></td>
      </tr>
    </table></td>
</tr>
...
<tr>
     ...
     <tr>
        ...
        <td><label for="cguestbook_notify"><?php echo $BL['be_cnt_notify_by_email'] ?></label>&nbsp;</td>
...
<tr>
  <td align="right" valign="top"><?php echo $BL['be_cnt_guestbook_edit'] ?>:&nbsp;</td>
