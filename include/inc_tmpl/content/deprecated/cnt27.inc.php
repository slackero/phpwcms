...
<tr>
    ...
    <td><select name="faq_template" id="faq_template" class="custom-select form-control">
<?php

// templates for recipes
$tmpllist = get_tmpl_files(CMSGO_TEMPLATE.'inc_cntpart/faq');
...
<tr>
    ...
    <td><textarea name="faq_question" rows="4" class="form-control" id="faq_question"><?php
...
<tr><td colspan="2">&nbsp;<?php echo $BL['be_cnt_answer'] ?>:&nbsp;</td></tr>
<tr><td colspan="2"><?php
            ...
            <tr>
              ...
              <td valign="top"><table class="table-no-border">
                <tr>
                  ...
                  <td><input name="cimage_height" type="text" class="form-control" id="cimage_height" style="width: 50px;" size="3" maxlength="4" onkeyup="if(!parseInt(this.value,10)) this.value='';" value="<?php echo  isset($content["image_height"]) ? $content["image_height"] : '' ?>" /></td>
                  <td>&nbsp;px&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  ...
                  <td bgcolor="#E7E8EB">&nbsp;<label for="cimage_zoom"><?php echo $BL['be_cnt_enlarge'] ?></label>&nbsp;</td>
                  <td bgcolor="#E7E8EB"></td>
                </tr>
              </table></td>
              </tr>
