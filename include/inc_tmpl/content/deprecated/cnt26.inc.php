...
$content['recipe']['get_keywords'] = _dbQuery('SELECT acontent_text FROM '.DB_PREPEND.'cmsgo_articlecontent WHERE acontent_type=26 AND acontent_trash=0');
...
?>
<tr>
  <td align="right" valign="top"><?php echo $BL['be_ftptakeover_keywords'] ?>:&nbsp;</td>
...
<tr>
	...
	<td><select name="recipe_template" id="recipe_template" class="custom-select form-control">
<?php

// templates for recipes
$tmpllist = get_tmpl_files(CMSGO_TEMPLATE.'inc_cntpart/recipe');
...
<tr>
  <td align="right" valign="top">Zutaten:&nbsp;</td>
  <td valign="top"><textarea name="recipe_ingredients" id="recipe_ingredients" cols="40" rows="6" class="form-control"><?php echo html($content['recipe']['ingredients']) ?></textarea></td>
</tr>
...
<tr>
	...
	<td><table class="table-no-border">
		<tr>
			...
			<td align="right" style="width:75px;"><?php echo $BL['be_cnt_additional'] ?>:&nbsp;</td>
