...
<tr>
  ...
  <td valign="top"><table border="0" cellpadding="0" cellspacing="0" bgcolor="#E7E8EB" summary="">
      <tr>
        ...
        <td><?php echo $BL['be_cnt_ecardform_javascript'] ?>&nbsp;&nbsp;&nbsp;</td>
      </tr>
    </table></td>
</tr>
<tr>
    <td align="right"><?php echo $BL['be_cnt_ecardform_over'] ?>:&nbsp;</td>
...
<tr>
    <td align="right"><?php echo $BL['be_cnt_ecardform_click'] ?>:&nbsp;</td>
...
<tr>
    <td align="right"><?php echo $BL['be_cnt_ecardform_out'] ?>:&nbsp;</td>
...
if(is_array($content['ecard']['images']) && count($content['ecard']['images'])) {
    ...
    foreach($content['ecard']['images'] as $key => $value) {
        ...
        $thumb_image = get_cached_image(array(
            ...
            "thumb_name"    =>  md5($content['ecard']['images'][$key][2].$cmsgo["img_list_width"].$cmsgo["img_list_height"].$cmsgo["sharpen_level"].$cmsgo['colorspace'])
        ));
...
<tr>
  <td align="right"><?php echo $BL['be_cnt_alignment'] ?>:&nbsp;</td>
  <td><select class="custom-select" name="cecard_pos" id="cecard_pos">
...
<tr>
  ...
  <td valign="top"><table class="table-no-border">
      <tr>
        ...
        <td><input name="cecard_height" type="text" class="form-control" id="cecard_height" style="width: 50px;" size="3" maxlength="4" onKeyUp="if(!parseInt(this.value,10)) this.value='';" value="<?php echo $content["ecard"]["height"] ?>"></td>
        <td>&nbsp;&nbsp;px</td>
      </tr>
    </table></td>
</tr>
...
?>
        ...
        <td>&nbsp;&nbsp;<?php echo $BL['be_cnt_imagespace'] ?>:&nbsp;</td>
        <td><input name="cecard_space" type="text" class="form-control" id="cecard_space" style="width: 40px;" size="2" maxlength="2" onKeyUp="if(!parseInt(this.value,10)) this.value='';" value="<?php echo $content["ecard"]["space"] ?>"></td>
        <td>&nbsp;&nbsp;px&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <td bgcolor="#E7E8EB">&nbsp;<?php echo $BL['be_cnt_enlarge'] ?>&nbsp;</td>
        <td bgcolor="#E7E8EB"></td>
      </tr>
    </table></td>
</tr>
...
<tr>
  <td align="right" valign="top"><?php echo $BL['be_cnt_ecardtext'] ?>:&nbsp;</td>
...
if(!$content["ecard"]["form"]) {
    ...
    $content["ecard"]["form"] .= '<td rowspan="5"></td>'."\n";
    ...
    $content["ecard"]["form"] .= '<td colspan="2" bgcolor="#F8FFDF" style="margin:0 0 0 0;padding:2px 0 0 0;"></td>'."\n";
    $content["ecard"]["form"] .= '<td colspan="2" bgcolor="#F8FFDF" style="margin:0 0 0 0;padding:2px 0 0 0;"></td>'."\n";
    $content["ecard"]["form"] .= "</tr>\n";
    $content["ecard"]["form"] .= "<tr>\n";
    ...
    $content["ecard"]["form"] .= '<td colspan="2" bgcolor="#F8FFDF" style="margin:0 0 0 0;padding:2px 0 0 0;"></td>'."\n";
    $content["ecard"]["form"] .= "</tr>\n";
    $content["ecard"]["form"] .= '<tr><td colspan="5"></td></tr>'."\n";
    $content["ecard"]["form"] .= '<tr bgcolor="#99CC00"><td colspan="5"><strong style="color:#FFFFFF;">&nbsp;'.$BL['be_cnt_ecardform_msgtext'].'</strong></td></tr>'."\n";
    $content["ecard"]["form"] .= '<tr bgcolor="#F8FFDF"><td colspan="5" style="margin:0 0 0 0;padding:2px 0 0 0;"></td></tr>'."\n";
    ...
    $content["ecard"]["form"] .= '<tr bgcolor="#F8FFDF"><td colspan="5" style="margin:0 0 0 0;padding:4px 0 0 0;"></td></tr>'."\n";
    ...
    $content["ecard"]["form"] .= '<tr bgcolor="#F8FFDF"><td colspan="5"></td></tr>'."\n";
...
?>
<tr>
  <td align="right" valign="top"><?php echo $BL['be_cnt_ecardform'] ?>:&nbsp;</td>
  <td valign="top"><textarea name="cecard_form" rows="15" wrap="VIRTUAL" class="form-control" id="cecard_form"><?php echo html($content["ecard"]["form"]); ?></textarea></td>
</tr>
<tr>
  <td align="right" valign="top">&nbsp;</td>
  <td valign="top">HTML: ###ECARD_SUBJECT###, ###RECIPIENT_NAME###,
        ###RECIPIENT_EMAIL###,<br /> ###SENDER_MESSAGE###,
        ###ECARD_TITLE###, ###ECARD_IMAGE###</td>
</tr>
<tr>
  <td align="right" valign="top"><?php echo $BL['be_cnt_ecardsend'] ?>:&nbsp;</td>
  <td valign="top"><textarea name="cecard_send" rows="5" wrap="VIRTUAL" class="form-control" id="cecard_send"><?php echo html($content["ecard"]["send"]); ?></textarea></td>
</tr>
<tr>
  <td align="right" valign="top">&nbsp;</td>
  <td valign="top">HTML: ###ECARD_SUBJECT###, ###SENDER_NAME###,
    ###SENDER_EMAIL###, <br />###RECIPIENT_NAME###,
    ###RECIPIENT_EMAIL###, ###SENDER_MESSAGE###, <br />
    ###ECARD_IMAGE###, ###ECARD_TITLE###</td>
</tr>
<tr>
  <td align="right" valign="top"><?php echo $BL['be_cnt_ecardtmpl'] ?>:&nbsp;</td>
  <td valign="top"><textarea name="cecard_mail" rows="15" wrap="VIRTUAL" class="form-control" id="cecard_mail"><?php echo  html($content["ecard"]["mail"]) ?></textarea></td>
</tr>
