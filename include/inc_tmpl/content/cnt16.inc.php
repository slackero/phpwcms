...
<div class="form-group form-row">
	...
	<div class="col-sm-10">
		<div class="d-flex align-items-start">
			<div class="mr-2">
				<select name="cimage_list[]" size="<?php echo isset($content['ecard']['select']) && count($content['ecard']['select']) ? count($content['ecard']['select'])+5 : 5 ?>" multiple="multiple" class="form-control form-control-sm" id="cimage_list" style="width: 200px;">
					<?php
...
<div class="form-group form-row">
	...
	<label for="cecard_width" class="col-sm-2 col-form-label text-right"><?php echo $BL['be_cnt_maxw']; ?></label>
	<div class="col-sm-4">
		<div class="form-inline">
			<input name="cecard_width" type="text" class="form-control form-control-sm mr-2" id="cecard_width" style="width: 60px;" size="3" maxlength="4" onkeyup="if(!parseInt(this.value,10)) this.value='';" value="<?php echo $content['ecard']['width']; ?>" />
			<span class="mr-2"><?php echo $BL['be_cnt_maxh']; ?>:</span>
			<input name="cecard_height" type="text" class="form-control form-control-sm mr-2" id="cecard_height" style="width: 60px;" size="3" maxlength="4" onkeyup="if(!parseInt(this.value,10)) this.value='';" value="<?php echo $content['ecard']['height']; ?>" />
