...
$cinfo_pagefile = @unserialize($row['acontent_form'], ['allowed_classes' => false]);
if (!empty($cinfo_pagefile['pfile'])) {
    $cinfo[] = '<code>' . html(getCleanSubString($cinfo_pagefile['pfile'], 150, '&#8230;')) . '</code>';
}
