...
//Count message boxes
$sql = "SELECT COUNT(*) FROM ".DB_PREPEND."cmsgo_message WHERE ";
...
?><table width="538" border="0" cellpadding="0" cellspacing="0" summary="">
        ...
        <tr><td><table width="538" border="0" cellpadding="2" cellspacing="0" summary=""><tr>
         ...
         <td width="70" align="center" background="img/background/bg_eckeli.gif" <?php which_folder_active($msg_folder, 3) ?>><a href="cmsgo.php?do=messages<?php echo $msg_get["list"].$msg_get["order"]."&f=3" ?>"><?php echo $count_delmsg." ".$BL['be_msg_del'] ?></a></td>
         <td width="239" align="right" bgcolor="#FFFFFF" class="chatlist">
            <a href="cmsgo.php?do=messages<?php echo $msg_get["folder"].$msg_get["order"]."&l=10".$msg_get["msg"] ?>">10</a>
            <a href="cmsgo.php?do=messages<?php echo $msg_get["folder"].$msg_get["order"]."&l=25".$msg_get["msg"] ?>">25</a>
            <a href="cmsgo.php?do=messages<?php echo $msg_get["folder"].$msg_get["order"]."&l=50".$msg_get["msg"] ?>">50</a>
            <a href="cmsgo.php?do=messages<?php echo $msg_get["folder"].$msg_get["order"]."&l=100".$msg_get["msg"] ?>">100</a>
            <a href="cmsgo.php?do=messages<?php echo $msg_get["folder"].$msg_get["order"]."&l=500".$msg_get["msg"] ?>">250</a>
            <a href="cmsgo.php?do=messages<?php echo $msg_get["folder"].$msg_get["order"]."&l=99999".$msg_get["msg"] ?>"><?php echo $BL['be_ftptakeover_all'] ?></a>
        </td>
        </tr></table></td>
        ...
        <tr><td><img src="img/leer.gif" alt="" width="1" height="6"></td></tr>
            ...
            $msg_user = _dbQuery("SELECT usr_id, usr_login, usr_name, usr_email FROM ".DB_PREPEND."cmsgo_user");
            ...
            if(!empty($_GET["msg"]) && intval($_GET["msg"])) {
                if($msg_read == "I" && $msg) { //Wenn die Nachricht noch den Status Unread hat, setzen auf read
                    $sql =  "UPDATE ".DB_PREPEND."cmsgo_message SET msg_tstamp=msg_tstamp, msg_read=1 WHERE ".
                ...
                if($msg) {
                    $sql =  "SELECT msg_id, msg_pid, msg_uid, msg_subject, msg_from, msg_read, msg_deleted, ".
                            ...
                            "FROM ".DB_PREPEND."cmsgo_message WHERE ((msg_uid=".$_SESSION["wcs_user_id"]." AND msg_deleted<>9)".
      ...
      <table width="538" border="0" cellpadding="0" cellspacing="0" summary="">
        ...
        <tr bgcolor="#FFF8DF">
          <td width=4><img src="img/leer.gif" alt="" width="4" height="1"></td>
          <td><a href="cmsgo.php?do=messages<?php echo $msg_get["all"] ?>" title="<?php echo $BL['be_msg_close'] ?>"><img src="img/button/close_message.gif" alt="" width="14" height="14" border="0"></a><img src="img/leer.gif" alt="" width="12" height="1"><a href="cmsgo.php?do=messages&p=1" title="<?php echo $BL['be_msg_create'] ?>"><img src="img/button/new_message1.gif" alt="" width="68" height="14" border="0"></a><img src="img/leer.gif" alt="" width="4" height="1"><a href="cmsgo.php?do=messages&p=1&msg=<?php echo $msgdetail["msg_id"].":"; if(!$msgdetail["msg_read"]) echo "I"; ?>" title="<?php echo $BL['be_msg_reply'] ?>"><img src="img/button/reply_to_message1.gif" alt="" width="83" height="14" border="0"></a><img src="img/leer.gif" alt="" width="4" height="1"><?php if($msg_folder<>3) {?><a href="include/inc_act/act_message.php?do=<?php echo $do_move ?>.<?php echo $msgdetail["msg_id"] ?>.1" title="<?php echo $BL['be_msg_move'] ?>"><img src="img/button/message_to_trash.gif" alt="" width="71" height="14" border="0"></a><?php } // ?></td>
          <td width=4><img src="img/leer.gif" alt="" width="4" height="1"></td>
        </tr>
...
<?php
    ...
    $sql =  "SELECT msg_id, msg_pid, msg_uid, msg_subject, msg_from, msg_read, ".
            ...
            "FROM ".DB_PREPEND."cmsgo_message WHERE msg_uid=".$_SESSION["wcs_user_id"].
...
<?php
    ...
    $sql =  "SELECT msg_id, msg_pid, msg_uid, msg_subject, msg_from, msg_read, ".
            "DATE_FORMAT(msg_tstamp, '%m/%d/%y %H:%i') AS msg_date ".
            "FROM ".DB_PREPEND."cmsgo_message WHERE msg_from=".$_SESSION["wcs_user_id"].
...
<?php
    ...
    $sql =  "SELECT msg_id, msg_pid, msg_uid, msg_subject, msg_from, msg_read, ".
            ...
            "FROM ".DB_PREPEND."cmsgo_message WHERE (msg_uid=".$_SESSION["wcs_user_id"]." AND msg_deleted=1) OR ".
