 ...
 *
 * was formally used to edit frontend.css No use anymore because customer aren't using this
 *
 **/
...
$frontend_css = read_textfile(CMSGO_TEMPLATE."inc_css/frontend.css"); //reads the css template
