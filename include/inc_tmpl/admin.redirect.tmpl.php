...
<div class="row align-items-center">
  ...
  <div class="col-12 col-sm text-center text-sm-end mb-3">
      ...
      <a class="btn btn-sm btn-blue me-3" href="phpwcms.php?do=admin&amp;p=14&amp;rid=0" title="<?php echo $BL['be_new_linkredirect'] ?>"><i class="fa-solid fa-plus me-1"></i> <?php echo $BL['be_new_linkredirect'] ?></a>
    </div>
  </div>
</div>
        ...
        <div class="col-12 col-sm-auto">
          <div class="input-group input-group-sm">
              ...
              <?php if($_SESSION['redirect_detail_page'] > 1): ?>
                <a class="btn btn-blue" href="phpwcms.php?do=admin&amp;p=14&amp;page=<?php echo ($_SESSION['redirect_detail_page']-1) ?>"><i class="fa-solid fa-angle-left"></i></a>
              <?php else: ?>
            ...
            <input type="number" name="page" id="page" value="<?php echo $_SESSION['redirect_detail_page'] ?>" class="form-control text-center fw-bold" style="width: 60px;" />
              ...
              <?php if($_SESSION['redirect_detail_page'] < $_entry['pages_total']): ?>
                <a class="btn btn-blue" href="phpwcms.php?do=admin&amp;p=14&amp;page=<?php echo ($_SESSION['redirect_detail_page']+1) ?>"><i class="fa-solid fa-angle-right"></i></a>
              <?php else: ?>
...
<div class="card-header"><h2><?php echo ($data['rid'] ? $BL['be_cnt_guestbook_edit'] : $BL['be_article_cnt_button2']) . ': ' . $BL['be_link'] . ' &amp; ' . $BL['be_redirect'] ?></h2></div>
  ...
  <div class="form-group row g-2 align-items-center">
    ...
    <div class="form-group align-items-center mt-4 mb-0">
      ...
      <?php if($rid): ?><button type="submit" class="btn btn-sm btn-danger ms-1" name="delete_<?php echo md5((string) $rid) ?>" data-confirm-type="danger" data-confirm-action="<?php echo $BL['be_cnt_delete'] ?>" data-confirm="<?php echo $BL['be_delete_dataset'].' [ID:'.$rid.']' ?>"><i class="fa-regular fa-trash-alt me-1"></i> <?php echo $BL['be_cnt_delete'] ?></button><?php endif; ?>
    </div>
</form>
