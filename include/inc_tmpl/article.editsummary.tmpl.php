      ...
      <div class="form-group align-items-center form-row">
          ...
          <div class="col-sm-10">
                  ...
                  <div class="input-group-prepend lang-id-select-part<?php if ($article['article_lang'] === ''): ?> text-muted<?php endif; ?>">
                      ...
                      <div class="input-group-text">
                           ...
                           <label class="form-check-label text-nowrap mb-0" for="article_lang_type_article">
                             ...
                             <span class="flag-icon flag-icon-<?php echo $phpwcms['default_lang'] ?>" data-toggle="tooltip" title="<?php echo get_language_name($phpwcms['default_lang']) . ' ('.$BL['be_admin_tmpl_default'].')' ?>"></span>
                           </label>
                      </div>
                  </div>
              ...
              if ((int)$article['article_lang_id'] > 0 && $article['article_lang_type'] === 'article') {
                  ...
                  if (is_array($adata)) {
                      $article_lang_item .= '<a href="phpwcms.php?&do=articles&p=2&s=1&id=' . $adata[0]['article_id'] . '" target="_blank" data-toggle="tooltip" title="' . $adata[0]['article_title'] . '">' . $adata[0]['article_alias'] . $phpwcms['rewrite_ext'] .'</a>';
                  } else {
                  ...
                  foreach ($phpwcms['allowed_lang'] as $key => $lang) {
                      ...
                      if (isset($adata[0]['article_id'])) {
                          $article_lang_data[] = '<span class="flag-icon flag-icon-'.$lang.' mt-1" data-toggle="tooltip" title="'. get_language_name($lang).'"></span> <a href="phpwcms.php?&do=articles&p=2&s=1&aktion=1&id=' . $adata[0]['article_id'] . '" target="_blank" data-toggle="tooltip" title="' . $adata[0]['article_title'] . '">' . $adata[0]['article_alias'] . $phpwcms['rewrite_ext'] .'</a>';
                          unset($adata);
                      }
                  }
              } else {
                  foreach ($phpwcms['allowed_lang'] as $key => $lang) {
                      ...
                      $adata = _dbGet('phpwcms_article', 'article_id, article_alias, article_title', $where, '', '', 1);
                      if (isset($adata[0]['article_id'])) {
                          $article_lang_data[] = '<span class="flag-icon flag-icon-'.$lang.'" data-toggle="tooltip" title="'. get_language_name($lang).'"></span> <a href="phpwcms.php?&do=articles&p=2&s=1&aktion=1&id=' . $adata[0]['article_id'] . '" target="_blank" data-toggle="tooltip" title="' . $adata[0]['article_title'] . '">' . $adata[0]['article_alias'] . $phpwcms['rewrite_ext'] .'</a>';
                          unset($adata);
                      }
                  }
              }
