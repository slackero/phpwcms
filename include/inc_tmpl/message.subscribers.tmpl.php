...
<div class="card">
    ...
    <div class="mb-3 text-center text-sm-left">
        ...
        <a class="btn btn-sm btn-blue my-1 my-md-0" role="button" aria-disabled="true" href="cmsgo.php?do=messages&amp;p=4&amp;duplicate=remove" onclick="return confirm('<?php echo $BL['be_cnt_delete_duplicates'] ?>?');"><i class="fa fa-trash"></i> <?php echo $BL['be_cnt_delete_duplicates'] ?></a>
...
<div class="table-responsive">
	...
	foreach($data as $row) {
		...
		echo '<a class="btn btn-sm btn-blue mr-1" role="button" aria-disabled="true" title="'.$BL['be_tt_edit'].'" data-toggle="tooltip" href="cmsgo.php?do=messages&amp;p=4&amp;s='.$row["address_id"].'&amp;edit=1"><i class="fa fa-pencil"></i></a>';
