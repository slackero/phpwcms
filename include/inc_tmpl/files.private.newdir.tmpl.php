...
?><form action="phpwcms.php?do=files&f=0" method="post" name="createnewdir"><table width="538" border="0" cellpadding="0" cellspacing="0" bgcolor='#EBF2F4' summary="">
	<tr>
	...
	<tr>
		<td width="67" valign="top"><input name="dir_pid" type="hidden" id="dir_pid" value="<?php echo $dir_pid ?>"><input name="dir_aktion" type="hidden" id="dir_aktion" value="1"></td>
