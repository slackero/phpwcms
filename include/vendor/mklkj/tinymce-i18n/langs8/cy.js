tinymce.addI18n("cy", {
    ...
    "Alternative source URL": "URL y ffynhonnell arall",
    "Anchor": "Angor",
    "Anchor...": "Angor...",
    "Anchors": "Angorau",
    ...
    "Background color menu": "Dewislen lliw cefndir",
    ...
    "Constrain proportions": "Cyfyngu cyfraneddau",
    "Copy": "Cop\xefo",
    "Copy column": "Cop\xefo colofn",
    "Copy row": "Cop\xefo rhes",
    "Could not find the specified string.": "Methu dod o hyd i'r llinyn dan sylw.",
    "Could not load emojis": "Ddim yn gallu llwytho emojiau",
    "Count": "Cyfrif",
    ...
    "Edit": "Golygu",
    "Editor's height: {0} pixels": "Uchder y golygydd: {0} picsel",
    "Editor's height: {0} pixels, Editor's width: {1} pixels": "Uchder y golygydd: {0} picsel, Lled y golygydd: {1} picsel",
    "Embed": "Mewnblannu",
    "Emojis": "Emojiau",
    "Emojis...": "Emojiau...",
    "Error": "Gwall",
    "Error: Form submit field collision.": "Gwall: Gwrthdrawiad maes wrth gyflwyno ffurflen.",
    ...
    "Find whole words only": "Canfod geiriau cyfan yn unig",
    "Flags": "Baneri",
    ...
    "Focus to notification": "Ffocws i hysbysiad",
    ...
    "Hexadecimal only, 000000 to FFFFFF": "Hecsadegol yn unig, 000000 i FFFFFF",
    "Hidden": "Cudd",
    "Horizontal align": "Alinio llorweddol",
    "Horizontal line": "Llinell lorweddol",
    "Horizontal space": "Gofod llorweddol",
    "ID": "ID",
    "ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.": "Dylai\u2019r ID gychwyn gyda llythyren, yn cael ei ddilyn gan ddim ond lythrennau, rhifau, llinellau toriad, dotiau, colonau neu thanlinellau.",
    ...
    "Insert date/time menu": "Dewislen mewnosod dyddiad/amser",
    ...
    "List properties...": "Rhestru priodweddau...",
    "Loading emojis...": "Llwytho emojiau...",
    "Loading...": "Llwytho...",
    ...
    "Numbers only, 0 to 255": "Rhifau yn unig, 0 i 255",
    "OR": "NEU",
    "Objects": "Gwrthrychau",
    "Ok": "Iawn",
    ...
    "People": "Pobl",
    "Plugins": "Ategion",
    "Plugins installed ({0}):": "Ategion wedi eu gosod ({0}):",
    ...
    "Red": "Coch",
    "Red channel": "Sianel Goch",
    "Redo": "Ailwneud",
    "Remove": "Gwaredu",
    "Remove color": "Tynnu lliw",
    "Remove link": "Tynnu dolen",
    "Replace": "Newid",
    "Replace all": "Newid popeth",
    "Replace with": "Newid gyda",
    "Resize": "Ailfeintio",
    ...
    "Scope": "Cwmpas",
    "Search": "Chwilio",
    "Select all": "Dewis y cwbl",
    "Select the {0} element": "Dewis yr elfen {0}",
    "Select...": "Dewis...",
    "Selection": "Dewis",
    "Shortcut": "Llwybr Byr",
    ...
    "Solid": "Solid",
    "Source": "Ffynhonnell",
    "Source code": "Cod ffynhonell",
    "Special Character": "Nod arbennig",
    "Special character...": "Nod arbennig...",
    "Split cell": "Hollti cell",
    "Square": "Sgw\xe2r",
    "Start list at number": "Dechrau rhestr efo'r rhif",
    ...
    "Text color menu": "Dewislen lliw testun",
    ...
    "Url": "Url",
    "Use arrow keys to navigate.": "Defnyddiwch y bysellau saeth i lywio.",
    ...
    "livre tournois sign": "arwydd livre tournois",
    "manat sign": "arwydd manat",
    "mill sign": "arwydd milfed",
