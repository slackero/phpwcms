tinymce.addI18n("eu", {
    ...
    "Background color menu": "Atzeko planoaren kolorearen menua",
    ...
    "Edit": "Editatu",
    "Editor's height: {0} pixels": "Editorearen altuera: {0} pixel",
    "Editor's height: {0} pixels, Editor's width: {1} pixels": "Editorearen altuera: {0} pixel. Editorearen zabalera: {1} pixel",
    "Embed": "Enbotatzea",
    "Emojis": "Emojiak",
    "Emojis...": "Emojiak...",
    "Error": "Errorea",
    ...
    "Focus to notification": "Fokoa jakinarazpenera eraman",
    ...
    "Hexadecimal only, 000000 to FFFFFF": "Hamaseitarrak soilik, 000000tik FFFFFFra",
    "Hidden": "Ezkutua",
    ...
    "Insert date/time menu": "Data/ordua txertatzeko menua",
    ...
    "Numbers only, 0 to 255": "Zenbakiak soilik, 0tik 255era",
    "OR": "EDO",
    "Objects": "Objektuak",
    "Ok": "Ados",
    ...
    "Select the {0} element": "Aukeratu {0} elementua",
    "Select...": "Aukeratu...",
    ...
    "Text color menu": "Testuaren kolorearen menua",
    ...
    "Url": "URLa",
    "Use arrow keys to navigate.": "Erabili gezi-teklak nabigatzeko.",
