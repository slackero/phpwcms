tinymce.addI18n("pt-BR", {
    ...
    "Edit": "Editar",
    "Editor's height: {0} pixels": "Altura do editor: {0} pixels",
    "Editor's height: {0} pixels, Editor's width: {1} pixels": "Altura do editor: {0} pixels, Largura do editor: {1} pixels",
    "Embed": "Incorporar",
    "Emojis": "Emojis",
    "Emojis...": "Emojis...",
    "Error": "Erro",
