...
if($action == 'edit') {
    ...
    if(isset($_POST['shopprod_id'])) {
        ...
        if(!$plugin['data']['shopprod_ordernumber']) {
            ...
            $sql  = 'SELECT COUNT(shopprod_id) FROM '.DB_PREPEND.'cmsgo_shop_products WHERE ';
        ...
        if(is_array($plugin['data']['shopprod_images']) && count($plugin['data']['shopprod_images'])) {
            ...
            if(count($plugin['data']['shopprod_images'])) {
                ...
                $img_all = _dbQuery('SELECT * FROM '.DB_PREPEND.'cmsgo_file WHERE f_id IN ('.implode(',', $plugin['data']['shopprod_images']).')');
        ...
        if(is_array($plugin['data']['shopprod_files']) && count($plugin['data']['shopprod_files'])) {
            ...
            if(count($plugin['data']['shopprod_files'])) {
                ...
                $img_all = _dbQuery('SELECT * FROM '.DB_PREPEND.'cmsgo_file WHERE f_id IN ('.implode(',', $plugin['data']['shopprod_files']).')');
        ...
        if(empty($plugin['error'] )) {
            ...
            if( $plugin['data']['shopprod_id'] && $plugin['data']['shopprod_duplicate'] == 0 ) {
                ...
                $sql  = 'UPDATE '.DB_PREPEND.'cmsgo_shop_products SET ';
            ...
            // INSERT
                ...
                $sql  = 'INSERT INTO '.DB_PREPEND.'cmsgo_shop_products (';
    ...
    $sql .= 'FROM '.DB_PREPEND.'cmsgo_categories C1 ';
