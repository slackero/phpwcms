...
?>" method="post" onsubmit="selectAllOptions(this.shopprod_images);selectAllOptions(this.shopprod_files);">
  ...
  <div class="row align-items-center">
    <div class="col-sm">
      <h1 class="mb-2 mb-sm-0 text-center text-sm-start"><?php echo $BLM['prod_edit'] ?></h1>
    </div>
    <div class="col-sm">
...
<hr />
  ...
  <div class="form-group row g-2 align-items-center">
    <label for="shopprod_ordernumber" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_ordernumber'] ?></label>
    <div class="col-sm-4">
    ...
    <div class="col-sm-6">
      <div class="row align-items-center">
        <label for="shopprod_model" class="col-sm-auto col-form-label text-end ms-sm-5"><?php echo $BLM['shopprod_model'] ?></label>
          <div class="col">
  ...
  <div class="form-group row g-2 align-items-center">
    ...
    ?><div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="shopprod_lang_<?php echo $lang ?>"><span class="flag-icon flag-icon-<?php echo $lang; $lang = strtoupper($lang); ?> mt-1" data-bs-toggle="tooltip" title="<?php echo $lang ?>"></span></label>
      </div>
  <?php endforeach; ?>
    </div>
  </div>
  ...
  <div class="form-group row g-2 align-items-center">
    <label for="shopprod_name1" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_name1'] ?></label>
    <div class="col">
  ...
  <div class="form-group row g-2 align-items-center">
    <label for="shopprod_name2" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_name2'] ?></label>
    <div class="col">
  ...
  <div class="form-group row g-2 align-items-center">
    <label for="shopprod_weight" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_weight'] ?></label>
    <div class="col-sm-4">
    ...
    <div class="form-group row g-2 align-items-center">
        <label class="col-sm-2 col-form-label text-end" for="shopprod_inventory"><?php echo $BLM['shopprod_inventory'] ?></label>
        <div class="col-sm-4">
  ...
  <div class="form-group row g-2 align-items-center">
    <label for="shopprod_unit" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_unit'] ?></label>
    <div class="col-sm-4">
  ...
  <div class="form-group row g-2 align-items-center">
    <label for="shopprod_price" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_price'] ?></label>
    <div class="col-sm-4">
        <div class="input-group input-group-sm">
    ...
    <div class="col-sm-auto px-3 py-3 py-sm-0">
        <div class="input-group input-group-sm align-items-center">
                <label for="shopprod_vat" class="col-form-label me-2"><?php echo $BLM['shopprod_vat'] ?></label>
                    <select name="shopprod_vat" id="shopprod_vat" class="form-select form-select-sm">
                        <?php
  ...
  <div class="form-group row g-2">
    <label for="shopprod_size" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_size'] ?></label>
    <div class="col-sm-4">
    ...
    <div class="col-sm-6">
    <div class="row g-2">
    <label for="shopprod_color" class="col-sm-3 col-form-label text-end"><?php echo $BLM['shopprod_color'] ?></label>
            <div class="col">
  ...
  <div class="form-group row g-2">
    <label for="shopprod_description0" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_description0'] ?></label>
    <div class="col">
      <?php
  ...
  <div class="form-group row g-2">
    <label for="shopprod_description1" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_description'] ?></label>
    <div class="col">
      <?php
  ...
  <div class="form-group row g-2">
    <label for="shopprod_description2" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_description1'] ?></label>
    <div class="col">
  ...
  <div class="form-group row g-2">
    <label for="shopprod_description3" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_description2'] ?></label>
    <div class="col">
...
<hr />
  ...
  <div class="form-group row g-2">
    ...
    echo $img_count+5
        ...
        ?>" multiple="multiple" class="form-select form-control form-control-sm h-100" id="shopprod_images">
<?php
...
if ($img_count) {
    ...
    foreach ($plugin['data']['shopprod_images'] as $key => $value) {
        ...
        if ($thumb_image != false) {
            ...
            $img_thumbs .= '<img class="my-1 me-1" src="' . $thumb_image['src'] .'" '.$thumb_image[3].' alt="'.$img_name.'" title="'.$img_name.'" />';
...
?>
        ...
        <div class="col-sm-auto ps-0">
          ...
          <button type="button" class="btn btn-sm btn-danger mb-1" onclick="removeSelectedOptions(img_field);return false;" data-bs-toggle="tooltip" title="<?php echo $BL['be_cnt_delimage'] ?>"><i class="fa-regular fa-trash-alt fa-fw" aria-hidden="true"></i></button>
        </div>
      </div>
      <div class="row">
        <div class="col mt-1">
  ...
  <div class="form-group row g-2">
    <label for="shopprod_caption" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_caption'] ?></label>
    <div class="col">
...
<hr />
  ...
  <!-- Attachments -->
  <div class="form-group row g-2">
    <label for="shopprod_files" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_files'] ?></label>
    <div class="col">
      <div class="row">
    ...
    echo $files_count+5
        ?>" multiple="multiple" class="form-select form-control form-control-sm h-100" id="shopprod_files">
<?php
...
?>
        ...
        <div class="col-sm-auto ps-0">
            ...
            <button type="button" class="btn btn-sm btn-danger mb-1" onclick="removeSelectedOptions(files_field);return false;" data-bs-toggle="tooltip" title="<?php echo $BL['be_cnt_delfile'] ?>"><i class="fa-regular fa-trash-alt fa-fw" aria-hidden="true"></i></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="form-group row g-2">
    <label for="shopprod_filecaption" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_description'] ?></label>
    <div class="col">
...
<!-- End Attachments -->
  ...
  <div class="form-group row g-2">
    <label for="shopprod_url" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_url'] ?></label>
    <div class="col">
  ...
  <div class="form-group row g-2">
    <label for="shopprod_category" class="col-sm-2 col-form-label text-end"><?php echo $BLM['prod_cat'] ?></label>
    <div class="col-sm-4">
        <select name="shopprod_category[]" size="7" multiple="multiple" class="form-select form-select-sm" id="shopprod_category">
        <?php
        $t = array();
  ...
  <div class="form-group row g-2">
    <label for="shopprod_tag" class="col-sm-2 col-form-label text-end"><?php echo $BLM['shopprod_tag'] ?></label>
    <div class="col">
