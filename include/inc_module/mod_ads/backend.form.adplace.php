...
?>
	...
	<tr> 
		...
		<td colspan="2"><textarea name="adplace_prefix" id="adplace_prefix" rows="3" class="code width400"><?php echo html_specialchars($plugin['data']['adplace_prefix']) ?></textarea></td>
	</tr>
	...
	<tr> 
		...
		<td colspan="2"><textarea name="adplace_suffix" id="adplace_suffix" rows="3" class="code width400"><?php echo html_specialchars($plugin['data']['adplace_suffix']) ?></textarea></td>
	</tr>
