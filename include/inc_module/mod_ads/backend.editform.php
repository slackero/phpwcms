...
<table border="0" cellpadding="0" cellspacing="0" width="100%" summary="">
	...
	<tr>
		...
		<td class="v10"><?php echo html(cmsgo_strtotime($plugin['data']['adcampaign_changed'], $BL['be_fprivedit_dateformat'], '')) ?></td>
	</tr>
	...
	<tr>
		...
		<td class="v10"><?php echo html(cmsgo_strtotime($plugin['data']['adcampaign_created'], $BL['be_fprivedit_dateformat'], '')) ?></td>
	</tr>
