    ...
    if(isset($_GET['cid'])) {
      ...
      if(isset($result[0]['article_id'])) {
        ...
        foreach($result as $crow) {
          echo "<a class=\"list-group-item list-group-item-action py-1 px-0 text-primary\" href=\"cmsgo.php?do=articles&amp;p=2&amp;s=1&amp;id=".$crow['article_id']."\" target=\"_blank\">".html_specialchars($crow['article_title'])."</a>";
        }
        echo '</div>';
      }
    }
