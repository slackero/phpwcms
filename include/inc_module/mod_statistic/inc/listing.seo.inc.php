...
<form action="<?php echo $_controller_link ?>" method="post" name="paginate" id="paginate">
	...
	<div class="row g-2 align-items-center mb-3">
		...
		<div class="col text-end">
			<select class="form-select form-select-sm" style="width: auto; display: inline-block;" onchange="location.href='<?php echo statistic_url('controller=seo') ?>&amp;c=' + this.value;">
