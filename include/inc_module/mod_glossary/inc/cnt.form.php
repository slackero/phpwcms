...
// current module vars are stored in $cmsgo['modules'][$content["module"]]
// var to modules path: $cmsgo['modules'][$content["module"]]['path']
...
// templates for forum
$tmpllist = get_tmpl_files($cmsgo['modules'][$content["module"]]['path'].'template');
