...
// $cmsgo['modules'][$crow["acontent_module"]]
...
if(empty($content['glossary']['glossary_template'])) {
    ...
    $content['glossary']['glossary_template'] = file_get_contents($cmsgo['modules'][$crow["acontent_module"]]['path'].'template/default/default.tmpl');

} elseif(file_exists($cmsgo['modules'][$crow["acontent_module"]]['path'].'template/'.$content['glossary']['glossary_template'])) {

    // load custom template
    $content['glossary']['glossary_template'] = file_get_contents($cmsgo['modules'][$crow["acontent_module"]]['path'].'template/'.$content['glossary']['glossary_template']);
...
if(!empty($GLOBALS['_getVar']['glossaryid'])) {
    ...
    $sql  = 'SELECT * FROM '.DB_PREPEND.'cmsgo_glossary WHERE glossary_status=1 ';
    ...
    $sql  = 'SELECT * FROM '.DB_PREPEND.'cmsgo_glossary WHERE glossary_status=1'.$content['glossary']['where'].' ORDER BY glossary_title';
