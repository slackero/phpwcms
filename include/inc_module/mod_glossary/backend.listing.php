...
// paginating values
$_entry['count_total'] = _dbQuery('SELECT * FROM '.DB_PREPEND.'cmsgo_glossary WHERE '.$_entry['query'], 'COUNT');
	...
	<div class="card-body">
				...
				<?php if($_entry['pages_total'] > 1): ?>
					<div class="col-auto">
						<div class="input-group input-group-sm">
							...
							<input type="text" name="page" id="page" value="<?php echo $_SESSION['glossary_page'] ?>" class="form-control form-control-sm text-center" style="width: 50px;" />
		...
		<div class="table-responsive">
			<table class="table table-sm table-striped table-hover mb-0">
				...
				$sql  = 'SELECT * FROM '.DB_PREPEND.'cmsgo_glossary WHERE '.$_entry['query'].' ';
