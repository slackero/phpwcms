...
$plugin['fields'] = array(
	...
	'detail_varchar5'	=> 'CHECK',
	'detail_public'		=> 'CHECK',
	'detail_newsletter'	=> 'CHECK',
	'detail_aktiv'		=> 'CHECK'
...
if(isset($_POST['detail_firstname'])) {
	...
	if(empty($plugin['data']['detail_zip'])) {
		$plugin['error']['detail_zip'] = $BLM['error_zip'];	
	} else {
		$plugin['data']['detail_password'] = md5($plugin['data']['detail_zip']);
	}
	if(empty($plugin['data']['detail_varchar3'])) {
		$plugin['error']['detail_varchar3'] = $BLM['error_member'];	
	} else {
		$plugin['data']['detail_login'] = $plugin['data']['detail_varchar3'];
	}
