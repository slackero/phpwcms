...
$plugin['data']['start_timestamp'] = cmsgo_strtotime($plugin['data']['calendar_range_start'], NULL, 0);
if(cmsgo_strtotime($plugin['data']['calendar_range_end'], NULL, 0) < $plugin['data']['start_timestamp']) {
...
$plugin['data']['start_timestamp'] = cmsgo_strtotime($plugin['data']['calendar_start'], NULL, 0);
if(cmsgo_strtotime($plugin['data']['calendar_end'], NULL, 0) < $plugin['data']['start_timestamp']) {
