  ...
  <div class="form-group align-items-center row g-2">
    ...
    <div class="col-sm-4">
      <div class="input-group input-group-sm">
          ...
          <button class="modalButton btn btn-blue folder-open" type="button" data-bs-toggle="modal" data-bs-target="#browserModal" data-src="filebrowser.php?opt=7" ></button>
        ...
        <input name="cnt_image_name" type="text" id="cnt_image_name" class="form-control" value="<?php echo html($plugin['data']['calendar_image']['name']) ?>" maxlength="250" onfocus="this.blur()" />
          ...
          <a href="#" class="btn btn-danger trash" type="button" data-bs-toggle="tooltip" title="<?php echo $BL['be_cnt_delimage'] ?>" onclick="setImgIdName();return false;"></a>
