...
<div class="card-body">
	...
	<div class="form-group row g-2 align-items-center">
  		<div class="col-sm-2 text-end"><?php echo $BL['be_cnt_last_edited']  ?>:</div>
	...
	<div class="form-group row g-2 align-items-center">
  		<div class="col-sm-2 text-end"><?php echo $BL['be_fprivedit_created']  ?>:</div>
	...
	<div class="form-group row g-2 align-items-center">
    	<label for="be_admin_tmpl_js" class="col-sm-2 col-form-label text-end"><?php echo $BLM['calendar_title'] ?></label>
    	<div class="col">
...
<hr />
    ...
    <div class="form-group row g-2 align-items-center">
    	<label class="col-sm-2 col-form-label text-end"><?php echo $BLM['calendar_start'] ?></label>
        <div class="col-sm-10">
          <div class="d-flex flex-wrap flex-lg-nowrap align-items-center gap-2">
            <div class="input-group input-group-sm datetime-picker-group">
              ...
              <span class="input-group-text btn-blue" style="cursor:pointer;" onclick="document.getElementById('calendar_start_date')._flatpickr&&document.getElementById('calendar_start_date')._flatpickr.open();"><i class="fa-regular fa-calendar-alt fa-fw"></i></span>
              ...
              <span class="input-group-text btn-blue" style="cursor:pointer;" onclick="document.getElementById('calendar_start_time')._flatpickr&&document.getElementById('calendar_start_time')._flatpickr.open();"><i class="fa-regular fa-clock fa-fw"></i></span>
            </div>
            <div class="input-group input-group-sm datetime-picker-group">
              ...
              <span class="input-group-text btn-blue" style="cursor:pointer;" onclick="document.getElementById('calendar_end_date')._flatpickr&&document.getElementById('calendar_end_date')._flatpickr.open();"><i class="fa-regular fa-calendar-alt fa-fw"></i></span>
  ...
  <div class="form-group row g-2 align-items-center">
    <label for="be_admin_tmpl_js" class="col-sm-2 col-form-label text-end"><?php echo $BLM['repeat'] ?></label>
    <div class="col-sm-4">
      <select name="calendar_range" id="calendar_range" class="form-select form-select-sm" onchange="setRangeDates(this.options[this.selectedIndex].value)">
    ...
    <div id="rDate0" class="form-group row g-2 align-items-center">
      <label for="calendar_end_date" class="col-sm-2 col-form-label text-end"><?php echo $BLM['repeat_till'] ?></label>
      <div class="col-sm-auto">
        <div class="input-group input-group-sm">
          <input type="text" class="form-control datetimepicker-input" name="calendar_range_start" id="calendar_range_start" value="<?php echo html($plugin['data']['calendar_rangestart']) ?>" maxlength="10" placeholder="<?php echo $BL['default_date_format'] ?>" autocomplete="off" />
            ...
            <span class="input-group-text btn-blue" style="cursor:pointer;" onclick="document.getElementById('calendar_range_start')._flatpickr&&document.getElementById('calendar_range_start')._flatpickr.open();"><i class="fa-regular fa-calendar-alt fa-fw"></i></span>
      ...
      <div class="col-sm-auto mt-3 mt-sm-0">
        <div class="input-group input-group-sm">
          <input type="text" class="form-control datetimepicker-input" name="calendar_range_end" id="calendar_range_end" value="<?php echo html($plugin['data']['calendar_rangeend']) ?>" maxlength="10" placeholder="<?php echo $BL['default_date_format'] ?>" autocomplete="off" />
            ...
            <span class="input-group-text btn-blue" style="cursor:pointer;" onclick="document.getElementById('calendar_range_end')._flatpickr&&document.getElementById('calendar_range_end')._flatpickr.open();"><i class="fa-regular fa-calendar-alt fa-fw"></i></span>
	...
	<div class="form-group row g-2 align-items-center">
    	<label for="where" class="col-sm-2 col-form-label text-end"><?php echo $BLM['where'] ?></label>
    	<div class="col">
	...
	<div class="form-group row g-2 align-items-center">
    	<span class="col-sm-2 col-form-label text-end"><?php echo $BLM['calendar_token'] ?></span>
    	<div class="col">
	...
	<div class="form-group row g-2 align-items-center">
    	<label class="col-sm-2 col-form-label text-end"><?php echo $BLM['article_link'] ?></label>
    	<div class="col-sm-4">
...
<hr />
	...
	<div class="form-group row g-2">
    	<label for="where" class="col-sm-2 col-form-label text-end"><?php echo $BLM['calendar_teasertext'] ?></label>
    	<div class="col">
	...
	<div class="form-group row g-2">
    	<label for="where" class="col-sm-2 col-form-label text-end"><?php echo $BLM['calendar_text'] ?></label>
    	<div class="col">
    		<?php
...
<hr />
  ...
  <div class="form-group align-items-center row g-2">
	...
	<div class="form-group row g-2">
    	<label for="where" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_cnt_caption'] ?></label>
    	<div class="col-sm-4">
    ...
    <div class="form-group row g-2">
    	<label for="where" class="col-sm-2 col-form-label text-end"><?php echo $BL['be_profile_label_website'] ?></label>
    	<div class="col-sm-4">
...
function showImage() {
  ...
  if(id > 0) {
		$('#cnt_image').html('<img src="<?php echo PHPWCMS_URL.PHPWCMS_RESIZE_IMAGE.'/'.$phpwcms['img_list_width'].'x'.$phpwcms['img_list_height'] ?>/'+id+'" alt="" border="0" />').show();
  } else {
    $('#cnt_image').hide();
  }
}
