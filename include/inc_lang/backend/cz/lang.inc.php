...
$BL['usr_online']                       = 'Pøihlášení uivatelé';

// Login Page
$BL["login_text"]                       = 'Vlote Vaše pøihlašovací údaje';
$BL['login_error']                      = 'Po dobu pøihlašování nastala chyba!';
...
$BL['be_subnav_article_new']            = 'novı èlánek';
...
$BL['be_func_struct_nocut']             = 'zrušit vyjmutí èlánku';
$BL['be_func_struct_svisible']          = 'pøepnout viditelnı/neviditelnı';
$BL['be_func_struct_spublic']           = 'pøepnout veøejnı/neveøejnı';
...
$BL['be_func_struct_new_article']       = 'vytvoøit novı èlánek v úrovni struktury';
...
$BL['be_func_struct_paste_cancel']      = 'zrušit zmìnu úrovnì struktury';
...
$BL['be_ctype_plaintext']               = 'obyèejnı text';
...
$BL['be_profile_create_success']        = 'Profil úspìšnì vytvoøen.';
$BL['be_profile_create_error']          = 'Pøi vytváøení nastala chyba.';

// profile.update.inc.php
$BL['be_profile_update_success']        = 'Údaje profilu byli úspìšnì aktualizovány.';
...
$BL['be_profile_account_err3']          = 'heslo musí bıt identické, zopakujte';
$BL['be_profile_account_err4']          = 'email {VAL} je chybnı';

// profile.data.tmpl.php
$BL['be_profile_data_title']            = 'vaše osobní údaje';
$BL['be_profile_data_text']             = 'Osobní údaje jsou volitelné.<br />To pomùe jinım uivatelùm získat o vás více informací.<br />Pokud zvolíte správnı checkbox uivatelé budou moci vidìt Váš profil ve veøejné èásti, nebo na stránkách èlánkù.';
...
$BL['be_profile_text_newsletter']       = 'Chci dostávat všeobecnı newsletter.';
$BL['be_profile_label_public']          = 'veøejné';
$BL['be_profile_text_public']           = 'Kadı mùe vidìt mùj profil.';
$BL['be_profile_label_button']          = 'aktualizace osobních údajù';

// profile.account.tmpl.php
$BL['be_profile_account_title']         = 'vaše pøihlašovací informace';
$BL['be_profile_account_text']          = 'Normálnì není nutné si mìnit pøihlašovací jméno.<br />Èas od èasu by jste si mìli zmìnit heslo pro zvıšení bezpeènosti.';
...
$BL['be_ftab_createnew']                = 'vytvoøit novı adresáø v root adresáøi';
...
$BL['be_ftab_trash']                    = 'odpadkovı&nbsp;koš';
$BL['be_ftab_open']                     = 'otevøít všechny adresáøe';
$BL['be_ftab_close']                    = 'zavøíet všechny otevøené adresáøe';
...
$BL['be_fprivup_err1']                  = 'Zvolte soubor, kterı chcete nahrát';
$BL['be_fprivup_err2']                  = 'Velikost pøenášeného souboru je vìtší ne';
...
$BL['be_fprivup_err6']                  = 'Prosím, nezkoušejte znovu - toto je chyba na stranì serveru! Kontaktujte vašeho <a href="mailto:{VAL}">webmastera</a> co najdøíve!';
...
$BL['be_fprivfunc_makenew']             = 'vytvoøit novı adresáø uvnitø';
...
$BL['be_fprivfunc_notempty']            = 'adresáø {VAL} není prázdnı!';
...
$BL['be_fprivfunc_movetrash']           = 'vyhodit do koše';
$BL['be_fprivfunc_jsmovetrash1']        = 'Chcete opravdu vyhodit';
$BL['be_fprivfunc_jsmovetrash2']        = 'do koše?';
...
$BL['be_ftrash_nofiles']                = 'koš je prázdnı';
...
$BL['be_ftrash_undo']                   = 'obnovit (vybrat z koše)';
$BL['be_ftrash_delfinal']               = 'finálnì vymazat';

// files.search.tmpl.php
$BL['be_fsearch_err1']                  = 'Hledanı vıraz je prázdnı.';
$BL['be_fsearch_title']                 = 'hledat soubory';
$BL['be_fsearch_infotext']              = 'Toto je základní vyhledávání souborù podle informací.<br />Vyhledávají se zhody v klíèovıch slovech, jménech souborù a souborovıch informací.<br />Wildcards znaky (*,?,...) nejsou podporovány.<br />Oddìlte vícenásobné vyhledávaní slov mezerou.<br />Zvolte AND/OR a hledané soubory: osobní/veøejné.';
$BL['be_fsearch_nonfound']              = 'Nebyli nalezeny ádné odpovídající soubory!';
$BL['be_fsearch_fillin']                = 'prosím vyplòte hledanı vıraz do vrchního políèka.';
$BL['be_fsearch_searchlabel']           = 'hledat';
$BL['be_fsearch_startsearch']           = 'zaèít hledat';
$BL['be_fsearch_and']                   = 'AND';
$BL['be_fsearch_or']                    = 'OR';
$BL['be_fsearch_all']                   = 'všechny soubory';
...
$BL['be_chat_info']                     = 'Zde mùete chatovat s ostatními uivateli o èem chcete. Toto médium je pro online rozhovor, ale mùete zde zanechat zprávu, kterou bude vidìt kadı. Poku si chcete vymìòovat nápady s jinımi uivateli, pouijte diskusi.';
$BL['be_chat_start']                    = 'pro spuštìní chatu kliknìte sem';
$BL['be_chat_lines']                    = 'poèet zobrazenıch vstupù';
...
$BL['be_msg_move']                      = 'pøesunout zprávu do koše';
...
$BL['be_msg_marked']                    = 'zprávy oznaèené pro smazání (koš)';
...
$BL['be_msg_err2']                      = 'vyplòte políèko pøedmìt (pøíjemce mùe jednodušeji pracovat se zprávou)';
...
$BL['be_msg_available']                 = 'seznam dostupnıch uivatelù';
$BL['be_msg_all']                       = 'zaslat zprávu všem oznaèenım pøíjemcùm';
...
$BL['be_newsletter_button_cancel']      = 'zrušit';
...
$BL['be_admin_usr_etitle']              = 'editovat uivatelskı úèet';
$BL['be_admin_usr_emailsubject']        = 'phpwcms - informace úètu byli zmìnìné';
$BL['be_admin_usr_emailbody']           = "PHPWCMS INFORMACE UIVATELSKÉHO ÚÈTU SE ZMÌNILI\n\n    uivatelské jméno: {LOGIN}\n    heslo: {PASSWORD}\n\n\nPøihlásit se mùete tu: {SITE}\n\nphpwcms administrátor\n ";
$BL['be_admin_usr_passnochange']        = '[BEZ ZMENY - POUIJTE PRO ZJIŠTÌNÍE HESLA]';
...
$BL['be_admin_usr_ldel']                = 'VİSTRAHA!&#13 Toto smae  uivetele';
...
$BL['be_admin_fcat_addkey']             = 'pøidat novı klíè';
...
$BL['be_admin_page_align_center']       = 'centrovat celı obsah stránky';
$BL['be_admin_page_align_right']        = 'celı obsah stránky zarovnat vpravo';
...
$BL['be_admin_page_height']             = 'vıška';
$BL['be_admin_page_width']              = 'šíøka';
...
$BL['be_admin_page_allblocks']          = 'všechny bloky';
...
$BL['be_admin_tmpl_title']              = 'frontend nastavení: šablony';
$BL['be_admin_tmpl_default']            = 'pøednastavené';
$BL['be_admin_tmpl_add']                = 'pøidat&nbsp;šablonu';
$BL['be_admin_tmpl_edit']               = 'editovat šablonu';
...
$BL['be_admin_tmpl_button']             = 'uloit šablonu';
...
$BL['be_article_err1']                  = 'název èlánku je prázdnı';
...
$BL['be_article_abutton']               = 'vytvoøit novı èlánek';

// article.editcontent.inc.php
$BL['be_article_err4']                  = 'zadané datum ukonèení bylo chybné - nastaveno na teï + 1 tıden';
...
$BL['be_article_cnt_lvisible']          = 'pøepnout viditelnı/neviditelnı';
...
// content forms
$BL['be_cnt_plaintext']                 = 'obyèejnı text';
...
$BL['be_cnt_maxw']                      = 'max.&nbsp;šíøka';
$BL['be_cnt_maxh']                      = 'max.&nbsp;vıška';
$BL['be_cnt_enlarge']                   = 'zvìtšit&nbsp;kliknutím';
...
$BL['be_cnt_sortup']                    = 'pøesunout vıše';
$BL['be_cnt_sortdown']                  = 'pøesunout níe';
$BL['be_cnt_delimage']                  = 'odstranit oznaèenı obrázek';
$BL['be_cnt_delfile']                   = 'odstranit oznaèenı soubor';
$BL['be_cnt_delmedia']                  = 'odstranit oznaèenı médiální soub.';
$BL['be_cnt_column']                    = 'sloupec';
$BL['be_cnt_imagespace']                = 'prostor&nbsp;obrázku';
$BL['be_cnt_directlink']                = 'pøímı odkaz';
...
$BL['be_cnt_movearticleto']             = 'pøesunout oznaèenı èlánek do seznamu odkazù èlánkù';
$BL['be_cnt_removearticleto']           = 'odstranit oznaèenı èlánek do seznamu odkazù èlánkù';
$BL['be_cnt_mediatype']                 = 'druh mediálního souboru';
$BL['be_cnt_control']                   = 'ovládání';
$BL['be_cnt_showcontrol']               = 'ukázat ovládací lištu';
$BL['be_cnt_autoplay']                  = 'auto. spuštìní';
...
$BL['be_cnt_set5']                      = 'vymazat vıšku a šíøku mediálního souboru';

// added: 28-12-2003
$BL['be_admin_page_add']                = 'vytvoøit novı layout stránky';
...
$BL['be_admin_page_custom']             = 'volitelnı';
$BL['be_admin_page_custominfo']         = 'ze šablony hlavního bloku';
$BL['be_admin_tmpl_layout']             = 'layout';
$BL['be_admin_tmpl_nolayout']           = 'ádny layout stránky není dostupnı!';

// added: 31-12-2003
$BL['be_ctype_search']                  = 'hledat';
$BL['be_cnt_results']                   = 'vısledky';
$BL['be_cnt_results_per_page']          = 'po&nbsp;stránce (jestli prázdné, zobrazit všechny)';
$BL['be_cnt_opennewwin']                = 'otevøít nové okno';
$BL['be_cnt_searchlabeltext']           = 'toto jsou pøeddefinované texty a hodnoty pro vyhledávací formuláø a stránku vısledkù hledaní a texty jsou zobrazené, kdy má bıt zobrazenı vìtší poèet vısledkù vyhledávání na stránku ne byl zadanı.';
$BL['be_cnt_input']                     = 'vstup';
$BL['be_cnt_style']                     = 'styl';
$BL['be_cnt_result']                    = 'vısledek';
$BL['be_cnt_next']                      = 'nasledující';
$BL['be_cnt_previous']                  = 'pøedchozí';
$BL['be_cnt_align']                     = 'zarovnání';
$BL['be_cnt_searchformtext']            = 'nasledující texty jsou uvedeny pøi otevøení vyhledávacího formuláøì nebo pokud vısledky pro dané vyhledávaní (ne) jsou dostupné.';
$BL['be_cnt_intro']                     = 'intro';
$BL['be_cnt_noresult']                  = 'bez vısledku';
...
$BL['be_admin_struct_regonly']          = 'viditelné pouze pro pøihlášené uivatele';
...
// added: 24-03-2004
$BL['be_subnav_admin_starttext']		    = 'backend pøedvolenı text';
$BL['be_ctype_ecard']					          = 'e-card';
$BL['be_ctype_blog']					          = 'blog';
$BL['be_cnt_ecardtext']                 = 'titulek/e-card';
$BL['be_cnt_ecardtmpl']                 = 'mailová šablona';
...
$BL['be_cnt_ecardform_selector']        = 'vıbìr';
...
$BL['be_newsletter_newnl']              = 'vytvoøit novı';
...
$BL['be_newsletter_allsubscriptions']   = 'všechny pøedplatné';
...
$BL['be_newsletter_attention']          = '<strong style="color:#CC3300;">Vıstraha!</strong> Odesílat newsletter více uivatelùm je nebezpeèné. Pøíjemci by mìli bıt ovìøení jinak pošlete potenciální spam. Myslete dvakrát ne odešlete newsletter. Provìøte si newsletter odesláním testem.';
...
$BL['be_newsletter_attention2']         = '<strong style="color:#CC3300;">Vıstraha!</strong> Prosím nezastavujte proces odesílání. Jinak je moné e zašlete newsletter víckrát ne jednou! Pokud odesílíní sele, všichni nedoruèení pøíjemcové jsou uloeni odešlete newsletter ještì jednou.';
...
$BL['be_cnt_reference_largetext']       = 'velkı referenèní obrázek';
$BL['be_cnt_reference_zoom']            = 'zvìtšení';
...
$BL['be_article_forfull']               = 'zobrazit celı èlánek';
...
$BL['be_cnt_error_text']				        = 'chybovı text';
...
$BL['be_func_content_paste_cancel']      = 'zrušit akci s touto èástí èlánku';
