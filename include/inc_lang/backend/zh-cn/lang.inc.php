...
$BL['be_ftptakeover_processing'] = '选定的文件将被接管！';
$BL['be_ftptakeover_dberror'] = '插入数据库时发生 MySQL 错误：';
$BL['be_ftptakeover_ok'] = '确定！';
$BL['be_ftptakeover_missing'] = '不存在';
$BL['be_ftptakeover_done'] = '每个选定的文件都已被接管！';
$BL['be_ftptakeover_error'] = '接管文件时出错！';
$BL['be_ftptakeover_return'] = '&laquo; 返回';
$BL['be_ftptakeover_autoredirect'] = '如果没有自动跳转';
