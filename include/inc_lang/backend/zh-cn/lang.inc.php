...
$BL['be_update_run']                = '备份 &amp; 立即更新';
$BL['be_update_confirm']            = '系统将创建数据库备份，然后替换自身文件。是否继续？';
$BL['be_update_success']            = '已成功更新到 %s。';
$BL['be_update_failed']             = '更新失败';
$BL['be_update_fetch_error']        = '无法从 GitHub 获取更新信息。最新版本可能没有 zip 文件，或 API 不可访问。';
$BL['be_update_uptodate']           = 'phpwcms 已是最新版本。';
$BL['be_update_history']            = '更新历史';
$BL['be_update_rollback']           = '恢复上一个版本';
$BL['be_update_rolled_back']        = '已恢复上一个版本。';
$BL['be_update_clear_maintenance']  = '清除维护模式';
...
$BL['be_admin_custom_cpt_err_reserved_field_key'] = '字段键名“%s”是保留的标准标签名称，无法使用。';
$BL['be_admin_custom_cpt_err_reserved_field_key_simple'] = '保留的标准标签名称（例如 TITLE、SUBTITLE、TEXT 等）。';
