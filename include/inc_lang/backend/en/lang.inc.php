...
$BL['be_update_current']            = 'Installed version';
$BL['be_update_available']          = 'Available version';
$BL['be_update_check']              = 'Check for update';
$BL['be_update_run']                = 'Backup &amp; update now';
...
$BL['be_update_rolled_back']        = 'Previous version restored.';
$BL['be_update_clear_maintenance']  = 'Clear maintenance mode';
...
$BL['be_update_version_unsupported'] = 'Automatic update is only supported for phpwcms version > 2.0.0.';
...
$BL['login_reset_email_greeting'] = 'Hello {NAME},';
$BL['login_reset_email_intro']    = 'A password reset request has been received for your backend user account ({LOGIN}) on {SITE}.';
$BL['login_reset_email_note']     = 'This link is valid for 1 hour. If you did not request this password reset, you can safely ignore this message.';
$BL['be_admin_usr_mailwelcome']   = 'Welcome to the phpwcms backend of {SITE}.';
$BL['be_admin_usr_maillogin']     = 'You can login here:';
$BL['be_admin_usr_mailchanged']   = 'Your phpwcms backend account data has been changed.';
$BL['email_regards']              = 'Regards,';
$BL['email_deactivated_subject']  = 'Your account on {SITE} was deactivated';
$BL['email_deactivated_greeting'] = 'Dear user,';
$BL['email_deactivated_body']     = 'Your account on {SITE} was deactivated.';
$BL['email_deactivated_contact']  = 'Contact the admin if you have any question.';
...
$BL['be_ftptakeover_processing']  = 'Selected files will be taken over!';
$BL['be_ftptakeover_dberror']     = 'MySQL error while inserting to DB: ';
$BL['be_ftptakeover_ok']          = 'OK!';
$BL['be_ftptakeover_missing']     = 'Does not exist';
$BL['be_ftptakeover_done']        = 'Every selected file was taken over!';
$BL['be_ftptakeover_error']       = 'Error while file take over!';
$BL['be_ftptakeover_return']      = '&Laquo; Return';
$BL['be_ftptakeover_autoredirect']= 'If no automatic redirect';
...
$BL['be_admin_group_err']         = 'Group name is empty!';
$BL['be_admin_group_added']       = 'Group added successfully';
...
$BL['be_admin_optgroup_label']     = array(1 => 'Text', 2 => 'Image', 3 => 'Form', 4 => 'Admin', 5 => 'Special');$BL['be_cnt_articlemenu_maxchar']  = 'Max. Chars';
...
$BL['file_actions_unused_title']   = 'Unused files';
$BL['file_actions_unused_intro']   = 'Searches all files for ones that were previously used in article content but are no longer referenced anywhere (black status).';
$BL['file_actions_unused_search']  = 'Search unused files';
$BL['file_actions_unused_none']    = 'No unused files were found.';
$BL['file_actions_unused_back']    = 'Back';
...
$BL['be_fusage_red']               = 'File is in use, cannot be deleted';
$BL['be_fusage_yellow']            = 'Newly uploaded, less than 24h old';
$BL['be_fusage_green']             = 'New, unused, older than 24h';
$BL['be_fusage_black']             = 'Was used before, not anymore';
$BL['be_fusage_nodelete']          = 'File is in use and therefore cannot be moved to the trash';
$BL['be_fprivfunc_selectfile']     = 'Select';
$BL['be_fusage_bulk_selected']     = '{VAL} file(s) selected';
$BL['be_fusage_bulk_clear']        = 'Clear selection';
$BL['be_fusage_bulk_trash_confirm'] = 'Do you really want to put {VAL} file(s) into the trash?';
$BL['be_fusage_bulk_skipped']      = '{VAL} file(s) were skipped because they are still in use.';
...
// Email Templates
$BL['be_admin_mail_templates']      = 'Email Templates';
$BL['be_admin_mail_templates_desc'] = 'Manage and customize transactional emails sent by the system (subject, content, and placeholders).';
$BL['be_admin_mail_name']           = 'Template Name';
$BL['be_admin_mail_subject']        = 'Subject';
$BL['be_admin_mail_saved']          = 'Email template saved successfully.';
$BL['be_admin_mail_err_save']       = 'Error saving template to database.';
$BL['be_admin_mail_reset_default']  = 'Reset to Default';
$BL['be_admin_mail_reset_done']     = 'Template reset to system default.';
$BL['be_admin_mail_confirm_reset']  = 'Do you really want to reset the template “{NAME}” to the system default?';
$BL['be_admin_mail_customized']     = 'Customized';
$BL['be_admin_mail_inactive']       = 'Inactive';
$BL['be_admin_mail_back_to_list']   = 'Back to Overview';
$BL['be_admin_mail_placeholders']   = 'Available Placeholders';
$BL['be_admin_mail_html_note']      = 'The HTML markup is wrapped into the standard responsive email layout automatically (header logo, container, footer).';
$BL['be_admin_mail_text_note']      = 'Fallback plain text for mail clients without HTML support.';
$BL['be_admin_mail_active_desc']    = 'Use this customized version when sending emails';
$BL['be_admin_mail_test_title']     = 'Send Test Email';
$BL['be_admin_mail_test_desc']      = 'Send a rendered preview of this email with sample data to verify design and formatting.';
$BL['be_admin_mail_send_test']      = 'Send Test Email';
$BL['be_admin_mail_test_sent']      = 'Test email sent successfully to {EMAIL}.';
$BL['be_admin_mail_title_password_reset'] = 'Password Reset Request';
$BL['be_admin_mail_desc_password_reset']  = 'Sent to users requesting a password reset link on the login page.';
$BL['be_admin_mail_title_new_user']       = 'New User Account Welcome';
$BL['be_admin_mail_desc_new_user']        = 'Sent when a new backend user account is created by an administrator.';
$BL['be_admin_mail_title_edit_user']      = 'User Account Updated';
$BL['be_admin_mail_desc_edit_user']       = 'Sent when an administrator updates a user account and checks the send email option.';
$BL['be_admin_mail_title_account_deactivated'] = 'Account Deactivation Notification';
$BL['be_admin_mail_desc_account_deactivated']  = 'Sent when an administrator deactivates a user account.';
$BL['be_admin_mail_title_password_changed']    = 'Password Changed Confirmation';
$BL['be_admin_mail_desc_password_changed']     = 'Sent to the user when their account password has been successfully changed or reset.';
$BL['be_admin_mail_title_user_email_changed']  = 'Email Address Changed Notification';
$BL['be_admin_mail_desc_user_email_changed']   = 'Sent to the previous email address when the account email address is changed.';
$BL['be_admin_mail_title_account_locked']      = 'Security Alert (Failed Login Attempts)';
$BL['be_admin_mail_desc_account_locked']       = 'Sent to the user when multiple repeated failed login attempts are detected.';
$BL['be_admin_mail_ph_name']        = 'Recipient display name or username';
$BL['be_admin_mail_ph_login']       = 'Username / login';
$BL['be_admin_mail_ph_new_email']   = 'New email address';
$BL['be_admin_mail_ph_old_email']   = 'Previous email address';
$BL['be_admin_mail_ph_ip']          = 'IP address of the attempt';
$BL['be_admin_mail_ph_date']        = 'Date and time';
$BL['be_admin_mail_ph_password']    = 'Assigned password';
$BL['be_admin_mail_ph_site']        = 'Website host name';
$BL['be_admin_mail_ph_site_url']    = 'Full website URL';
$BL['be_admin_mail_ph_reset_link']  = 'Password reset URL with secure token';
$BL['be_admin_mail_ph_expires']     = 'Expiration time (e.g. 1 hour)';
$BL['be_admin_mail_ph_login_page']  = 'Direct URL to login page';
$BL['be_admin_mail_ph_admin_email'] = 'Administrator contact email';
$BL['be_admin_mail_ph_button']      = 'Call-to-action button';
$BL['be_admin_mail_ph_signature']   = 'Closing signature block';
$BL['be_admin_mail_title_mail_layout'] = 'Master Email Layout (HTML Shell)';
$BL['be_admin_mail_desc_mail_layout']  = 'The responsive HTML layout wrapping all transactional system emails (header, content container, and footer).';
$BL['be_admin_mail_ph_preheader']   = 'Hidden preview text snippet';
$BL['be_admin_mail_ph_header']      = 'Rendered email header (logo or site name)';
$BL['be_admin_mail_ph_title']       = 'Email subject / headline';
$BL['be_admin_mail_ph_content']     = 'Body content of the specific email';
$BL['be_admin_mail_ph_footer']      = 'Rendered email footer / disclaimer';
$BL['be_admin_mail_layout_html_note'] = 'The master HTML document structure. Use <code>{CONTENT}</code> for the inner email message, <code>{HEADER}</code> and <code>{FOOTER}</code> for standard branding, and <code>{TITLE}</code> for the headline.';
$BL['be_admin_mail_title_mail_header'] = 'Email Header Component';
$BL['be_admin_mail_desc_mail_header']  = 'Sub-template for the email top header (rendered via {HEADER} in master layout).';
$BL['be_admin_mail_title_mail_footer'] = 'Email Footer Component';
