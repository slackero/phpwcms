...
$BL['be_update_check']              = 'अपडेट की जाँच करें';
$BL['be_update_run']                = 'बैकअप &amp; अभी अपडेट करें';
$BL['be_update_confirm']            = 'सिस्टम डेटाबेस का बैकअप बनाता है, फिर अपनी फ़ाइलों को बदलता है। जारी रखें?';
$BL['be_update_success']            = '%s में अपडेट सफलतापूर्वक पूरा हुआ।';
$BL['be_update_failed']             = 'अपडेट विफल रहा';
$BL['be_update_fetch_error']        = 'GitHub से अपडेट जानकारी प्राप्त नहीं की जा सकी। नवीनतम रिलीज़ में zip फ़ाइल नहीं हो सकती है, या API उपलब्ध नहीं है।';
$BL['be_update_uptodate']           = 'phpwcms अप-टू-डेट है।';
$BL['be_update_history']            = 'अपडेट इतिहास';
$BL['be_update_rollback']           = 'पिछला संस्करण पुनर्स्थापित करें';
$BL['be_update_rolled_back']        = 'पिछला संस्करण पुनर्स्थापित किया गया।';
$BL['be_update_clear_maintenance']  = 'रखरखाव मोड साफ़ करें';
...
$BL['be_admin_custom_cpt_err_reserved_field_key'] = 'फ़ील्ड कुंजी “%s” एक आरक्षित मानक टैग नाम है और इसका उपयोग नहीं किया जा सकता है।';
