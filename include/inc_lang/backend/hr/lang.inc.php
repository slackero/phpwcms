...
$BL['be_cnt_field']                = array('text' => 'tekst (jednoredni)', 'email' => 'email', 'textarea' => 'tekstualno polje (višeredno)', 'hidden' => 'skriveno polje', 'password' => 'lozinka', 'select' => 'padajući izbornik', 'list' => 'popis', 'checkbox' => 'potvrdni okvir (checkbox)', 'radio' => 'radio gumb', 'upload' => 'učitavanje datoteke', 'submit' => 'gumb za slanje', 'reset' => 'gumb za poništavanje', 'break' => 'prijelom', 'breaktext' => 'tekst prijeloma', 'special' => 'posebni tekst', 'captchaimg' => 'captcha slika', 'captcha' => 'captcha kod', 'newsletter' => 'bilten (newsletter)', 'tel' => 'telefon', 'url' => 'url (web adresa)', 'number' => 'broj', 'date' => 'datum', 'time' => 'vrijeme', 'color' => 'birač boja', 'range' => 'klizač');
...
$BL['be_cnt_articlemenu_maxchar']  = 'maks. znakova';
