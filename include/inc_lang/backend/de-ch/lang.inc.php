...
$BL['be_profile_2fa_step2_text'] = 'Geben Sie den 6-stelligen Best&auml;tigungscode aus Ihrer Authentifikator-App ein, um die Einrichtung abzuschliessen:';
...
$BL['login_2fa_desc'] = 'F&uuml;r dieses Konto ist die Zwei-Faktor-Authentifizierung aktiv. Geben Sie den 6-stelligen Code aus Ihrer Authentifikator-App oder einen Wiederherstellungscode ein, um die Anmeldung abzuschliessen.';
...
$BL['be_fprivup_err11'] = 'Die Datei "%s" ist zu gross (%s). Maximal zul&auml;ssige Gr&ouml;sse ist %s.';
...
$BL['be_cnt_doubleoptin'] = 'aktiviere Double Opt-In gem&auml;ss der <a href="https://de.wikipedia.org/wiki/Datenschutz-Grundverordnung" target="_blank">Datenschutzgrundverordnung</a> (DSGVO)';
...
$BL['be_fileuploader_typeError'] = "Datei {file} hat eine nicht zul&auml;ssige Erweiterung. Zul&auml;ssig: {extensions}.";
$BL['be_fileuploader_sizeError'] = "Datei {file} ist zu gross, Dateigr&ouml;sse maximal {sizeLimit} zul&auml;ssig.";
$BL['be_fileuploader_minSizeError'] = "{file} ist zu klein, Dateigr&ouml;sse mindestens {minSizeLimit}.";
...
$BL['be_ie8ignore'] = '<a href="https://de.wikipedia.org/wiki/Conditional_Comments" target="_blank" class="underline">Conditional Comments</a> f&uuml;r IE8 deaktivieren (deprecated)';
...
$BL['deleted_msg_error'] = ' Template konnte nicht gel&ouml;scht werden.';
$BL['rename_msg']      = ' Template erfolgreich umbenannt.';
$BL['rename_msg_error'] = ' Template konnte nicht umbenannt werden.';
...
$BL['OPEN_DIR']          = '&Ouml;ffne Verzeichnis';
$BL['CLOSE_DIR']         = 'Schliesse Verzeichnis';
$BL['FILE_TITLE']        = 'phpwcms Dateibrowser';
$BL['IMAGE_TITLE']       = 'phpwcms Bildbrowser';
$BL['MEDIA_TITLE']       = 'phpwcms Mediabrowser';
$BL['IMAGE_FILES']       = 'Bilddateien';
...
$BL['FILEINFO_TITLE']    = 'phpwcms: Dateiinformation';
$BL['CREATED']           = 'erstellt';
$BL['DATE_FORMAT']       = 'd.m.Y H:i';
$BL['SIZE']              = 'Gr&ouml;sse';
$BL['DOWNLOAD_FILE']     = 'Datei herunterladen';
$BL['FILE_IN_TRASH']     = 'Datei ist im Papierkorb';
$BL['KEYWORDS']          = 'Schl&uuml;ssel';
$BL['DOWNLOAD_ERR3']     = 'Fehler beim Lesen der Dateiinfo<br />Fenster schliessen und erneut versuchen&#8230;';
...
// Theme selection
$BL['be_theme'] = 'Theme';
$BL['be_theme_auto'] = 'Automatisch (System)';
$BL['be_theme_light'] = 'Hell';
$BL['be_theme_dark'] = 'Dunkel';

// Custom Content Parts
$BL['be_admin_custom_cpt']              = 'Custom Content Parts';
$BL['be_admin_custom_cpt_add']          = 'Neuer Custom Content Part';
$BL['be_admin_custom_cpt_edit']         = 'Custom Content Part bearbeiten';
$BL['be_admin_custom_cpt_new']          = 'Custom Content Part erstellen';
$BL['be_admin_custom_cpt_title']        = 'Titel / Anzeigename';
$BL['be_admin_custom_cpt_key']          = 'Schl&uuml;ssel / Alias';
$BL['be_admin_custom_cpt_mode']         = 'Modus';
$BL['be_admin_custom_cpt_repeater']     = 'Repeater (Liste)';
$BL['be_admin_custom_cpt_single']       = 'Einzelnes Element';
$BL['be_admin_custom_cpt_desc']         = 'Beschreibung';
$BL['be_admin_custom_cpt_icon']         = 'Icon';
$BL['be_admin_custom_cpt_fields']       = 'Felddefinitionen';
$BL['be_admin_custom_cpt_add_field']    = 'Feld hinzuf&uuml;gen';
$BL['be_admin_custom_cpt_field_key']    = 'Schl&uuml;ssel (Tag)';
$BL['be_admin_custom_cpt_field_label']  = 'Beschriftung / Titel';
$BL['be_admin_custom_cpt_field_type']   = 'Typ';
$BL['be_admin_custom_cpt_field_config'] = 'Optionen / Konfiguration';
$BL['be_admin_custom_cpt_actions']      = 'Aktionen';
$BL['be_admin_custom_cpt_registered']   = 'Konfigurierte Custom Content Parts';
$BL['be_admin_custom_cpt_import']       = 'JSON importieren';
$BL['be_admin_custom_cpt_export']       = 'JSON exportieren';
$BL['be_admin_custom_cpt_upload_json']  = 'JSON-Datei hochladen';
$BL['be_admin_custom_cpt_paste_json']   = 'Oder JSON-Inhalt einf&uuml;gen';
$BL['be_admin_custom_cpt_modal_import'] = 'Custom Content Part importieren';
$BL['be_admin_custom_cpt_no_entries']   = 'Noch keine Custom Content Parts definiert.';
$BL['be_admin_custom_cpt_create_one']   = 'Jetzt anlegen';
$BL['be_admin_custom_cpt_preset']       = 'Preset';
$BL['be_admin_custom_cpt_legacy']       = 'Legacy';
$BL['be_admin_custom_cpt_readonly_file']= 'Schreibgesch&uuml;tzt (Datei)';
$BL['be_admin_custom_cpt_delete_confirm']= 'Diesen Custom Content Part wirklich l&ouml;schen?';
$BL['be_admin_custom_cpt_err_save']     = 'Fehler beim Speichern des Custom Content Parts.';
$BL['be_admin_custom_cpt_err_import']   = 'Ung&uuml;ltige JSON-Daten f&uuml;r den Import angegeben.';
$BL['be_admin_custom_cpt_divider']      = 'Trennlinie';
$BL['be_admin_custom_cpt_default_val']  = 'Standardwert&#8230;';
$BL['be_admin_custom_cpt_opt_placeholder'] = 'schl&uuml;ssel:Beschriftung (eine pro Zeile)';
$BL['be_admin_custom_cpt_scaffold']     = 'Template-Vorlage';
$BL['be_admin_custom_cpt_scaffold_help']= 'Kopieren und als Vorlagendatei speichern unter:';
$BL['be_admin_custom_cpt_copy']         = 'In Zwischenablage kopieren';
$BL['be_admin_custom_cpt_copied']       = 'Kopiert!';
$BL['be_admin_custom_cpt_create_template']      = 'Starter-Template-Datei anlegen';
$BL['be_admin_custom_cpt_create_template_help'] = 'Automatisch Vorlagendatei anlegen:';
$BL['be_admin_custom_cpt_template_exists']      = 'Template-Datei existiert bereits:';
$BL['be_admin_custom_cpt_template_saved']       = 'Template-Datei erfolgreich gespeichert:';
$BL['be_admin_custom_cpt_overwrite_template']   = 'Vorlagendatei &uuml;berschreiben:';
$BL['be_admin_custom_cpt_err_duplicate_key']    = 'Der Identifikationsschl&uuml;ssel &bdquo;%s&ldquo; wird bereits verwendet.';
$BL['be_admin_custom_cpt_err_duplicate_key_simple'] = 'Dieser Identifikationsschl&uuml;ssel wird bereits verwendet.';
$BL['be_admin_custom_cpt_key_in_use']           = 'Schl&uuml;ssel ist gesperrt, da er in %d Content Part(s) verwendet wird.';
$BL['be_admin_custom_cpt_delete_field_confirm']        = 'Feld &bdquo;%s&ldquo; wirklich l&ouml;schen?';
