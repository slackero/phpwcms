...
// Language: DE-CH, Language Code: de-ch
...
// Self-update
$BL['be_subnav_admin_update']       = 'System-Update';
$BL['be_update_current']            = 'Installierte Version';
$BL['be_update_available']          = 'Verf&uuml;gbare Version';
$BL['be_update_check']              = 'Auf Update pr&uuml;fen';
$BL['be_update_run']                = 'Backup &amp; jetzt aktualisieren';
$BL['be_update_confirm']            = 'Das System erstellt ein Datenbank-Backup und ersetzt anschlie&szlig;end seine eigenen Dateien. Fortfahren?';
$BL['be_update_success']            = 'Update auf %s erfolgreich abgeschlossen.';
$BL['be_update_failed']             = 'Update fehlgeschlagen';
$BL['be_update_fetch_error']        = 'Update-Informationen konnten nicht von GitHub abgerufen werden. Die neueste Version hat m&ouml;glicherweise kein Zip-Paket oder die API ist nicht erreichbar.';
$BL['be_update_uptodate']           = 'phpwcms ist auf dem neuesten Stand.';
$BL['be_update_history']            = 'Update-Verlauf';
$BL['be_update_rollback']           = 'Vorherige Version wiederherstellen';
$BL['be_update_rolled_back']        = 'Vorherige Version wurde wiederhergestellt.';
$BL['be_update_clear_maintenance']  = 'Wartungsmodus beenden';
...
$BL['be_ftptakeover_processing'] = 'Die ausgew&auml;hlten Dateien werden &uuml;bernommen!';
$BL['be_ftptakeover_dberror'] = 'MySQL-Fehler beim Einf&uuml;gen in die Datenbank: ';
$BL['be_ftptakeover_ok'] = 'OK!';
$BL['be_ftptakeover_missing'] = 'Existiert nicht';
$BL['be_ftptakeover_done'] = 'Alle ausgew&auml;hlten Dateien wurden &uuml;bernommen!';
$BL['be_ftptakeover_error'] = 'Fehler bei der Datei&uuml;bernahme!';
$BL['be_ftptakeover_return'] = '&Laquo; Zur&uuml;ck';
$BL['be_ftptakeover_autoredirect'] = 'Falls keine automatische Weiterleitung';
...
$BL['be_fprivup_err11']            = 'Die Datei &laquo;%s&raquo; ist zu gross (%s). Maximal zul&auml;ssige Gr&ouml;sse ist %s.';
...
$BL['setup_dir_exists']            = '<strong>ACHTUNG!</strong> Das &laquo;SETUP&raquo; Verzeichnis ist noch immer vorhanden! L&ouml;schen Sie dieses Verzeichnis, sonst haben Sie ein potentielles Sicherheitproblem.';
...
$BL['be_newsletter_placeholder_insert'] = 'Klicken zum Einf&uuml;gen an der Cursor-Position';
...
$BL['be_admin_group_err']         = 'Gruppenname ist leer!';
$BL['be_admin_group_added']       = 'Gruppe erfolgreich hinzugefügt';
...
$BL['be_cnt_field']                = array('text' => 'Text (einzeilig)', 'email' => 'E-Mail', 'textarea' => 'Text (mehrzeilig)', 'hidden' => 'Versteckt', 'password' => 'Passwort', 'select' => 'Ausklappmen&uuml;', 'list' => 'Liste', 'checkbox' => 'Checkbox', 'checkboxcopy' => 'Checkbox (E-Mail Kopie an/aus)', 'radio' => 'Optionsschalter', 'upload' => 'Datei', 'submit' => 'Sende-Taste', 'reset' => 'Zur&uuml;cksetzen', 'break' => 'Trenner', 'breaktext' => 'Zwischentext', 'special' => 'Text (spezial)', 'captchaimg' => 'Captcha Bild', 'captcha' => 'Captcha Code', 'newsletter' => 'Newsletter', 'selectemail' => 'E-Mail Ausklappmen&uuml;', 'country' => 'L&auml;nder-Ausklappmen&uuml;', 'mathspam' => 'Mathe Spam Schutz', 'summing' => 'Summieren', 'subtract' => 'Subtrahieren', 'divide' => 'Dividieren', 'multiply' => 'Multiplizieren', 'calculation' => 'Berechnung:', 'formtracking_off' => 'Formular-Tracking ausschalten', 'checktofrom' => 'Empf&auml;nger und Absender E-Mail m&uuml;ssen verschieden sein', 'recaptcha' => 'ReCAPTCHA', 'recaptcha_signapikey' => 'Registrierung eines reCAPTCHA API-Schl&uuml;ssels', 'recaptchainv' => 'Unsichtbares reCAPTCHA', 'tel' => 'Telefon', 'url' => 'URL (Webadresse)', 'number' => 'Zahl', 'date' => 'Datum', 'time' => 'Uhrzeit', 'color' => 'Farbauswahl', 'range' => 'Schieberegler');$BL['be_cnt_optin']                = 'Double Opt-In';
...
$BL['phpwcms_code_snippets_dir_exists'] = '<strong>ACHTUNG!</strong> Das &laquo;CODE-SNIPPETS&raquo; Verzeichnis ist noch immer vorhanden! L&ouml;schen Sie das Verzeichnis <strong>&laquo;phpwcms_code_snippets&raquo;</strong>, sonst haben Sie ein potentielles Sicherheitproblem.';
...
$BL['be_fileuploader_dictDefaultMessage'] = '<i class="fa-solid fa-cloud-upload-alt fa-3x mb-3 text-muted d-block"></i><span class="fw-bold">Dateien w&auml;hlen oder hier ablegen</span><br><small class="text-muted">Klicken oder Dateien per Drag & Drop hineinziehen</small>';
...
$BL['be_cnt_fpro_usecaption']      = 'Dateizentrums-&laquo;Info&raquo; verwenden';
...
$BL['be_cnt_expand_all']           = 'Alle aufklappen';
$BL['be_cnt_collapse_all']         = 'Alle zuklappen';
$BL['be_cnt_texts']                = 'Texte';
$BL['be_admin_template_lang']      = 'Template-&Uuml;bersetzungen';
$BL['be_admin_template_lang_desc'] = 'Automatische <code>@@Text@@</code> Frontend-&Uuml;bersetzungen verwalten (unter <code>template/template_lang</code>).';
$BL['be_admin_template_lang_saved']= '&Uuml;bersetzungen erfolgreich gespeichert.';
$BL['be_admin_template_lang_deleted'] = '&Uuml;bersetzungstoken erfolgreich gel&ouml;scht.';
$BL['be_admin_template_lang_token_added'] = 'Neues &Uuml;bersetzungstoken erfolgreich hinzugef&uuml;gt.';
$BL['be_admin_template_lang_empty'] = 'Keine &Uuml;bersetzungstoken gefunden.';
$BL['be_admin_template_lang_token']= 'Token / Standardtext';
$BL['be_admin_template_lang_trans']= '&Uuml;bersetzung';
$BL['be_admin_template_lang_all']  = 'Alle';
$BL['be_admin_template_lang_missing'] = 'Fehlende &Uuml;bersetzung';
$BL['be_admin_template_lang_translated'] = '&Uuml;bersetzt';
$BL['be_admin_template_lang_add']  = 'Token hinzuf&uuml;gen';
$BL['be_admin_template_lang_filter'] = 'Filter';
$BL['be_admin_template_lang_search'] = 'Token oder &Uuml;bersetzungen suchen&#8230;';
$BL['be_admin_template_lang_items'] = 'Eintr&auml;ge';

// Email Templates
$BL['be_admin_mail_templates']      = 'E-Mail-Vorlagen';
$BL['be_admin_mail_templates_desc'] = 'Verwalten und Anpassen von System-E-Mails (Betreff, Inhalt und Platzhalter).';
$BL['be_admin_mail_name']           = 'E-Mail Vorlagenname';
$BL['be_admin_mail_subject']        = 'Betreff';
$BL['be_admin_mail_saved']          = 'E-Mail-Vorlage erfolgreich gespeichert.';
$BL['be_admin_mail_err_save']       = 'Fehler beim Speichern der Vorlage in der Datenbank.';
$BL['be_admin_mail_reset_default']  = 'Auf Standard zur&uuml;cksetzen';
$BL['be_admin_mail_reset_done']     = 'Vorlage auf System-Standard zur&uuml;ckgesetzt.';
$BL['be_admin_mail_confirm_reset']  = 'M&ouml;chten Sie die Vorlage &#8222;{NAME}&#8220; wirklich auf den Systemstandard zur&uuml;cksetzen?';
$BL['be_admin_mail_customized']     = 'Angepasst';
$BL['be_admin_mail_inactive']       = 'Inaktiv';
$BL['be_admin_mail_back_to_list']   = 'Zur&uuml;ck zur &Uuml;bersicht';
$BL['be_admin_mail_placeholders']   = 'Verf&uuml;gbare Platzhalter';
$BL['be_admin_mail_html_note']      = 'Der HTML-Inhalt wird automatisch in das responsive Standard-Layout eingebettet (Header-Logo, Container, Footer).';
$BL['be_admin_mail_text_note']      = 'Einfacher Text f&uuml;r E-Mail-Programme ohne HTML-Unterst&uuml;tzung.';
$BL['be_admin_mail_active_desc']    = 'Angepasste Version beim E-Mail-Versand verwenden';
$BL['be_admin_mail_test_title']     = 'Test-E-Mail senden';
$BL['be_admin_mail_test_desc']      = 'Senden Sie eine Vorschau dieser Vorlage mit Beispieldaten, um Darstellung und Formatierung zu pr&uuml;fen.';
$BL['be_admin_mail_send_test']      = 'Test-E-Mail senden';
$BL['be_admin_mail_test_sent']      = 'Test-E-Mail wurde erfolgreich an {EMAIL} gesendet.';
$BL['be_admin_mail_title_password_reset'] = 'Passwort zur&uuml;cksetzen';
$BL['be_admin_mail_desc_password_reset']  = 'Wird gesendet, wenn ein Benutzer auf der Anmeldeseite ein Zur&uuml;cksetzen des Passworts anfordert.';
$BL['be_admin_mail_title_new_user']       = 'Neues Benutzerkonto (Willkommen)';
$BL['be_admin_mail_desc_new_user']        = 'Wird gesendet, wenn ein Administrator ein neues Benutzerkonto anlegt.';
$BL['be_admin_mail_title_edit_user']      = 'Benutzerkonto ge&auml;ndert';
$BL['be_admin_mail_desc_edit_user']       = 'Wird gesendet, wenn ein Administrator ein Konto aktualisiert und den E-Mail-Versand aktiviert.';
$BL['be_admin_mail_title_account_deactivated'] = 'Benutzerkonto deaktiviert';
$BL['be_admin_mail_desc_account_deactivated']  = 'Wird gesendet, wenn ein Administrator ein Benutzerkonto deaktiviert.';
$BL['be_admin_mail_title_password_changed']    = 'Passwort ge&auml;ndert';
$BL['be_admin_mail_desc_password_changed']     = 'Wird an den Benutzer gesendet, wenn das Passwort ge&auml;ndert oder zur&uuml;ckgesetzt wurde.';
$BL['be_admin_mail_title_user_email_changed']  = 'E-Mail-Adresse ge&auml;ndert';
$BL['be_admin_mail_desc_user_email_changed']   = 'Wird an die bisherige E-Mail-Adresse gesendet, wenn die Kontoadresse ge&auml;ndert wurde.';
$BL['be_admin_mail_title_account_locked']      = 'Sicherheitshinweis (Fehlgeschlagene Anmeldungen)';
$BL['be_admin_mail_desc_account_locked']       = 'Wird an den Benutzer gesendet, wenn wiederholt falsche Anmeldeversuche festgestellt wurden.';
$BL['be_admin_mail_ph_name']        = 'Name oder Benutzername des Empf&auml;ngers';
$BL['be_admin_mail_ph_login']       = 'Benutzername / Login';
$BL['be_admin_mail_ph_new_email']   = 'Neue E-Mail-Adresse';
$BL['be_admin_mail_ph_old_email']   = 'Bisherige E-Mail-Adresse';
$BL['be_admin_mail_ph_ip']          = 'IP-Adresse des Anmeldeversuchs';
$BL['be_admin_mail_ph_date']        = 'Datum und Uhrzeit';
$BL['be_admin_mail_ph_password']    = 'Zugewiesenes Passwort';
$BL['be_admin_mail_ph_site']        = 'Website-Hostname';
$BL['be_admin_mail_ph_site_url']    = 'Vollst&auml;ndige Website-URL';
$BL['be_admin_mail_ph_reset_link']  = 'Passwort-Reset-URL mit Sicherheitstoken';
$BL['be_admin_mail_ph_expires']     = 'G&uuml;ltigkeitsdauer (z.B. 1 Stunde)';
$BL['be_admin_mail_ph_login_page']  = 'Direkte URL zur Anmeldeseite';
$BL['be_admin_mail_ph_admin_email'] = 'Administrator-Kontakt-E-Mail';
$BL['be_admin_mail_ph_button']      = 'Aktions-Button (CTA)';
$BL['be_admin_mail_ph_signature']   = 'Abschluss-Signatur';
$BL['be_admin_mail_title_mail_layout'] = 'Haupt-E-Mail-Layout (HTML-Rahmen)';
$BL['be_admin_mail_desc_mail_layout']  = 'Das responsive HTML-Layout, das alle System-E-Mails umschliesst (Header, Inhaltsbereich und Footer).';
$BL['be_admin_mail_ph_preheader']   = 'Versteckter Vorschautext (Preheader)';
$BL['be_admin_mail_ph_header']      = 'Gerenderter E-Mail-Header (Logo oder Website-Name)';
$BL['be_admin_mail_ph_title']       = 'E-Mail-Betreff / Haupt&uuml;berschrift';
$BL['be_admin_mail_ph_content']     = 'Hauptinhalt der jeweiligen E-Mail';
$BL['be_admin_mail_ph_footer']      = 'Gerenderter E-Mail-Footer / Impressum';
$BL['be_admin_mail_layout_html_note'] = 'Die grundlegende HTML-Dokumentstruktur. Verwenden Sie <code>{CONTENT}</code> f&uuml;r den Nachrichtentext, <code>{HEADER}</code> und <code>{FOOTER}</code> f&uuml;r Logo/Impressum und <code>{TITLE}</code> f&uuml;r den Titel.';
$BL['be_admin_mail_title_mail_header'] = 'E-Mail-Header-Komponente';
$BL['be_admin_mail_desc_mail_header']  = 'Teilvorlage f&uuml;r den oberen E-Mail-Header (wird &uuml;ber {HEADER} im Haupt-Layout ausgegeben).';
$BL['be_admin_mail_title_mail_footer'] = 'E-Mail-Footer-Komponente';
