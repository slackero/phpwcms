...
$BL['be_cnt_field']                = array('text' => 'metin (tek-satırlı)', 'email' => 'email', 'textarea' => 'metin (çok-satirli)', 'hidden' => 'gizli', 'password' => 'şifre', 'select' => 'açllır kutu', 'list' => 'liste menü', 'checkbox' => 'işaret-kutusu', 'radio' => 'radyo-buton', 'upload' => 'dosya', 'submit' => 'gönder butonu', 'reset' => 'temizle butonu', 'break' => 'kesme', 'breaktext' => 'kesme metni', 'special' => 'metin (özel)', 'tel' => 'telefon', 'url' => 'url (web adresi)', 'number' => 'sayı', 'date' => 'tarih', 'time' => 'saat', 'color' => 'renk seçici', 'range' => 'kaydırıcı');
