...
$BL['be_page_title'] = 'cmsGO! Backend (Verwaltung)';

$BL['be_subnav_article_center'] = 'Artikelübersicht';
$BL['be_subnav_article_new'] = 'Neuer Artikel';
$BL['be_subnav_file_center'] = 'Dateiübersicht';
...
$BL['be_ftabhelp_paste']                = 'Datei in diesen Ordner einfügen';
$BL['be_ftabhelp_download']             = 'Datei herunterladen';
$BL['be_ftabhelp_delete']               = 'Datei löschen';
$BL['be_ftabhelp_cantdelete']           = 'Datei kann nicht gelöscht werden';
...
$BL['be_ftabhelp_public']               = 'Datei oder Ordner ist Öffentlich';
...
$BL['be_admin_usr_mailsubject'] = 'Willkommen im cmsGO! Backend';
$BL['be_admin_usr_mailbody'] = "WILLKOMMEN IM CMSGO! BACKEND\n\n    Benutzer: {LOGIN}\n    Kennwort: {PASSWORD}\n\n\nSie können sich hier anmelden: {LOGIN_PAGE}\n\ncmsgo Administrator\n ";
...
$BL['be_admin_usr_emailsubject'] = 'cmsGO! - Anmeldedaten ge&auml;ndert';
$BL['be_admin_usr_emailbody'] = "CMSGO! ANMELDEDATEN GEÄNDERT\n\n    Benutzer: {LOGIN}\n    Kennwort: {PASSWORD}\n\n\nSie können sich hier anmelden: {LOGIN_PAGE}\n\ncmsgo Administrator\n ";
...
$BL['be_admin_usr_ltitle'] = 'cmsGO! Benutzerliste';
...
$BL['be_cnt_pages_php_render_warning'] = 'Inline PHP <code>$cmsgo[&#39;enable_inline_php&#39;]</code> ist deaktiviert.';
...
$BL['Version_up_to_date'] = 'Diese Installation ist auf dem neuesten Stand; es sind keine Updates f&uuml;r diese Version von cmsGO! verf&uuml;gbar.';
$BL['Version_not_up_to_date'] = 'Diese Installation ist wahrscheinlich <b>nicht</b> auf dem neuesten Stand. Es sind Updates f&uuml;r diese Version von cmsGO! verf&uuml;gbar, bitte <a href="https://github.com/slackero/cmsgo/releases" target="_blank">GitHub Releases</a> besuchen, um die aktuellste Version zu erhalten.';
$BL['Latest_version_info'] = 'Die neueste offizielle Version ist <b>cmsGO! %s</b>.';
$BL['Current_version_info'] = 'Aktuell verwendete Version <b>cmsGO! %s</b>.';
$BL['Connect_socket_error'] = 'Die Verbindung zum cmsGO!-Server konnte nicht aufgebaut werden. Es trat folgender Fehler auf:<br />%s';
$BL['Socket_functions_disabled'] = 'Die Socket-Funktionen konnten nicht benutzt werden.';
$BL['Mailing_list_subscribe_reminder'] = 'Um immer die neuesten Informationen zu Updates von cmsGO! zu erhalten, wird empfohlen, sich bei der <a href="http://eepurl.com/bm-BrH" target="_blank">cmsGO! Mailingliste</a> anzumelden.';
...
$BL['be_aboutlink_title'] = 'Informationen zu cmsGO! sowie den Lizenzbedingungen';
...
$BL['cc_v3_title_placeholder'] = 'Wir schätzen Ihre Privatsphäre';
$BL['be_cc_v3_description'] = 'Beschreibung';
$BL['cc_v3_description_placeholder'] = 'Wir verwenden Cookies, um Ihr Browsing-Erlebnis zu verbessern, personalisierte Werbung oder Inhalte bereitzustellen und unseren Datenverkehr zu analysieren. Wenn Sie auf „Alle akzeptieren“ klicken, stimmen Sie unserer Verwendung von Cookies zu.';
$BL['be_cc_v3_accept_all'] = 'Button „Alle akzeptieren“';
$BL['cc_v3_accept_all_placeholder'] = 'Alle akzeptieren';
$BL['be_cc_v3_accept_necessary'] = 'Button „Notwendige akzeptieren“';
$BL['cc_v3_accept_necessary_placeholder'] = 'Notwendige akzeptieren';
$BL['be_cc_v3_accept_selected'] = 'Button „Auswahl akzeptieren“';
$BL['cc_v3_accept_selected_placeholder'] = 'Auswahl akzeptieren';
$BL['be_cc_v3_reject_all'] = 'Button „Alle ablehnen“';
$BL['cc_v3_reject_all_placeholder'] = 'Alle ablehnen';
$BL['be_cc_v3_customize'] = 'Button „Anpassen“';
...
$BL['be_cc_v3_theme'] = 'Vorlage (leer = ohne CSS)';
...
$BL['be_cc_v3_section_necessary_description_placeholder'] = 'Notwendige Cookies sind erforderlich, um die grundlegenden Funktionen dieser Website zu ermöglichen, wie z.B. das sichere Einloggen oder die Anpassung Ihrer Einwilligungseinstellungen. Diese Cookies speichern keine persönlich identifizierbaren Daten.';
$BL['be_cc_v3_section_functional'] = 'Funktion';
$BL['be_cc_v3_section_functional_title_placeholder'] = 'Funktionale Cookies';
$BL['be_cc_v3_section_functional_description_placeholder'] = 'Funktionalitäts-Cookies werden verwendet, um die Leistung von Websites zu verbessern, da ohne sie bestimmte Funktionen der Website möglicherweise nicht verfügbar sind. Funktionscookies werden verwendet, um die Leistung von Websites zu verbessern, da ohne sie bestimmte Funktionen der Website möglicherweise nicht verfügbar sind. So ermöglichen diese z.B. das Speichern wichtiger Informationen und Benutzereinstellungen. Zu den Informationen können Anmeldedaten, Region, Sprache und erweiterte Inhalte gehören.';
$BL['be_cc_v3_section_analytics'] = 'Analyse';
$BL['be_cc_v3_section_analytics_title_placeholder'] = 'Cookies für Leistung und Analytik';
$BL['be_cc_v3_section_analytics_description_placeholder'] = 'Analytische Cookies werden verwendet, um zu verstehen, wie Besucher mit der Website interagieren. Diese Cookies helfen dabei, Informationen über Metriken wie die Anzahl der Besucher, Absprungrate, Verkehrsquelle usw. zu liefern.';
$BL['be_cc_v3_section_marketing'] = 'Marketing';
$BL['be_cc_v3_section_marketing_title_placeholder'] = 'Cookies für Werbung und Marketing';
$BL['be_cc_v3_section_marketing_description_placeholder'] = 'Cookie für Werbung und Marketing werden verwendet, um Werbung bereitzustellen, die für Sie und Ihre Interessen relevanter ist. Kann auch verwendet werden, um die Häufigkeit, mit der Sie eine Werbung sehen, zu begrenzen und die Wirksamkeit von Werbekampagnen zu messen. Werbenetzwerke platzieren sie in der Regel mit der Erlaubnis des Website-Betreibers.';
$BL['be_cc_v3_section_social'] = 'Soziale Medien';
$BL['be_cc_v3_section_social_title_placeholder'] = 'Cookies für soziale Medien';
