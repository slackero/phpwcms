...
$BL['be_update_check']              = '更新を確認';
$BL['be_update_run']                = 'バックアップ &amp; 今すぐ更新';
$BL['be_update_confirm']            = 'システムはデータベースのバックアップを作成し、その後自身のファイルを置き換えます。続行しますか？';
$BL['be_update_success']            = '%s への更新が正常に完了しました。';
$BL['be_update_failed']             = '更新に失敗しました';
$BL['be_update_fetch_error']        = 'GitHub から更新情報を取得できませんでした。最新リリースに zip アセットがないか、API にアクセスできない可能性があります。';
$BL['be_update_uptodate']           = 'phpwcms は最新です。';
$BL['be_update_history']            = '更新履歴';
$BL['be_update_rollback']           = '以前のバージョンを復元';
...
$BL['be_admin_custom_cpt_err_reserved_field_key'] = 'フィールドキー「%s」は予約済みの標準タグ名のため使用できません。';
$BL['be_admin_custom_cpt_err_reserved_field_key_simple'] = '予約済みの標準タグ名です（例: TITLE, SUBTITLE, TEXT など）。';
