...
$BL['be_subnav_file_ftptakeover']  = 'FTP取り込み';
...
$BL['be_ftptakeover_processing'] = '選択されたファイルは引き継がれます！';
$BL['be_ftptakeover_dberror'] = 'データベースへの挿入中にMySQLエラーが発生しました：';
$BL['be_ftptakeover_ok'] = 'OK！';
$BL['be_ftptakeover_missing'] = '存在しません';
$BL['be_ftptakeover_done'] = '選択されたすべてのファイルが引き継がれました！';
$BL['be_ftptakeover_error'] = 'ファイル引き継ぎ中にエラーが発生しました！';
$BL['be_ftptakeover_return'] = '&laquo; 戻る';
$BL['be_ftptakeover_autoredirect'] = '自動リダイレクトがない場合';
