...
$BL['be_func_struct_articleID']    = '記事ID';
$BL['be_func_struct_preview']      = 'プレビュー';
$BL['be_func_struct_edit']         = '記事を編集';
$BL['be_func_struct_sedit']        = '構造レベルを編集';
$BL['be_func_struct_cut']          = '記事を切り取り';
$BL['be_func_struct_nocut']        = '切り取りを解除';
$BL['be_func_struct_svisible']     = '表示/非表示の切り替え';
$BL['be_func_struct_spublic']      = '公開/非公開の切り替え';
...
$BL['be_func_struct_new_article']  = 'この構造レベルに新規記事を作成';
$BL['be_func_struct_new_article_short'] = '新規記事作成';
$BL['be_func_struct_paste_article'] = '記事をこの構造レベルに貼り付け';
$BL['be_func_struct_insert_level'] = '構造レベルを挿入';
$BL['be_func_struct_insert_level_short'] = '構造レベルを挿入';
$BL['be_func_struct_paste_level']  = '構造レベルに貼り付け';
$BL['be_func_struct_cut_level']    = '構造レベルを切り取り';
$BL['be_func_struct_no_cut']       = 'ルートレベルを切り取ることはできません！';
$BL['be_func_struct_no_paste1']    = 'ここに貼り付けることはできません！';
...
$BL['be_func_struct_del_struct']   = '構造レベルを削除';
$BL['be_func_struct_del_sjsmsg']   = '本当に構造レベルを削除しますか？';
$BL['be_func_struct_open']         = '展開';
$BL['be_func_struct_close']        = '折りたたむ';
$BL['be_func_struct_empty']        = '空にする';
