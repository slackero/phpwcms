...
$BL['be_admin_custom_cpt_err_reserved_field_key'] = 'Khóa trường "%s" là tên thẻ tiêu chuẩn dành riêng và không thể sử dụng.';
$BL['be_admin_custom_cpt_err_reserved_field_key_simple'] = 'Tên thẻ tiêu chuẩn dành riêng (ví dụ: TITLE, SUBTITLE, TEXT, v.v.).';
