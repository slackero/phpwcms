...
$BL['login_reset_email_intro']     = 'Primljen je zahtjev za resetovanje lozinke za Vaš backend korisnički račun ({LOGIN}) na {SITE}.';
$BL['login_reset_email_note']      = 'Ovaj link važi 1 sat. Ako niste zatražili resetovanje lozinke, možete sigurno zanemariti ovu poruku.';
$BL['login_revision_success']      = 'Baza podataka je uspješno ažurirana';
$BL['be_admin_usr_mailwelcome']    = 'Dobro došli u phpwcms backend stranice {SITE}.';
$BL['be_admin_usr_maillogin']      = 'Možete se prijaviti ovdje:';
$BL['be_admin_usr_mailchanged']    = 'Podaci Vašeg phpwcms backend korisničkog računa su promijenjeni.';
$BL['email_regards']               = 'Srdačan pozdrav,';
$BL['email_deactivated_subject']   = 'Vaš korisnički račun na {SITE} je deaktiviran';
$BL['email_deactivated_greeting']  = 'Poštovani korisniče,';
$BL['email_deactivated_body']      = 'Vaš korisnički račun na {SITE} je deaktiviran.';
$BL['email_deactivated_contact']   = 'Obratite se administratoru ako imate bilo kakvo pitanje.';
...
$BL['be_update_check']              = 'Provjeri ažuriranje';
$BL['be_update_run']                = 'Napravi sigurnosnu kopiju &amp; ažuriraj sada';
$BL['be_update_confirm']            = 'Sistem kreira sigurnosnu kopiju baze podataka, a zatim zamjenjuje vlastite datoteke. Nastaviti?';
$BL['be_update_success']            = 'Ažuriranje na %s je uspješno završeno.';
...
$BL['be_update_history']            = 'Historija ažuriranja';
...
$BL['be_newsletter_testemail']     = 'Testna e-mail adresa';
...
$BL['be_newsletter_placeholder_insert'] = 'Kliknite da umetnete na poziciju kursora';
...
$BL['be_cnt_field']                = array('text' => 'Tekst (jednolinijski)', 'email' => 'Email', 'textarea' => 'Tekstualno polje (višelinijsko)', 'hidden' => 'Skriveno polje', 'password' => 'Lozinka', 'select' => 'Padajući meni', 'list' => 'Lista', 'checkbox' => 'Polje za potvrdu (checkbox)', 'radio' => 'Radio dugme', 'upload' => 'Otpremanje datoteke', 'submit' => 'Dugme za slanje', 'reset' => 'Dugme za poništavanje', 'break' => 'Prelom', 'breaktext' => 'Tekst preloma', 'special' => 'Posebni tekst', 'captchaimg' => 'Captcha slika', 'captcha' => 'Captcha kod', 'newsletter' => 'Bilten (newsletter)', 'tel' => 'Telefon', 'url' => 'URL (web adresa)', 'number' => 'Broj', 'date' => 'Datum', 'time' => 'Vrijeme', 'color' => 'Birač boja', 'range' => 'Klizač');$BL['be_cnt_access']               = 'Pristup';
...
$BL['be_cnt_page_of_pages_descr']  = '{PREV:Nazad} stranica #/##, rezultati ###-####, {NAVI:123}, {NAVI:1-3}, {NEXT:Naprijed}';
...
$BL['be_ftptakeover_dberror'] = 'MySQL greška pri unosu u bazu podataka: ';
$BL['be_ftptakeover_ok'] = 'OK!';
$BL['be_ftptakeover_missing'] = 'Ne postoji';
$BL['be_ftptakeover_done'] = 'Svaka odabrana datoteka je preuzeta!';
$BL['be_ftptakeover_error'] = 'Greška pri preuzimanju datoteka!';
$BL['be_ftptakeover_return'] = '&Laquo; Nazad';
...
$BL['be_admin_custom_cpt_err_reserved_field_key'] = 'Klju&ccaron; polja „%s“ je rezervisani standardni naziv oznake i ne mo&zcaron;e se koristiti.';
...
$BL['be_admin_template_lang'] = 'Prijevodi &scaron;ablona';
$BL['be_admin_template_lang_desc'] = 'Upravljajte automatskim <code>@@Tekst@@</code> frontend prijevodima spremljenim pod <code>template/template_lang</code>.';
$BL['be_admin_template_lang_saved'] = 'Prijevodi su uspje&scaron;no sa&ccaron;uvani.';
$BL['be_admin_template_lang_deleted'] = 'Token prijevoda je uspje&scaron;no obrisan.';
...
$BL['be_admin_template_lang_token'] = 'Token / Zadani tekst';
...
// Email Templates
$BL['be_admin_mail_templates']      = '&Scaron;abloni e-po&scaron;te';
$BL['be_admin_mail_templates_desc'] = 'Upravljajte i prilagodite transakcijske e-mailove koje &scaron;alje sistem (predmet, sadr&zcaron;aj i zamjenske oznake).';
$BL['be_admin_mail_name']           = 'Naziv &scaron;ablona';
$BL['be_admin_mail_subject']        = 'Predmet';
$BL['be_admin_mail_saved']          = '&Scaron;ablon e-po&scaron;te je uspje&scaron;no sa&ccaron;uvan.';
$BL['be_admin_mail_err_save']       = 'Gre&scaron;ka pri spa&scaron;avanju &scaron;ablona u bazu podataka.';
$BL['be_admin_mail_reset_default']  = 'Vrati na zadano';
$BL['be_admin_mail_reset_done']     = '&Scaron;ablon je vra&cacute;en na zadane vrijednosti sistema.';
$BL['be_admin_mail_confirm_reset']  = 'Da li zaista &zcaron;elite vratiti &scaron;ablon „{NAME}“ na zadane vrijednosti sistema?';
...
$BL['be_admin_mail_html_note']      = 'HTML k&ocirc;d se automatski uklapa u standardni responzivni izgled e-po&scaron;te (zaglavlje sa logotipom, kontejner, podno&zcaron;je).';
$BL['be_admin_mail_text_note']      = 'Zamjenski obi&ccaron;ni tekst za e-mail klijente bez HTML podr&scaron;ke.';
$BL['be_admin_mail_active_desc']    = 'Koristi ovu prilago&dstrok;enu verziju prilikom slanja e-mailova';
$BL['be_admin_mail_test_title']     = 'Po&scaron;alji testni e-mail';
$BL['be_admin_mail_test_desc']      = 'Po&scaron;aljite pretpregled ovog e-maila sa uzorkom podataka radi provjere izgleda i formatiranja.';
$BL['be_admin_mail_send_test']      = 'Po&scaron;alji testni e-mail';
$BL['be_admin_mail_test_sent']      = 'Testni e-mail je uspje&scaron;no poslan na {EMAIL}.';
$BL['be_admin_mail_title_password_reset'] = 'Zahtjev za resetovanje lozinke';
$BL['be_admin_mail_desc_password_reset']  = '&Scaron;alje se korisnicima koji zatra&zcaron;e link za resetovanje lozinke na stranici za prijavu.';
$BL['be_admin_mail_title_new_user']       = 'Novi korisni&ccaron;ki ra&ccaron;un (Dobrodo&scaron;lica)';
$BL['be_admin_mail_desc_new_user']        = '&Scaron;alje se kada administrator kreira novi backend korisni&ccaron;ki ra&ccaron;un.';
$BL['be_admin_mail_title_edit_user']      = 'Korisni&ccaron;ki ra&ccaron;un a&zcaron;uriran';
$BL['be_admin_mail_desc_edit_user']       = '&Scaron;alje se kada administrator a&zcaron;urira korisni&ccaron;ki ra&ccaron;un i ozna&ccaron;i opciju slanja e-maila.';
$BL['be_admin_mail_title_account_deactivated'] = 'Obavje&scaron;tenje o deaktivaciji ra&ccaron;una';
...
$BL['be_admin_mail_desc_password_changed']     = '&Scaron;alje se korisniku kada je lozinka ra&ccaron;una uspje&scaron;no promijenjena ili resetovana.';
$BL['be_admin_mail_title_user_email_changed']  = 'Obavje&scaron;tenje o promjeni e-mail adrese';
$BL['be_admin_mail_desc_user_email_changed']   = '&Scaron;alje se na prethodnu e-mail adresu kada se promijeni e-mail adresa ra&ccaron;una.';
$BL['be_admin_mail_title_account_locked']      = 'Sigurnosno upozorenje (Neuspje&scaron;ni poku&scaron;aji prijave)';
$BL['be_admin_mail_desc_account_locked']       = '&Scaron;alje se korisniku kada se detektuje vi&scaron;e uzastopnih neuspje&scaron;nih poku&scaron;aja prijave.';
$BL['be_admin_mail_ph_name']        = 'Prikazano ime ili korisni&ccaron;ko ime primaoca';
$BL['be_admin_mail_ph_login']       = 'Korisni&ccaron;ko ime / prijava';
$BL['be_admin_mail_ph_new_email']   = 'Nova e-mail adresa';
$BL['be_admin_mail_ph_old_email']   = 'Prethodna e-mail adresa';
...
$BL['be_admin_mail_ph_site']        = 'Naziv hosta web stranice';
$BL['be_admin_mail_ph_site_url']    = 'Puna URL adresa web stranice';
$BL['be_admin_mail_ph_reset_link']  = 'URL za resetovanje lozinke sa sigurnosnim tokenom';
...
$BL['be_admin_mail_ph_admin_email'] = 'Kontakt e-mail administratora';
...
$BL['be_admin_mail_desc_mail_layout']  = 'Responzivni HTML raspored koji obuhvata sve transakcijske sistemske e-poruke (zaglavlje, kontejner sadržaja i podnožje).';
$BL['be_admin_mail_ph_preheader']   = 'Skriveni isječak teksta za pregled';
$BL['be_admin_mail_ph_header']      = 'Prikazano zaglavlje e-pošte (logotip ili naziv stranice)';
...
$BL['be_admin_mail_layout_html_note'] = 'Glavna struktura HTML dokumenta. Koristite <code>{CONTENT}</code> za tekst poruke, <code>{HEADER}</code> i <code>{FOOTER}</code> za brendiranje i <code>{TITLE}</code> za naslov.';
...
$BL['be_admin_mail_ph_logo']        = 'Oznaka slike logotipa ili stilizovani naziv stranice';
$BL['be_admin_mail_component_html_note'] = 'HTML označavanje za ovu komponentu. Ugrađuje se u glavni raspored putem odgovarajućeg zamjenskog znaka.';
