...
// Language: SR, Language Code: sr

$BL['usr_online']                  = 'Korisnika online';
$BL['login_text']                  = 'Unesite svoje korisničko ime i lozinku';
$BL['login_error']                 = 'Greška pri prijavljivanju!';
$BL['login_username']              = 'Korisničko ime';
$BL['login_userpass']              = 'Lozinka';
$BL['login_button']                = 'Prijava';
$BL['login_lang']                  = 'Jezik administratorskog interfejsa';
$BL['login_forgot_password']       = 'Zaboravili ste lozinku?';
$BL['login_reset_title']           = 'Resetovanje lozinke';
$BL['login_reset_desc']            = 'Unesite svoje korisničko ime ili imejl adresu. Poslaćemo vam bezbedan link za resetovanje lozinke.';
$BL['login_reset_button']          = 'Pošalji link za resetovanje';
$BL['login_reset_back']            = 'Nazad na prijavu';
$BL['login_reset_sent']            = 'Ako postoji aktivan nalog sa unetim podacima, poslat je imejl sa uputstvima.';
$BL['login_reset_invalid_token']   = 'Ovaj link je nevažeći ili je istekao. Zatražite novi.';
$BL['login_reset_set_new_title']   = 'Postavite novu lozinku';
$BL['login_reset_set_new_desc']    = 'Unesite i potvrdite novu lozinku.';
$BL['login_reset_new_password']    = 'Nova lozinka';
$BL['login_reset_repeat_password'] = 'Ponovite lozinku';
$BL['login_reset_password_mismatch'] = 'Lozinke se ne poklapaju!';
$BL['login_reset_password_empty']  = 'Lozinka ne može biti prazna!';
$BL['login_reset_success']         = 'Vaša lozinka je uspešno resetovana. Sada se možete prijaviti.';
$BL['login_reset_email_subject']   = 'Zahtev za resetovanje lozinke za {SITE}';
...
$BL['login_reset_email_greeting']  = 'Poštovani {NAME},';
$BL['login_reset_email_intro']     = 'Zaprimljen je zahtev za resetovanje lozinke za vaš administratorski nalog ({LOGIN}) na {SITE}.';
$BL['login_reset_email_note']       = 'Ovaj link važi 1 sat. Ako niste zahtevali resetovanje lozinke, možete ignorisati ovu poruku.';
$BL['login_revision_success']      = 'Baza podataka je uspešno ažurirana';
$BL['be_admin_usr_mailwelcome']     = 'Dobro došli u phpwcms administratorski deo sajta {SITE}.';
$BL['be_admin_usr_maillogin']       = 'Možete se prijaviti ovde:';
$BL['be_admin_usr_mailchanged']     = 'Podaci vašeg phpwcms administratorskog naloga su promenjeni.';
$BL['email_regards']                 = 'Srdačan pozdrav,';
$BL['email_deactivated_subject']    = 'Vaš nalog na {SITE} je deaktiviran';
$BL['email_deactivated_greeting']   = 'Poštovani korisniče,';
$BL['email_deactivated_body']       = 'Vaš nalog na {SITE} je deaktiviran.';
$BL['email_deactivated_contact']    = 'Kontaktirajte administratora ako imate bilo kakvo pitanje.';
...
$BL['be_update_check']              = 'Proveri ažuriranja';
$BL['be_update_run']                = 'Napravi sigurnosnu kopiju &amp; ažuriraj sada';
$BL['be_update_confirm']            = 'Sistem kreira sigurnosnu kopiju baze podataka, a zatim zamenjuje sopstvene datoteke. Nastaviti?';
$BL['be_update_success']            = 'Ažuriranje na %s je uspešno završeno.';
$BL['be_update_failed']             = 'Ažuriranje nije uspelo';
$BL['be_update_fetch_error']        = 'Nije moguće preuzeti informacije o ažuriranju sa GitHub-a. Najnovije izdanje možda nema zip datoteku ili API nije dostupan.';
$BL['be_update_uptodate']           = 'phpwcms je ažuran.';
$BL['be_update_history']            = 'Istorija ažuriranja';
$BL['be_update_rollback']           = 'Vrati prethodnu verziju';
$BL['be_update_rolled_back']        = 'Prethodna verzija je vraćena.';
$BL['be_update_clear_maintenance']  = 'Očisti režim održavanja';
$BL['be_update_backup_path']        = 'Sigurnosna kopija sačuvana na';
$BL['be_update_changed_files']      = 'Izmenjene datoteke';
$BL['be_update_no_history']         = 'Još nema zabeleženih ažuriranja.';
$BL['be_update_revision_pending']   = 'Migracije baze podataka su na čekanju ili nisu uspele — pokrenite ih (prijava u backend) pre ažuriranja.';
...
$BL['be_ctype_newsletter']         = 'Prijava na bilten';
...
$BL['be_profile_label_newsletter'] = 'Bilten';
...
$BL['be_ftptakeover_processing'] = 'Изабране датотеке биће преузете!';
$BL['be_ftptakeover_dberror'] = 'MySQL грешка при уметању у базу података: ';
$BL['be_ftptakeover_ok'] = 'У реду!';
$BL['be_ftptakeover_missing'] = 'Не постоји';
$BL['be_ftptakeover_done'] = 'Свака изабрана датотека је преузета!';
$BL['be_ftptakeover_error'] = 'Грешка при преузимању датотека!';
$BL['be_ftptakeover_return'] = '&Laquo; Назад';
$BL['be_ftptakeover_autoredirect'] = 'Ако нема аутоматског преусмеравања';
...
administrator
';
$BL['be_admin_usr_passnochange']   = '[Bez promene - koristiti postojeću lozinku]';
...
$BL['be_cnt_default']              = 'Podrazumevano';
...
$BL['be_subnav_msg_newslettersend'] = 'Bilten';
...
$BL['be_newsletter_shouldbe2']     = 'Podrazumevano = <b>;</b>';
$BL['be_newsletter_sample']        = 'Primjer';
$BL['be_newsletter_selectCSV']     = 'Selektuj CSV file';
$BL['be_newsletter_delimeter']     = 'Razdvojnik';
$BL['be_newsletter_importCSV']     = 'Ubaci CSV dat.';
$BL['be_newsletter_placeholder_insert'] = 'Кликните да уметнете на позицију курсора';
...
$BL['be_on']                       = 'Ukljuceno';
$BL['be_cache']                    = 'Keš';
$BL['be_cache_timeout']            = 'Vreme isteka';
$BL['be_subnav_admin_groups']      = 'Grupe korisnika';
$BL['be_admin_group_add']          = 'Dodaj grupu';
$BL['be_admin_group_err']         = 'Назив групе је празан!';
$BL['be_admin_group_added']       = 'Група је успешно додата';
...
$BL['be_cnt_field']                = array('text' => 'Tekst (jednolinijski)', 'email' => 'Email', 'textarea' => 'Tekstualno polje (višelinijsko)', 'hidden' => 'Skriveno polje', 'password' => 'Lozinka', 'select' => 'Padajući meni', 'list' => 'Lista', 'checkbox' => 'Polje za potvrdu (checkbox)', 'radio' => 'Radio dugme', 'upload' => 'Otpremanje datoteke', 'submit' => 'Dugme za slanje', 'reset' => 'Dugme za poništavanje', 'break' => 'Prelom', 'breaktext' => 'Tekst preloma', 'special' => 'Posebni tekst', 'captchaimg' => 'Captcha slika', 'captcha' => 'Captcha kod', 'newsletter' => 'Bilten (newsletter)', 'tel' => 'Telefon', 'url' => 'URL (web adresa)', 'number' => 'Broj', 'date' => 'Datum', 'time' => 'Vreme', 'color' => 'Birač boja', 'range' => 'Klizač');$BL['be_cnt_optin']                = 'Double Opt-In';
...
$BL['be_admin_usr_ifsection0']     = 'Korisnički deo';
$BL['be_admin_usr_ifsection1']     = 'Administratorski deo';
$BL['be_admin_usr_ifsection2']     = 'Korisnički i administratorski deo';
...
$BL['be_cnt_page_of_pages_descr']  = '{PREV:Nazad} stranica #/##, rezultati ###-####, {NAVI:123}, {NAVI:1-3}, {NEXT:Napred}';
...
$BL['be_fe_login_url']             = 'URL za prijavu na sajt';
...
$BL['be_admin_custom_cpt_err_reserved_field_key'] = 'Кључ поља „%s“ је резервисано стандардно име ознаке и не може се користити.';
$BL['be_admin_custom_cpt_err_reserved_field_key_simple'] = 'Резервисано стандардно име ознаке (нпр. TITLE, SUBTITLE, TEXT итд.).';
$BL['be_cnt_expand_all'] = 'Рашири све';
$BL['be_cnt_collapse_all'] = 'Скупи све';
$BL['be_cnt_texts'] = 'Текстови';

// Template translations
$BL['be_admin_template_lang'] = 'Преводи шаблона';
$BL['be_admin_template_lang_desc'] = 'Управљајте аутоматским <code>@@Текст@@</code> корисничким преводима у <code>template/template_lang</code>.';
$BL['be_admin_template_lang_saved'] = 'Преводи су успешно сачувани.';
$BL['be_admin_template_lang_deleted'] = 'Токен превода је успешно избрисан.';
$BL['be_admin_template_lang_token_added'] = 'Нови токен превода је успешно додат.';
$BL['be_admin_template_lang_empty'] = 'Нису пронађени токени превода.';
$BL['be_admin_template_lang_token'] = 'Токен / Подразумевани текст';
$BL['be_admin_template_lang_trans'] = 'Превод';
$BL['be_admin_template_lang_all'] = 'Све';
$BL['be_admin_template_lang_missing'] = 'Недостаје превод';
...
$BL['be_admin_template_lang_search'] = 'Претражи токене или преводе&#8230;';
$BL['be_admin_template_lang_items'] = 'Ставке';

// Email Templates
$BL['be_admin_mail_templates']      = 'Šabloni e-pošte';
$BL['be_admin_mail_templates_desc'] = 'Upravljajte i prilagodite transakcione e-poruke koje šalje sistem (predmet, sadržaj i zamenske oznake).';
$BL['be_admin_mail_name']           = 'Naziv šablona';
$BL['be_admin_mail_subject']        = 'Predmet';
$BL['be_admin_mail_saved']          = 'Šablon e-pošte je uspešno sačuvan.';
$BL['be_admin_mail_err_save']       = 'Greška pri čuvanju šablona u bazi podataka.';
$BL['be_admin_mail_reset_default']  = 'Vrati na podrazumevano';
$BL['be_admin_mail_reset_done']     = 'Šablon je vraćen na podrazumevane sistemske vrednosti.';
$BL['be_admin_mail_confirm_reset']  = 'Da li zaista želite da vratite šablon „{NAME}“ na podrazumevane sistemske vrednosti?';
$BL['be_admin_mail_customized']     = 'Prilagođeno';
$BL['be_admin_mail_inactive']       = 'Neaktivno';
$BL['be_admin_mail_back_to_list']   = 'Nazad na pregled';
$BL['be_admin_mail_placeholders']   = 'Dostupne zamenske oznake';
$BL['be_admin_mail_html_note']      = 'HTML kôd se automatski uklapa u standardni responzivni raspored e-pošte (zaglavlje sa logotipom, kontejner, podnožje).';
$BL['be_admin_mail_text_note']      = 'Rezervni običan tekst za klijente e-pošte bez HTML podrške.';
$BL['be_admin_mail_active_desc']    = 'Koristi ovu prilagođenu verziju prilikom slanja e-pošte';
$BL['be_admin_mail_test_title']     = 'Pošalji test poruku';
$BL['be_admin_mail_test_desc']      = 'Pošaljite pregled ove poruke sa probnim podacima radi provere izgleda i formatiranja.';
$BL['be_admin_mail_send_test']      = 'Pošalji test poruku';
$BL['be_admin_mail_test_sent']      = 'Test poruka je uspešno poslata na {EMAIL}.';
$BL['be_admin_mail_title_password_reset'] = 'Zahtev za resetovanje lozinke';
$BL['be_admin_mail_desc_password_reset']  = 'Šalje se korisnicima koji zatraže link za resetovanje lozinke na stranici za prijavu.';
$BL['be_admin_mail_title_new_user']       = 'Novi korisnički nalog (Dobrodošlica)';
$BL['be_admin_mail_desc_new_user']        = 'Šalje se kada administrator kreira novi korisnički nalog u administratorskom delu.';
$BL['be_admin_mail_title_edit_user']      = 'Korisnički nalog je ažuriran';
$BL['be_admin_mail_desc_edit_user']       = 'Šalje se kada administrator ažurira korisnički nalog i označi opciju slanja e-pošte.';
$BL['be_admin_mail_title_account_deactivated'] = 'Obaveštenje o deaktivaciji naloga';
$BL['be_admin_mail_desc_account_deactivated']  = 'Šalje se kada administrator deaktivira korisnički nalog.';
$BL['be_admin_mail_title_password_changed']    = 'Potvrda o promeni lozinke';
$BL['be_admin_mail_desc_password_changed']     = 'Šalje se korisniku kada je lozinka naloga uspešno promenjena ili resetovana.';
$BL['be_admin_mail_title_user_email_changed']  = 'Obaveštenje o promeni adrese e-pošte';
$BL['be_admin_mail_desc_user_email_changed']   = 'Šalje se na prethodnu adresu e-pošte kada se promeni adresa e-pošte naloga.';
$BL['be_admin_mail_title_account_locked']      = 'Sigurnosno upozorenje (Neuspešni pokušaji prijave)';
$BL['be_admin_mail_desc_account_locked']       = 'Šalje se korisniku kada se detektuje više uzastopnih neuspešnih pokušaja prijave.';
$BL['be_admin_mail_ph_name']        = 'Prikazano ime ili korisničko ime primaoca';
$BL['be_admin_mail_ph_login']       = 'Korisničko ime / prijava';
$BL['be_admin_mail_ph_new_email']   = 'Nova adresa e-pošte';
$BL['be_admin_mail_ph_old_email']   = 'Prethodna adresa e-pošte';
$BL['be_admin_mail_ph_ip']          = 'IP adresa pokušaja';
$BL['be_admin_mail_ph_date']        = 'Datum i vreme';
$BL['be_admin_mail_ph_password']    = 'Dodeljena lozinka';
$BL['be_admin_mail_ph_site']        = 'Ime hosta veb-sajta';
$BL['be_admin_mail_ph_site_url']    = 'Puna URL adresa veb-sajta';
$BL['be_admin_mail_ph_reset_link']  = 'URL za resetovanje lozinke sa bezbednosnim tokenom';
$BL['be_admin_mail_ph_expires']     = 'Vreme isteka (npr. 1 sat)';
$BL['be_admin_mail_ph_login_page']  = 'Direktna URL adresa stranice za prijavu';
$BL['be_admin_mail_ph_admin_email'] = 'Kontakt adresa e-pošte administratora';
$BL['be_admin_mail_ph_button']      = 'Dugme za poziv na akciju (CTA)';
$BL['be_admin_mail_ph_signature']   = 'Završni blok potpisa';
$BL['be_admin_mail_title_mail_layout'] = 'Glavni raspored e-pošte (HTML okvir)';
$BL['be_admin_mail_desc_mail_layout']  = 'Responzivni HTML raspored koji obuhvata sve transakcione e-poruke sistema (zaglavlje, kontejner sadržaja i podnožje).';
$BL['be_admin_mail_ph_preheader']   = 'Skriveni isečak teksta za pregled';
$BL['be_admin_mail_ph_header']      = 'Prikazano zaglavlje e-pošte (logotip ili naziv sajta)';
$BL['be_admin_mail_ph_title']       = 'Predmet e-pošte / glavni naslov';
$BL['be_admin_mail_ph_content']     = 'Glavni sadržaj određene e-poruke';
$BL['be_admin_mail_ph_footer']      = 'Prikazano podnožje e-pošte / impresum';
$BL['be_admin_mail_layout_html_note'] = 'Glavna struktura HTML dokumenta. Koristite <code>{CONTENT}</code> za tekst poruke, <code>{HEADER}</code> i <code>{FOOTER}</code> za standardno brendiranje i <code>{TITLE}</code> za naslov.';
$BL['be_admin_mail_title_mail_header'] = 'Komponenta zaglavlja e-pošte';
$BL['be_admin_mail_desc_mail_header']  = 'Podšablon za gornje zaglavlje e-pošte (prikazuje se putem {HEADER} u glavnom rasporedu).';
$BL['be_admin_mail_title_mail_footer'] = 'Komponenta podnožja e-pošte';
$BL['be_admin_mail_desc_mail_footer']  = 'Podšablon za donje podnožje e-pošte / impresum (prikazuje se putem {FOOTER} u glavnom rasporedu).';
$BL['be_admin_mail_ph_logo']        = 'Oznaka slike logotipa ili stilizovani naziv sajta';
$BL['be_admin_mail_component_html_note'] = 'HTML označavanje za ovu komponentu. Ugrađuje se u glavni raspored putem odgovarajuće zamenske oznake.';
$BL['be_admin_mail_template']       = 'Šablon e-pošte';
