...
$BL['be_cnt_field']                = array('text' => 'tekst (jednolinijski)', 'email' => 'email', 'textarea' => 'tekstualno polje (višelinijsko)', 'hidden' => 'skriveno polje', 'password' => 'lozinka', 'select' => 'padajući meni', 'list' => 'lista', 'checkbox' => 'polje za potvrdu (checkbox)', 'radio' => 'radio dugme', 'upload' => 'otpremanje datoteke', 'submit' => 'dugme za slanje', 'reset' => 'dugme za poništavanje', 'break' => 'prelom', 'breaktext' => 'tekst preloma', 'special' => 'posebni tekst', 'captchaimg' => 'captcha slika', 'captcha' => 'captcha kod', 'newsletter' => 'bilten (newsletter)', 'tel' => 'telefon', 'url' => 'url (web adresa)', 'number' => 'broj', 'date' => 'datum', 'time' => 'vreme', 'color' => 'birač boja', 'range' => 'klizač');
