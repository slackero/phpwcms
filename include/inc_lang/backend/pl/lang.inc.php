...
$BL['be_chat_info'] = 'Tutaj możesz porozumieć się z innymi użytkownikami swojego systemu cmsgo. To medium jest przeznaczone głównie do porozumiewania się w czasie rzeczywistym, ale możesz również zostawiać poprzez niego wiadomości dla innych.';
...
$BL['be_admin_usr_mailsubject'] = 'Witajcie w systemie zarządzania cmsgo';
$BL['be_admin_usr_mailbody'] = "WITAJ W SYSTEMIE ZARZĄDZANIA CMSGO\n\n    użytkownik: {LOGIN}\n    hasło: {PASSWORD}\n\n\nPrzez tą stronę możesz się zalogować: {SITE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_emailsubject'] = 'Dane konta - cmsgo - zostały zmienione';
$BL['be_admin_usr_emailbody'] = "KONTO UŻYTKOWNIKA W CMSGO ZOSTAŁO ZMIENIONE \n\n    Nazwa użytkownika: {LOGIN}\n    Hasło: {PASSWORD}\n\n\nPrzez tą stronę możesz się zalogować:: {SITE}\n\ncmsgo admin\n ";
...
// added: 28-03-2004
$BL['be_admin_startup_title'] = 'Domyślny tekst na stronie startowej systemu cmsgo';
...
$BL["cmsgo_code_snippets_dir_exists"] = '<strong>UWAGA!</strong> Katalog &quot;CODE-SNIPPETS&quot; nadal istnieje! Usuń katalog <strong>cmsgo_code_snippets</strong> - jest on potencjalnym problemem bezpieczeństwa.';
...
$BL['Version_up_to_date'] = 'Twoja instalacja jest aktualna,brak możliwych aktualizacji tej wersji cmsgo.';
$BL['Version_not_up_to_date'] = 'Twoja instalacja <b>nie</b> wydaje się być aktualna. Dostępne są,aktualizacje tej wersji cmsgo-a. Proszę odwiedź <a href="https://github.com/slackero/cmsgo/releases" target="_blank">GitHub Releases</a> aby poznać szczegóły.';
$BL['Latest_version_info'] = 'Ostatnia dostępna wersja to <b>cmsgo %s</b>.';
$BL['Current_version_info'] = 'Twój bieżący <b>cmsgo %s</b>.';
$BL['Connect_socket_error'] = 'Nie można otworzyć połączenia z serwerem cmsgo , zgłaszany jest błąd:<br />%s';
$BL['Socket_functions_disabled'] = 'Niemożliwe jest użycie funkcji socket';
$BL['Mailing_list_subscribe_reminder'] = 'Aby otrzymywać informacje o aktualizacjach do Twojego cmsgo,prenumeruj <a href="http://eepurl.com/bm-BrH" target="_blank">listę mailingową</a>.';
$BL['Version_information'] = 'Informacja o wersji cmsgo';
...
$BL['be_aboutlink_title'] = 'Informacja o cmsgo i licencji';
...
$BL['be_cnt_pages_php_render_warning'] = 'osadzony kod PHP <code>$cmsgo[&#39;enable_inline_php&#39;]</code> jest wyłączony';
...
$BL['be_cookie_consent_translatable'] = 'Ta instalacja ma włączoną obsługę wielu języków (&#36;cmsgo[&#39;allowed_lang&#39;]). W przypadku przetłumaczonych tekstów zgody na pliki cookie użyj składni <b>@@Tekst@@</b> i sprawdź „template/template_lang” po wyrenderowaniu.';
...
$BL['be_about_headline'] = 'System zarządzania treścią cmsGO!';
...
$BL['be_about_and_contributors'] = 'oraz inni współtwórcy (w tym Marcus Obst, Fernando Batista, KoMa, geckse, phalancs, q23 i inni) &ndash; zobacz <a href="https://github.com/systron-dev/cmsgo" title="Kod źródłowy w serwisie GitHub" target="_blank">kod źródłowy</a>, aby uzyskać szczegółowe informacje o prawach autorskich i licencjach.';
