...
$BL['be_update_version_unsupported'] = 'Automatyczna aktualizacja jest obsługiwana tylko dla phpwcms w wersji > 2.0.0.';
...
$BL['be_admin_group_err']         = 'Nazwa grupy jest pusta!';
$BL['be_admin_group_added']       = 'Grupa została dodana';
...
$BL['be_admin_optgroup_label']     = array(1 => 'Tekst', 2 => 'Obraz', 3 => 'Formularz', 4 => 'Admin', 5 => 'Specjalny');$BL['be_cnt_articlemenu_maxchar']  = 'Max. znak&oacute;w';
...
$BL['be_cc_v3_section_marketing']  = 'Marketingowe';
...
$BL['be_admin_custom_cpt_preset']  = 'Ustawienie wstępne';
$BL['be_admin_custom_cpt_legacy']  = 'Przestarzałe (Legacy)';
...
// Email Templates
$BL['be_admin_mail_templates'] = 'Szablony e-mail';
$BL['be_admin_mail_templates_desc'] = 'Zarządzaj i dostosowuj wiadomości e-mail wysyłane przez system (temat, treść i znaczniki).';
$BL['be_admin_mail_name'] = 'Nazwa szablonu';
$BL['be_admin_mail_subject'] = 'Temat';
$BL['be_admin_mail_saved'] = 'Szablon e-mail został pomyślnie zapisany.';
$BL['be_admin_mail_err_save'] = 'Błąd podczas zapisywania szablonu w bazie danych.';
$BL['be_admin_mail_reset_default'] = 'Przywróć domyślne';
$BL['be_admin_mail_reset_done'] = 'Szablon został przywrócony do ustawień domyślnych systemu.';
$BL['be_admin_mail_confirm_reset'] = 'Czy na pewno chcesz przywrócić szablon „{NAME}” do ustawień domyślnych?';
$BL['be_admin_mail_customized'] = 'Dostosowany';
$BL['be_admin_mail_inactive'] = 'Nieaktywny';
$BL['be_admin_mail_back_to_list'] = 'Powrót do przeglądu';
$BL['be_admin_mail_placeholders'] = 'Dostępne znaczniki';
$BL['be_admin_mail_html_note'] = 'Treść HTML jest automatycznie osadzana w standardowym responsywnym układzie wiadomości (logo nagłówka, kontener, stopka).';
$BL['be_admin_mail_text_note'] = 'Zwykły tekst dla klientów poczty bez obsługi HTML.';
$BL['be_admin_mail_active_desc'] = 'Użyj tej dostosowanej wersji podczas wysyłania wiadomości e-mail';
$BL['be_admin_mail_test_title'] = 'Wyślij testowy e-mail';
$BL['be_admin_mail_test_desc'] = 'Wyślij podgląd tej wiadomości e-mail z przykładowymi danymi, aby sprawdzić wygląd i formatowanie.';
$BL['be_admin_mail_send_test'] = 'Wyślij testowy e-mail';
$BL['be_admin_mail_test_sent'] = 'Testowy e-mail został pomyślnie wysłany na adres {EMAIL}.';
$BL['be_admin_mail_title_password_reset'] = 'Prośba o zresetowanie hasła';
$BL['be_admin_mail_desc_password_reset'] = 'Wysyłane do użytkowników żądających linku resetowania hasła na stronie logowania.';
$BL['be_admin_mail_title_new_user'] = 'Nowe konto użytkownika (Powitanie)';
$BL['be_admin_mail_desc_new_user'] = 'Wysyłane po utworzeniu nowego konta użytkownika w panelu administracyjnym.';
$BL['be_admin_mail_title_edit_user'] = 'Konto użytkownika zaktualizowane';
$BL['be_admin_mail_desc_edit_user'] = 'Wysyłane, gdy administrator aktualizuje konto użytkownika i zaznaczy opcję wysłania e-maila.';
$BL['be_admin_mail_title_account_deactivated'] = 'Powiadomienie o dezaktywacji konta';
$BL['be_admin_mail_desc_account_deactivated'] = 'Wysyłane, gdy administrator dezaktywuje konto użytkownika.';
$BL['be_admin_mail_title_password_changed'] = 'Potwierdzenie zmiany hasła';
$BL['be_admin_mail_desc_password_changed'] = 'Wysyłane do użytkownika po pomyślnej zmianie lub zresetowaniu hasła do konta.';
$BL['be_admin_mail_title_user_email_changed'] = 'Powiadomienie o zmianie adresu e-mail';
$BL['be_admin_mail_desc_user_email_changed'] = 'Wysyłane na poprzedni adres e-mail, gdy adres e-mail konta zostanie zmieniony.';
$BL['be_admin_mail_title_account_locked'] = 'Ostrzeżenie o bezpieczeństwie (Nieudane próby logowania)';
$BL['be_admin_mail_desc_account_locked'] = 'Wysyłane do użytkownika po wykryciu wielokrotnych nieudanych prób logowania.';
$BL['be_admin_mail_ph_name'] = 'Imię lub nazwa użytkownika odbiorcy';
$BL['be_admin_mail_ph_login'] = 'Nazwa użytkownika / Login';
$BL['be_admin_mail_ph_new_email'] = 'Nowy adres e-mail';
$BL['be_admin_mail_ph_old_email'] = 'Poprzedni adres e-mail';
$BL['be_admin_mail_ph_ip'] = 'Adres IP próby logowania';
$BL['be_admin_mail_ph_date'] = 'Data i godzina';
$BL['be_admin_mail_ph_password'] = 'Przypisane hasło';
$BL['be_admin_mail_ph_site'] = 'Nazwa hosta witryny';
$BL['be_admin_mail_ph_site_url'] = 'Pełny adres URL witryny';
$BL['be_admin_mail_ph_reset_link'] = 'Link resetowania hasła z tokenem bezpieczeństwa';
$BL['be_admin_mail_ph_expires'] = 'Czas wygaśnięcia (np. 1 godzina)';
$BL['be_admin_mail_ph_login_page'] = 'Bezpośredni adres URL do strony logowania';
$BL['be_admin_mail_ph_admin_email'] = 'Adres e-mail kontaktowy administratora';
$BL['be_admin_mail_ph_button'] = 'Przycisk akcji (CTA)';
$BL['be_admin_mail_ph_signature'] = 'Końcowy blok podpisu';
$BL['be_admin_mail_title_mail_layout'] = 'Główny szablon e-mail (szkielet HTML)';
$BL['be_admin_mail_desc_mail_layout']  = 'Responsywny układ HTML obejmujący wszystkie transakcyjne wiadomości e-mail systemu (nagłówek, kontener treści i stopkę).';
$BL['be_admin_mail_ph_preheader']   = 'Ukryty fragment tekstu podglądu';
$BL['be_admin_mail_ph_header']      = 'Wygenerowany nagłówek wiadomości (logo lub nazwa witryny)';
$BL['be_admin_mail_ph_title']       = 'Temat wiadomości e-mail / nagłówek';
$BL['be_admin_mail_ph_content']     = 'Główna treść konkretnej wiadomości e-mail';
$BL['be_admin_mail_ph_footer']      = 'Wygenerowana stopka wiadomości e-mail / nota prawna';
$BL['be_admin_mail_layout_html_note'] = 'Główna struktura dokumentu HTML. Użyj <code>{CONTENT}</code> dla treści wiadomości, <code>{HEADER}</code> i <code>{FOOTER}</code> dla elementów marki oraz <code>{TITLE}</code> dla nagłówka.';
$BL['be_admin_mail_title_mail_header'] = 'Komponent nagłówka e-mail';
$BL['be_admin_mail_desc_mail_header']  = 'Podszablon górnego nagłówka wiadomości e-mail (renderowany przez {HEADER} w szablonie głównym).';
$BL['be_admin_mail_title_mail_footer'] = 'Komponent stopki e-mail';
$BL['be_admin_mail_desc_mail_footer']  = 'Podszablon dolnej stopki wiadomości / noty prawnej (renderowany przez {FOOTER} w szablonie głównym).';
$BL['be_admin_mail_ph_logo']        = 'Znacznik obrazu logo lub stylizowana nazwa witryny';
$BL['be_admin_mail_component_html_note'] = 'Kod HTML dla tego komponentu. Jest osadzany w szablonie głównym za pośrednictwem odpowiedniego znacznika.';
$BL['be_admin_mail_template']       = 'Szablon e-mail';
