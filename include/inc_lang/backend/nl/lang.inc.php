...
$BL['login_reset_email_intro'] = 'Er is een verzoek ontvangen om het wachtwoord van uw backend-gebruikersaccount ({LOGIN}) op {SITE} opnieuw in te stellen.';
$BL['login_reset_email_note'] = 'Deze link is 1 uur geldig. Als u dit verzoek niet heeft gedaan, kunt u dit bericht gerust negeren.';
$BL['login_revision_success'] = 'Database succesvol bijgewerkt';
$BL['be_admin_usr_mailwelcome'] = 'Welkom bij het phpwcms-backend van {SITE}.';
$BL['be_admin_usr_maillogin'] = 'U kunt hier inloggen:';
$BL['be_admin_usr_mailchanged'] = 'Uw phpwcms-backendaccountgegevens zijn gewijzigd.';
$BL['email_regards'] = 'Met vriendelijke groet,';
$BL['email_deactivated_subject'] = 'Uw account op {SITE} is gedeactiveerd';
$BL['email_deactivated_greeting'] = 'Beste gebruiker,';
$BL['email_deactivated_body'] = 'Uw account op {SITE} is gedeactiveerd.';
$BL['email_deactivated_contact'] = 'Neem contact op met de administrator als u vragen heeft.';
...
// Self-update
$BL['be_subnav_admin_update']       = 'Systeemupdate';
$BL['be_update_current']            = 'Geïnstalleerde versie';
$BL['be_update_available']          = 'Beschikbare versie';
$BL['be_update_check']              = 'Controleren op updates';
$BL['be_update_run']                = 'Back-up maken &amp; nu bijwerken';
$BL['be_update_confirm']            = 'Het systeem maakt een back-up van de database en vervangt daarna zijn eigen bestanden. Doorgaan?';
$BL['be_update_success']            = 'Update naar %s is succesvol voltooid.';
$BL['be_update_failed']             = 'Update mislukt';
$BL['be_update_fetch_error']        = 'Kan update-informatie niet ophalen van GitHub. De nieuwste release heeft mogelijk geen zip-bestand of de API is niet bereikbaar.';
$BL['be_update_uptodate']           = 'phpwcms is up-to-date.';
$BL['be_update_history']            = 'Updategeschiedenis';
$BL['be_update_rollback']           = 'Vorige versie herstellen';
$BL['be_update_rolled_back']        = 'Vorige versie is hersteld.';
$BL['be_update_clear_maintenance']  = 'Onderhoudsmodus wissen';
...
$BL['be_update_version_unsupported'] = 'Automatische update wordt alleen ondersteund voor phpwcms versie > 2.0.0.';
...
$BL['be_admin_group_err']         = 'Groepsnaam is leeg!';
$BL['be_admin_group_added']       = 'Groep succesvol toegevoegd';
...
$BL['be_admin_keywords']           = 'Trefwoorden';
...
$BL['be_admin_optgroup_label']     = array(1 => 'Tekst', 2 => 'Plaatje', 3 => 'Formulier', 4 => 'Admin', 5 => 'Speciaal');$BL['be_cnt_articlemenu_maxchar']  = 'Max. aantal karakters';
...
$BL['be_cnt_plugin_n.a.']          = 'Plugin niet beschikbaar';
...
$BL['be_fe_login_url']             = 'Frontend-inlog-URL';
...
$BL['be_flashplayer_thumbnail']    = 'Miniatuur';
...
$BL['be_cc_v3_section_social_title_placeholder'] = 'Cookies voor sociale media';
...
$BL['be_dashboard_support']        = 'Contact &amp; ondersteuning';
$BL['be_legacy']                   = 'Legacy';
...
// Email Templates
$BL['be_admin_mail_templates'] = 'E-mailsjablonen';
$BL['be_admin_mail_templates_desc'] = 'Beheer en pas transactionele e-mails aan die door het systeem worden verzonden (onderwerp, inhoud en plaatshouders).';
$BL['be_admin_mail_name'] = 'Sjabloonnaam';
$BL['be_admin_mail_subject'] = 'Onderwerp';
$BL['be_admin_mail_saved'] = 'E-mailsjabloon succesvol opgeslagen.';
$BL['be_admin_mail_err_save'] = 'Fout bij het opslaan van sjabloon in de database.';
$BL['be_admin_mail_reset_default'] = 'Herstellen naar standaardwaarde';
$BL['be_admin_mail_reset_done'] = 'Sjabloon hersteld naar systeemstandaard.';
$BL['be_admin_mail_confirm_reset'] = 'Wilt u het sjabloon “{NAME}” echt herstellen naar de systeemstandaard?';
$BL['be_admin_mail_customized'] = 'Aangepast';
$BL['be_admin_mail_inactive'] = 'Inactief';
$BL['be_admin_mail_back_to_list'] = 'Terug naar overzicht';
$BL['be_admin_mail_placeholders'] = 'Beschikbare plaatshouders';
$BL['be_admin_mail_html_note'] = 'De HTML-inhoud wordt automatisch ingebed in de standaard responsieve e-mailopmaak (header-logo, container, footer).';
$BL['be_admin_mail_text_note'] = 'Platte tekst als alternatief voor e-mailprogramma’s zonder HTML-ondersteuning.';
$BL['be_admin_mail_active_desc'] = 'Deze aangepaste versie gebruiken bij het verzenden van e-mails';
$BL['be_admin_mail_test_title'] = 'Test-e-mail verzenden';
$BL['be_admin_mail_test_desc'] = 'Verzend een voorbeeldweergave van deze e-mail met voorbeeldgegevens om het uiterlijk en de formattering te controleren.';
$BL['be_admin_mail_send_test'] = 'Test-e-mail verzenden';
$BL['be_admin_mail_test_sent'] = 'Test-e-mail succesvol verzonden naar {EMAIL}.';
$BL['be_admin_mail_title_password_reset'] = 'Wachtwoord opnieuw instellen';
$BL['be_admin_mail_desc_password_reset'] = 'Verzonden naar gebruikers die een link voor wachtwoordherstel aanvragen op de inlogpagina.';
$BL['be_admin_mail_title_new_user'] = 'Nieuw gebruikersaccount (Welkom)';
$BL['be_admin_mail_desc_new_user'] = 'Verzonden wanneer een beheerder een nieuw gebruikersaccount aanmaakt in het beheerpaneel.';
$BL['be_admin_mail_title_edit_user'] = 'Gebruikersaccount bijgewerkt';
$BL['be_admin_mail_desc_edit_user'] = 'Verzonden wanneer een beheerder een account bijwerkt en de e-mailoptie inschakelt.';
$BL['be_admin_mail_title_account_deactivated'] = 'Melding accountdeactivering';
$BL['be_admin_mail_desc_account_deactivated'] = 'Verzonden wanneer een beheerder een gebruikersaccount deactiveert.';
$BL['be_admin_mail_title_password_changed'] = 'Wachtwoordwijziging bevestigd';
$BL['be_admin_mail_desc_password_changed'] = 'Verzonden naar de gebruiker wanneer het accountwachtwoord succesvol is gewijzigd of hersteld.';
$BL['be_admin_mail_title_user_email_changed'] = 'Melding e-mailadreswijziging';
$BL['be_admin_mail_desc_user_email_changed'] = 'Verzonden naar het vorige e-mailadres wanneer het e-mailadres van het account wordt gewijzigd.';
$BL['be_admin_mail_title_account_locked'] = 'Beveiligingswaarschuwing (Mislukte inlogpogingen)';
$BL['be_admin_mail_desc_account_locked'] = 'Verzonden naar de gebruiker wanneer herhaalde mislukte inlogpogingen zijn gedetecteerd.';
$BL['be_admin_mail_ph_name'] = 'Naam of gebruikersnaam van de ontvanger';
$BL['be_admin_mail_ph_login'] = 'Gebruikersnaam / Inlog';
$BL['be_admin_mail_ph_new_email'] = 'Nieuw e-mailadres';
$BL['be_admin_mail_ph_old_email'] = 'Vorig e-mailadres';
$BL['be_admin_mail_ph_ip'] = 'IP-adres van de poging';
$BL['be_admin_mail_ph_date'] = 'Datum en tijd';
$BL['be_admin_mail_ph_password'] = 'Toegewezen wachtwoord';
$BL['be_admin_mail_ph_site'] = 'Hostnaam van website';
$BL['be_admin_mail_ph_site_url'] = 'Volledige website-URL';
$BL['be_admin_mail_ph_reset_link'] = 'URL voor wachtwoordherstel met beveiligingstoken';
$BL['be_admin_mail_ph_expires'] = 'Geldigheidsduur (bijv. 1 uur)';
$BL['be_admin_mail_ph_login_page'] = 'Directe URL naar de inlogpagina';
$BL['be_admin_mail_ph_admin_email'] = 'Contact-e-mailadres beheerder';
$BL['be_admin_mail_ph_button'] = 'Actieknop (CTA)';
$BL['be_admin_mail_ph_signature'] = 'Afsluitende handtekening';
$BL['be_admin_mail_title_mail_layout'] = 'Hoofd-e-maillayout (HTML-kader)';
$BL['be_admin_mail_desc_mail_layout']  = 'De responsieve HTML-layout die alle transactionele systeem-e-mails omvat (koptekst, inhoudscontainer en voettekst).';
$BL['be_admin_mail_ph_preheader']   = 'Verborgen voorbeeldtekstfragment';
$BL['be_admin_mail_ph_header']      = 'Gerenderde e-mailkoptekst (logo of websitenaam)';
$BL['be_admin_mail_ph_title']       = 'E-mailonderwerp / hoofdtitel';
$BL['be_admin_mail_ph_content']     = 'Hoofdinhoud van de specifieke e-mail';
$BL['be_admin_mail_ph_footer']      = 'Gerenderde e-mailvoettekst / colofon';
$BL['be_admin_mail_layout_html_note'] = 'De hoofdstructuur van het HTML-document. Gebruik <code>{CONTENT}</code> voor het e-mailbericht, <code>{HEADER}</code> en <code>{FOOTER}</code> voor standaard huisstijl en <code>{TITLE}</code> voor de titel.';
$BL['be_admin_mail_title_mail_header'] = 'E-mailkoptekst-component';
$BL['be_admin_mail_desc_mail_header']  = 'Deelsjabloon voor de bovenste e-mailkoptekst (gerenderd via {HEADER} in de hoofdlayout).';
$BL['be_admin_mail_title_mail_footer'] = 'E-mailvoettekst-component';
$BL['be_admin_mail_desc_mail_footer']  = 'Deelsjabloon voor de onderste e-mailvoettekst / colofon (gerenderd via {FOOTER} in de hoofdlayout).';
$BL['be_admin_mail_ph_logo']        = 'Logo-afbeeldingstag of gestileerde websitenaam';
$BL['be_admin_mail_component_html_note'] = 'HTML-opmaak voor deze component. Deze wordt via de bijbehorende plaatshouder in de hoofdlayout ingebed.';
$BL['be_admin_mail_template']       = 'E-mailsjabloon';
