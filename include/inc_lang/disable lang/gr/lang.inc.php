...
$BL['be_page_title']                    = 'cmsgo διαχείριση';
...
$BL['be_profile_text_newsletter']       = 'Επιθυμώ να λαμβάνω γενικά ενημερωτικά δελτία του cmsgo.';
...
$BL['be_chat_info']                     = 'Εδώ μπορείτε να συζητήσετε με άλλους χρήστες cmsgo για οτιδήποτε θέλετε. Αυτό το μέσο είναι για συζήτηση σε πραγματικό χρόνο αλλά μπορείτε επίσης να αφήσετε ένα μήνυμα που μπορούν να το διαβάσουν όλοι. Εαν θέλετε να ανταλλάξετε ιδέες με άλλους παρακαλείσθε να χρησιμοποιήστε τη συζήτηση (σε επόμενες εκδόσεις cmsgo).';
...
$BL['be_admin_usr_mailsubject']         = 'καλωσήρθατε στο cmsgo';
$BL['be_admin_usr_mailbody']            = "ΚΑΛΩΣΗΡΘΑΤΕ ΣΤΟ CMSGO\n\n    ταυτότητα χρήστη: {LOGIN}\n    κωδικός πρόσβασης: {PASSWORD}\n\n\nΜπορείτε να συνδεθείτε εδώ: {LOGIN_PAGE}\n\nδιαχειριστής cmsgo\n ";
...
$BL['be_admin_usr_emailsubject']        = 'cmsgo - στοιχεία λογαριασμού άλλαξαν';
$BL['be_admin_usr_emailbody']           = "CMSGO ΠΛΗΡΟΦΟΡΙΕΣ ΛΟΓΑΡΙΑΣΜΟΥ ΧΡΗΣΤΗ ΑΛΛΑΞΑΝ\n\n    όνομα χρήστη: {LOGIN}\n    κωδικός: {PASSWORD}\n\n\nΜπορείτε να συνδεθείτε εδώ: {LOGIN_PAGE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_ltitle']              = 'λίστα χρηστών cmsgo';
