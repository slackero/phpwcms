...
$BL['be_page_title']                    = 'cmsgo backend (administrare)';
...
$BL['be_admin_usr_mailsubject']         = 'Bine ai venit la cmsgo "backend"';
$BL['be_admin_usr_mailbody']            = "Bine ai venit la cmsgo BACKEND\n\n    utilizator: {LOGIN}\n    parola: {PASSWORD}\n\n\nTe poti loga aici: {LOGIN_PAGE}\n\nwdmedia admin\n ";
