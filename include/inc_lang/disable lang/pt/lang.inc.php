...
$BL['be_page_title']                    = 'cmsgo backend (administração)';
...
$BL['be_profile_text_newsletter']       = 'Eu quero receber o boletim de notícias geral de cmsgo.';
...
$BL['be_admin_usr_mailsubject']         = 'bem vindo ao cmsgo backend';
$BL['be_admin_usr_mailbody']            = "BEM VINDO AO BACKEND DO CMSGO\n\n    utilizador: {LOGIN}\n    senha: {PASSWORD}\n\n\nVoçê pode ligar-se em: {LOGIN_PAGE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_emailsubject']        = 'cmsgo - dados da conta alterados';
$BL['be_admin_usr_emailbody']           = "CMSGO DADOS DA CONTA ALTERADOS\n\n    utilizador: {LOGIN}\n    senha: {PASSWORD}\n\n\nVoçê pode ligar-se aqui: {LOGIN_PAGE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_ltitle']              = 'cmsgo lista de utilizadores';
