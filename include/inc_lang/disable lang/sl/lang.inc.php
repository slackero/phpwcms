...
$BL['be_page_title']                    = 'cmsgo administracija';
...
$BL['be_profile_text_newsletter']       = 'Želim prejemati splošne cmsgo novice.';
...
$BL['be_chat_info']                     = 'Tukaj lahko klepetate z ostalimi cmsgo uporabniki o čemerkoli. ';
...
$BL['be_admin_usr_mailsubject']         = 'dobrodošli v uredniški sistem cmsgo';
$BL['be_admin_usr_mailbody']            = "DOBRODOŠLI V UREDNIŠKI SISTEM CMSGO\n\n    uporabniško ime: {LOGIN}\n    geslo: {PASSWORD}\n\n\nPrijavite se lahko tukaj: {LOGIN_PAGE}\n\nadministrator sistema cmsgo\n ";
...
$BL['be_admin_usr_emailsubject']        = 'cmsgo - uporabniški račun spremenjen';
$BL['be_admin_usr_emailbody']           = "CMSGO UPORABNIŠKI RAČUN SPREMENJEN\n\n    uporabniško ime: {LOGIN}\n    geslo: {PASSWORD}\n\n\nPrijavite se lahko tukaj: {LOGIN_PAGE}\n\nadministrator sistema cmsgo\n ";
...
$BL["cmsgo_code_snippets_dir_exists"] = '<strong>POZOR!</strong> Direktorij &quot;CODE-SNIPPETS&quot; še vedno obstaja! Izbrišite direktorij <strong>cmsgo_code_snippets</strong> - lahko predstavlja varnostno težavo.';
...
$BL['Version_up_to_date']               = 'Nameščeno imate zadnjo verzijo cmsgo-ja. Na voljo ni nobene posodobitve.';
$BL['Version_not_up_to_date']           = 'Vaša namestitev <strong>ni</strong> posodobljena. Na voljo so posodobitve - obiščite <a href="https://github.com/slackero/cmsgo/releases" target="_blank">GitHub Releases</a>.';
$BL['Latest_version_info']              = 'Zadnja verzija je: <b>cmsgo %s</b>.';
$BL['Current_version_info']             = 'Nameščeno imate: <b>cmsgo %s</b>.';
$BL['Connect_socket_error']             = 'Ne morem odpreti povezave do cmsgo strežnika - napaka:<br />%s';
$BL['Socket_functions_disabled']        = 'Ne morem uporaviti "socket" funkcije.';
$BL['Mailing_list_subscribe_reminder']  = 'Za prejemanje informacij o zadnjih verzijah cmsgo-ja se lahko prijavite <a href="http://eepurl.com/bm-BrH" target="_blank">tukaj</a>.';
$BL['Version_information']              = 'informacije o verziji cmsgo-ja';
...
$BL['be_aboutlink_title']               = 'informacije o cmsgo-ju in licenca';
