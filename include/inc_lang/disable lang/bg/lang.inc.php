...
$BL['be_page_title']                    = 'cmsgo backend (администрация)';
...
$BL['be_profile_text_newsletter']       = 'Искам да получавам общият бюлетин на cmsgo.';
...
$BL['be_admin_usr_mailsubject']         = 'Добре дошли в cmsgo backend';
$BL['be_admin_usr_mailbody']            = "ДОБРЕ ДОШЛИ CMSGO BACKEND\n\n    потребителско име: {LOGIN}\n    парола: {PASSWORD}\n\n\nможе да влезето тука: {LOGIN_PAGE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_emailsubject']        = 'cmsgo - данните за потребитеят са променени';
...
$BL['be_admin_usr_ltitle']              = 'cmsgo списък с потребители';
