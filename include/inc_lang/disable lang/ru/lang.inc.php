...
$BL['be_page_title']                    = 'cmsgo администрирование';
...
$BL['be_profile_text_newsletter']       = 'Я хочу получать общую рассылку cmsgo.';
...
$BL['be_chat_info']                     = 'Здесь вы можете общаться с другими cmsgo пользователями о чем захотите. Эта услуга предусматривает общение в реальном времени но вы можете также оставить сообщение которое все прочитают. Если вы хотите обменяться мнениями с другими воспользуйтесь услугой дискуссия.';
...
$BL['be_admin_usr_emailsubject']        = 'cmsgo - данные пользователя изменены';
$BL['be_admin_usr_emailbody']           = "CMSGO ДАННЫЕ ПОЛЬЗОВАТЕЛЯ БЫЛИ ИЗМЕНЕНЫ\n\n    пользователь: {LOGIN}\n    пароль: {PASSWORD}\n\n\nВы можете зайти здесь: {LOGIN_PAGE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_ltitle']              = 'cmsgo список пользователей';
