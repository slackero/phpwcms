...
$BL['be_page_title']                    = 'cmsgo back-end kasutajaliides (administreerimine)';
...
$BL['be_ftptakeover_nofile']            = 'pole ühtegi kättesaadavat faili &#8211; laadi fail kõigepealt ftp kaudu "cmsgo_ftp" kataloogi';
...
$BL['be_admin_usr_mailsubject']         = 'tere tulemast cmsgo back-end kasutajaliidesesse';
$BL['be_admin_usr_mailbody']            = "TERE TULEMAST CMSGO BACK-END KASUTAJALIIDESESSE\n\n    kasutajatunnus: {LOGIN}\n    parool: {PASSWORD}\n\n\nLogi sisse: {LOGIN_PAGE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_emailsubject']        = 'cmsgo - kontoandmed on muudetud';
$BL['be_admin_usr_emailbody']           = "CMSGO KASUTAJAKONTO ANDMED ON MUUDETUD\n\n    kasutajatunnus: {LOGIN}\n    parool: {PASSWORD}\n\n\nLogi sisse: {LOGIN_PAGE}\n\ncmsgo admin\n ";
...
$BL['be_admin_usr_ltitle']              = 'cmsgo back-end kasutajate haldus';
...
// added: 08-07-2004
$BL["setup_dir_exists"]                 = '<div style="font-size: 14px;">TÄHELEPANU!</div>SETUP&quot; kataloog on kustutamata!<br>Kui oled cmsgo-i edukalt seadistanud, siis kustuta see kataloog. Jättes kataloogi kustutamata ning vaikimisi kasutajanime ja parooli, jätad ka võimaluse oma server üle võtta.';
