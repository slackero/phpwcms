<?php
// enhancement for phpwcms usage
//$spaw_include_path = str_replace('/include/inc_ext/spaw2/config', '', str_replace('\\', '/', dirname(__FILE__)));
//require_once ($spaw_include_path.'/config/phpwcms/conf.inc.php');
//require_once ($spaw_include_path.'/include/inc_lib/default.inc.php');

require_once (str_replace('\\','/',realpath(dirname(__FILE__)).'/../../../../config/phpwcms/conf.inc.php'));
require_once (str_replace('\\','/',realpath(dirname(__FILE__)).'/../../../../include/inc_lib/default.inc.php'));

if(!function_exists('aporeplace')) {
...
require_once(PHPWCMS_ROOT.'/include/inc_ext/spaw2/class/config.class.php');
require_once(PHPWCMS_ROOT.'/include/inc_ext/spaw2/class/util.class.php');
...
SpawConfig::setStaticConfigItem('DOCUMENT_ROOT', PHPWCMS_ROOT.'/');
/*
...
SpawConfig::setStaticConfigItem('SPAW_ROOT', PHPWCMS_ROOT.'/include/inc_ext/spaw2/');
// sets virtual path to the spaw directory on the server
// if calculation fails set this manually
SpawConfig::setStaticConfigItem('SPAW_DIR', PHPWCMS_BASEPATH.'include/inc_ext/spaw2/');
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    ...
    array(
      ...
      'fsdir'   => SpawConfig::getStaticConfigValue('SPAW_ROOT').'spaw/uploads/files/', // optional absolute physical filesystem path
      'caption' => 'Files', 
      'params'  => array(
