...
<tr>
  <td align="right" nowrap="nowrap"><?php echo $lang->m('alt')?>:</td>
  <td colspan="3"><input type="text" name="calt" id="calt" class="input" size="32" /></td>
</tr>
<tr>
  <td align="right" nowrap="nowrap"><?php echo $lang->m('title_attr')?>:</td>
  <td colspan="3"><input type="text" name="ctitle" id="ctitle" class="input" size="32" /></td>
</tr>
<tr>
  <td align="right" nowrap="nowrap"><?php echo $lang->m('width')?>:</td>
...
<tr>
  <td align="right" nowrap="nowrap"><?php echo $lang->m('border')?>:</td>
  <td align="left"><input type="text" name="cborder" id="cborder" class="input3chars" /></td>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
</tr>
<tr>
  <td align="right" nowrap="nowrap"><?php echo $lang->m('hspace')?>:</td>
...
<tr>
<td nowrap="nowrap"><hr width="100%" /></td>
</tr>
<tr>
