  ...
  <div class="groupbox">
    ...
    <table border="0" cellpadding="2" cellspacing="0">
      <tr>
        ...
        <td align="left" valign="middle"><input type="text" name="iHue" id="iHue" class="input3chars" maxlength="3" onkeyup="SpawColorPicker.inputKeyUp(event, 'h', this);" onchange="SpawColorPicker.setCurrentColor(SpawColorPicker.getCurrentColor());" /></td>
      </tr>
      <tr>
        <td align="left" valign="middle">S:</td>
        <td align="left" valign="middle"><input type="text" name="iSaturation" id="iSaturation" class="input3chars" maxlength="3" onkeyup="SpawColorPicker.inputKeyUp(event, 's', this);" onchange="SpawColorPicker.setCurrentColor(SpawColorPicker.getCurrentColor());" /></td>
      </tr>
      <tr>
        <td align="left" valign="middle">B:</td>
        <td align="left" valign="middle"><input type="text" name="iBrightness" id="iBrightness" class="input3chars" maxlength="3" onkeyup="SpawColorPicker.inputKeyUp(event, 'v', this);" onchange="SpawColorPicker.setCurrentColor(SpawColorPicker.getCurrentColor());" /></td>
      </tr>
    </table>
    </div>
    </fieldset>
    ...
    <table border="0" cellpadding="2" cellspacing="0">
      <tr>
        ...
        <td align="left" valign="middle"><input type="text" name="iRed" id="iRed" class="input3chars" maxlength="3" onkeyup="SpawColorPicker.inputKeyUp(event, 'r', this);" onchange="SpawColorPicker.setCurrentColor(SpawColorPicker.getCurrentColor());" /></td>
      </tr>
      <tr>
        <td align="left" valign="middle">G:</td>
        <td align="left" valign="middle"><input type="text" name="iGreen" id="iGreen" class="input3chars" maxlength="3" onkeyup="SpawColorPicker.inputKeyUp(event, 'g', this);" onchange="SpawColorPicker.setCurrentColor(SpawColorPicker.getCurrentColor());" /></td>
      </tr>
      <tr>
        <td align="left" valign="middle">B:</td>
        <td align="left" valign="middle"><input type="text" name="iBlue" id="iBlue" class="input3chars" maxlength="3" onkeyup="SpawColorPicker.inputKeyUp(event, 'b', this);" onchange="SpawColorPicker.setCurrentColor(SpawColorPicker.getCurrentColor());" /></td>
      </tr>
    </table>
    </div>
    </fieldset>
    ...
    <table border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td align="left" valign="middle"><input type="text" name="iHex" id="iHex" class="input7chars" onkeyup="SpawColorPicker.inputKeyUp(event, 'x', this);" onchange="SpawColorPicker.setCurrentColor(SpawColorPicker.getCurrentColor());" /></td>
      </tr>
    </table>
    </fieldset>
...
<div class="buttonbox">
  <input type="submit" class="bt" value="<?php echo $lang->m('ok', 'colorpicker', 'core') ?>" onclick="SpawColorPicker.okClick();" />&nbsp;
  <input type="button" class="bt" value="<?php echo $lang->m('cancel', 'colorpicker', 'core') ?>" onclick="SpawColorPicker.cancelClick();" />
</div>
</form>