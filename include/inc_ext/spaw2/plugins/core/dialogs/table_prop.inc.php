...
<form name="table_prop" id="table_prop" onsubmit="return false;" style="padding:0;margin:0;">
...
<tr>
  ...
  <td><input type="text" name="tcols" id="tcols" size="3" maxlength="3" class="input3chars" /></td>
</tr>
<tr>
...
<tr>
  ...
  <td nowrap="nowrap">
    <input type="text" name="twidth" id="twidth" size="3" maxlength="3" class="input3chars" />
  ...
  <td nowrap="nowrap">
    <input type="text" name="theight" id="theight" size="3" maxlength="3" class="input3chars" />
...
<tr>
  ...
  <td colspan="3"><input type="text" name="tborder" id="tborder" size="2" maxlength="2" class="input3chars" /> 
  <?php echo $lang->m('pixels')?></td>
</tr>
<tr>
  <td><?php echo $lang->m('cellpadding')?>:</td>
  <td><input type="text" name="tcpad" id="tcpad" size="3" maxlength="3" class="input3chars" /></td>
  <td><?php echo $lang->m('cellspacing')?>:</td>
  <td><input type="text" name="tcspc" id="tcspc" size="3" maxlength="3" class="input3chars" /></td>
</tr>
<tr>
  <td colspan="4"><?php echo $lang->m('bg_color')?>: <img src="img/spacer.gif" id="color_sample" border="1" width="30" height="18" align="absmiddle" />&nbsp;
    <input type="text" name="tbgcolor" id="tbgcolor" size="7" maxlength="7" class="input7chars" onkeyup="setSample()" align="absmiddle" />
    <input type="button" id="tcolorpicker" border="0" onclick="SpawTablePropDialog.showColorPicker(tbgcolor.value)" value="..." class="bt" align="absmiddle" />
  </td>
</tr>
<tr>
  <td colspan="4">
	<?php echo $lang->m('background')?>: <input type="text" name="tbackground" id="tbackground" size="20" class="input">
	&nbsp;
	<input type="button" id="timg_picker" onclick="SpawTablePropDialog.showImgPicker();" value="..." class="bt" align="absmiddle" />	
  </td>
</tr>
<tr>
