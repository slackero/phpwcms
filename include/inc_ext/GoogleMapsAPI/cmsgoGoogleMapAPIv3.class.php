...
class GoogleMapAPI {
     ...
     * @var string
     */
    var $_db_cache_table = 'cmsgo_geocodes';
    ...
    function __construct($map_id = 'map', $app_id = 'MyMapApp') {
        ...
        $this->_debug_file = empty($this->_debug_file) ? CMSGO_TEMP.'maps_url.log' : $this->_debug_file;
  ...
  function addWaypointByAddress($address,$stopover = TRUE)
  {
    ...
    */
    ...
    function getMapJS() {
        ...
        $_output .= '//<![CDATA[' . "\n";
        $_output .= "/*************************************************\n";
        $_output .= " * Created with GoogleMapAPI" . $this->_version . " for cmsgo\n";
    ...
    function getCache($address) {
        ...
        if ( isset( $_row[0] ) ) {
            ...
            $sql .= " `address` varchar(1000) NOT NULL DEFAULT '', ";
