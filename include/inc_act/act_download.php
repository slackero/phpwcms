...
if($dl) {
    ...
    $sql = "SELECT * FROM ".DB_PREPEND."cmsgo_file WHERE f_trash=0 AND f_kid=1 AND f_id=".$dl." ";
    ...
    if(isset($result[0]['f_id'])) {
        ...
        $dl_path = CMSGO_ROOT.$cmsgo["file_path"];
...
<body>
    ...
    <p>Please <a href="<?php echo CMSGO_URL.get_login_file() ?>"><strong>login</strong></a> again and try another file.</p>
