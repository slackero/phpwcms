        ...
        if(is_file($file_path)) {
            ...
            if(empty($file_error["upload"])) {
                ...
                if($ftp["replace"]) {
                    ...
                    $rsql  = "SELECT * FROM ".DB_PREPEND."cmsgo_file WHERE ";
                    ...
                    if(isset($rrow[0]['f_id'])) {
                        ...
                        $nsql  = "UPDATE ".DB_PREPEND."cmsgo_file SET ";
                        ...
                        if(_dbQuery($nsql, 'UPDATE')) {
                            ...
                            _dbUpdate('cmsgo_file', array('f_type'=>$file_type, 'f_size'=>$file_size, 'f_changed'=>now()), 'f_id='.$oldFileID);
                            ...
                            $thumbnails = returnFileListAsArray(CMSGO_THUMB, $filter_by_ext);
