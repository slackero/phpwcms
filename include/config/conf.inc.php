...
$cmsgo['db_timezone'] = ''; // set MySQL session time zone http://dev.mysql.com/doc/refman/5.5/en/time-zone-support.html
...
$cmsgo['site_ssl_port'] = 443; // The Port on which you SSL Service serve the secure Sites, default SSL port is 443
...
$cmsgo['cimage_path'] = 'images';  //default: 'images'
$cmsgo['ftp_path'] = 'upload';     //default: 'upload'

// content values
$cmsgo['file_maxsize'] = 52428800; //Bytes (50 x 1024 x 1024)
$cmsgo['content_width'] = 1140; //max width of the article content column - important for rendering multi column images
$cmsgo['img_list_width'] = 80; //max with of the list thumbnail image
$cmsgo['img_list_height'] = 80; //max height of the list thumbnail image
$cmsgo['img_prev_width'] = 538; //max width of the large preview image
$cmsgo['img_prev_height'] = 538; //max height of the large preview image
...
$cmsgo['allowed_lang'] = array('en','de','fr','it');     //array of allowed languages: array('en', 'de', 'fr', 'es')
...
$cmsgo['charset'] = 'utf-8';  //default charset 'utf-8'
$cmsgo['php_charset'] = false; // set PHP default charset to $cmsgo['charset']
$cmsgo['allow_remote_URL'] = 1;  //0 = no remote URL in {PHP:...} replacement tag allowed, 1 = allowed
...
$cmsgo['inline_download'] = 1;  //1 = try to display download documents in new window; 0 = show safe under dialog
...
$cmsgo['GETparameterName'] = 'id'; //must have a minimum of 2 chars
$cmsgo['BOTS'] = array('googlebot', 'msnbot', 'bingbot', 'baiduspider', 'yandex', 'sosospider', 'ia_archiver', 'altavista', 'slurp', 'yahoo', 'jeeves', 'teoma', 'lycos', 'crawler'); //don't start session
...
$cmsgo['usergroup_support'] = true; // set true or false to support/disable this feature, is experimental
