 ...
 * setting $cmsgo['feuser_regkey'] in conf.inc.php
 */
...
if($fe_action) {
    ...
    /**
     * Define fields to be used - fields are named like in cmsgo_userdetail
    ...
    if(isset($_POST['detail_login'])) {
        ...
        if($fe_action == '{FE_USER_REGISTER}') {
            ...
            $sql  = 'SELECT COUNT(*) FROM '.DB_PREPEND."cmsgo_userdetail WHERE ";
