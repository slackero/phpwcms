...
// define neccessary functions only when RT is in use
	...
	function listRecipes($alt = null)
	{
		...
		if(!PREVIEW_MODE) {
			$sql .= 'AND ';
			$sql .= DB_PREPEND . "cmsgo_article.article_begin < NOW() AND ";
			$sql .= '(' . DB_PREPEND . "cmsgo_article.article_end > NOW() OR " .DB_PREPEND . "cmsgo_article.article_end = '0000-00-00 00:00:00')";
		}
