...
// load cmsgoImageGallery class
include_once CMSGO_ROOT.'/include/inc_lib/imagegallery.inc.php';

$gallery = new cmsgoImageGallery();
...
if( strpos($content['all'], '{GALLERY}') !== FALSE ) {
    ...
    if( isset($_getVar['subgallery']) ) {
        ...
        $sql .= 'FROM '.DB_PREPEND.'cmsgo_file pf ';
        $sql .= 'LEFT JOIN '.DB_PREPEND.'cmsgo_file pj ';
